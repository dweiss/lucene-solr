...
public class TestBlockPostingsFormat3 extends LuceneTestCase {
    ...
    if (deep) {
      ...
      for (int i = 0; i < numIntersections; i++) {
        ...
        if (automaton.type == CompiledAutomaton.AUTOMATON_TYPE.NORMAL) {
          ...
          assertTermsEnum(
              leftIntersection, rightIntersection, rarely(), bothHaveFreqs, bothHavePositions);
        }
      }
    }
  }
  ...
  public void assertTermStats(
      TermsEnum leftTermsEnum, TermsEnum rightTermsEnum, boolean bothHaveFreqs) throws Exception {
  ...
  public void assertDocsAndPositionsEnum(PostingsEnum leftDocs, PostingsEnum rightDocs)
      throws Exception {
  ...
  public void assertDocsSkipping(int docFreq, PostingsEnum leftDocs, PostingsEnum rightDocs)
      throws Exception {
    if (leftDocs == null) {
      assertNull(rightDocs);
      return;
