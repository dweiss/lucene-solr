...
public class STUniformSplitTermsReader extends UniformSplitTermsReader {
  ...
  /**
   * @see UniformSplitTermsReader#UniformSplitTermsReader(PostingsReaderBase, SegmentReadState,
   *     BlockDecoder, boolean)
   */
  public STUniformSplitTermsReader(
   ...
   *     BlockDecoder, boolean)
   */
  protected STUniformSplitTermsReader(
      PostingsReaderBase postingsReader,
      SegmentReadState state,
      BlockDecoder blockDecoder,
      boolean dictionaryOnHeap,
   ...
   * {@link FieldMetadata#getLastTerm()} are respectively the min and max among the {@link
   * FieldMetadata}s provided as parameter.
   */
