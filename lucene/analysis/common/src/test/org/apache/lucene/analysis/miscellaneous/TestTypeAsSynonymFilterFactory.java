...
public class TestTypeAsSynonymFilterFactory extends BaseTokenStreamFactoryTestCase {
  ...
  private static final Token[] TOKENS = {
    token("Visit", "<ALPHANUM>"), token("example.com", "<URL>")
  };
  ...
  public void testBasic() throws Exception {
    ...
    assertTokenStreamContents(
        stream,
        new String[] {"Visit", "<ALPHANUM>", "example.com", "<URL>"},
        null,
        null,
        new String[] {"<ALPHANUM>", "<ALPHANUM>", "<URL>", "<URL>"},
        new int[] {1, 0, 1, 0});
  }
  ...
  public void testPrefix() throws Exception {
    ...
    assertTokenStreamContents(
        stream,
        new String[] {"Visit", "_type_<ALPHANUM>", "example.com", "_type_<URL>"},
        null,
        null,
        new String[] {"<ALPHANUM>", "<ALPHANUM>", "<URL>", "<URL>"},
        new int[] {1, 0, 1, 0});
