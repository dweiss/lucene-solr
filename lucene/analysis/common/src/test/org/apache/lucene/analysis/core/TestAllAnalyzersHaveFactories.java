  ...
  static {
    Collections.<Class<?>>addAll(
        ...
        ReversePathHierarchyTokenizer
            .class, // this is supported via an option to PathHierarchyTokenizer's factory
        ...
        org.apache.lucene.analysis.StopFilter
            .class, // class from core, but StopFilterFactory creates one from this module
        org.apache.lucene.analysis.LowerCaseFilter
            .class // class from core, but LowerCaseFilterFactory creates one from this module
        );
  }
    ...
    for (final Class<?> c : analysisClasses) {
      ...
      Modifier.isAbstract(modifiers)
          ...
          || c.isAnnotationPresent(
              Deprecated.class) // deprecated ones are typically back compat hacks
