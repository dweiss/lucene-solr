...
public class SerbianAnalyzer extends StopwordAnalyzerBase {
   ...
   *     {@link SetKeywordMarkerFilter} if a stem exclusion set is provided, {@link SnowballFilter}
   *     ({@link SerbianStemmer} https://snowballstem.org/algorithms/serbian/stemmer.html), and
   *     {@link SerbianNormalizationFilter}.
   */
  @Override
