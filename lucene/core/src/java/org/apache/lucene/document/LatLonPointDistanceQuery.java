      ...
      private IntersectVisitor getIntersectVisitor(DocIdSetBuilder result) {
        return new IntersectVisitor() {
          ...
          public void visit(int docID, byte[] packedValue) {
            // bounding box check
            if (FutureArrays.compareUnsigned(packedValue, 0, 0 + Integer.BYTES, maxLat, 0, 0 + Integer.BYTES) > 0 ||
                FutureArrays.compareUnsigned(packedValue, 0, 0 + Integer.BYTES, minLat, 0, 0 + Integer.BYTES) < 0) {
              // latitude out of bounding box range
              return;
            }

            if ((FutureArrays.compareUnsigned(packedValue, Integer.BYTES, Integer.BYTES + Integer.BYTES, maxLon, 0, 0 + Integer.BYTES) > 0 ||
                FutureArrays.compareUnsigned(packedValue, Integer.BYTES, Integer.BYTES + Integer.BYTES, minLon, 0, 0 + Integer.BYTES) < 0)
                && FutureArrays.compareUnsigned(packedValue, Integer.BYTES, Integer.BYTES + Integer.BYTES, minLon2, 0, 0 + Integer.BYTES) < 0) {
          ...
          public Relation compare(byte[] minPackedValue, byte[] maxPackedValue) {
            if (FutureArrays.compareUnsigned(minPackedValue, 0, 0 + Integer.BYTES, maxLat, 0, 0 + Integer.BYTES) > 0 ||
                FutureArrays.compareUnsigned(maxPackedValue, 0, 0 + Integer.BYTES, minLat, 0, 0 + Integer.BYTES) < 0) {
              // latitude out of bounding box range
              return Relation.CELL_OUTSIDE_QUERY;
            }

            if ((FutureArrays.compareUnsigned(minPackedValue, Integer.BYTES, Integer.BYTES + Integer.BYTES, maxLon, 0, 0 + Integer.BYTES) > 0 ||
                FutureArrays.compareUnsigned(maxPackedValue, Integer.BYTES, Integer.BYTES + Integer.BYTES, minLon, 0, 0 + Integer.BYTES) < 0)
                && FutureArrays.compareUnsigned(maxPackedValue, Integer.BYTES, Integer.BYTES + Integer.BYTES, minLon2, 0, 0 + Integer.BYTES) < 0) {
              // longitude out of bounding box range
              return Relation.CELL_OUTSIDE_QUERY;
            }
