...
public final class LongBitSet implements Accountable {
  ...
  public static int bits2words(long numBits) {
    ...
    return (int) ((numBits - 1) >> 6)
        + 1; // I.e.: get the word-offset of the last bit and add one (make sure to use >> so 0
    // returns 0!)
  }
  ...
  public void flip(long startIndex, long endIndex) {
    ...
    long endmask =
        -1L >>> -endIndex; // 64-(endIndex&0x3f) is the same as -endIndex since only the lowest 6
    // bits are used
