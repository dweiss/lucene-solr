 ...
 * a {@link Query} instance can be reused. <br>
 * {@link IndexSearcher} dependent state of the query should reside in the {@link Weight}. <br>
  ...
  protected static class DefaultBulkScorer extends BulkScorer {
    ...
    public int score(LeafCollector collector, Bits acceptDocs, int min, int max)
      ...
      DocIdSetIterator filteredIterator =
          collectorIterator == null
              ? scorerIterator
              : ConjunctionDISI.intersectIterators(
                  Arrays.asList(scorerIterator, collectorIterator));
