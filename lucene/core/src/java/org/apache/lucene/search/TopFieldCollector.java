...
public abstract class TopFieldCollector extends TopDocsCollector<Entry> {
  ...
  // TODO: remove this code when all bulk scores similar to {@code DefaultBulkScorer} use
  // collectors' iterator,
  // as early termination should be implemented in their respective comparators and removed from a
  // collector
