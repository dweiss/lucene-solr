...
public abstract class ValueSource {
  ...
  private static class FromDoubleValuesSource extends ValueSource {
    ...
    public FunctionValues getValues(Map<Object, Object> context, LeafReaderContext readerContext)
      ...
      DoubleValues inner;
      if (searcher != null) inner = in.rewrite(searcher).getValues(readerContext, scores);
      else inner = in.getValues(readerContext, scores);
      ...
      return new FunctionValues() {
        ...
        public float floatVal(int doc) throws IOException {
          if (inner.advanceExact(doc) == false) return 0;
