...
class StandardXYZSolid extends BaseXYZSolid {
  ...
  public StandardXYZSolid(
    ...
    if (isWholeWorld) {
      ...
      // might contribute
      // an edgepoint, for instance, if the plane describing that side intercepts the planet in such
      // a way that the ellipse
      // of interception does not meet any other planes.  Plane intersections can each contribute 0,
      // 1, or 2 edgepoints.
      //
      ...
      // completely describe all shapes on the
      // planet.
      this.edgePoints =
          glueTogether(
  ...
  public boolean equals(Object o) {
    if (!(o instanceof StandardXYZSolid)) return false;
