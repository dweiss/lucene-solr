...
class GeoWideSouthRectangle extends GeoBaseBBox {
   ...
   */
  public GeoWideSouthRectangle(final PlanetModel planetModel, final InputStream inputStream)
      throws IOException {
    this(
        planetModel,
  ...
  protected double outsideDistance(
    ...
    final double topDistance =
        distanceStyle.computeDistance(planetModel, topPlane, x, y, z, eitherBound);
    ...
    final double leftDistance =
        distanceStyle.computeDistance(planetModel, leftPlane, x, y, z, topPlane);
    final double rightDistance =
        distanceStyle.computeDistance(planetModel, rightPlane, x, y, z, topPlane);
  ...
  public boolean equals(Object o) {
    if (!(o instanceof GeoWideSouthRectangle)) return false;
  ...
  public String toString() {
    return "GeoWideSouthRectangle: {planetmodel="
        + planetModel
        + ", toplat="
        + topLat
        + "("
