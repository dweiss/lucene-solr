 ...
 *       <blockquote>
 *       c:\mingw\bin\g++ -Wall -D_JNI_IMPLEMENTATION_ -Wl,--kill-at -I"%JAVA_HOME%\include"
 *       -I"%JAVA_HOME%\include\win32" -static-libgcc -static-libstdc++ -shared WindowsDirectory.cpp
 *       -o WindowsDirectory.dll
 *       </blockquote>
