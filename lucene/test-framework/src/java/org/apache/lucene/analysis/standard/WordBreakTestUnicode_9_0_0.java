 ...
 *
 * <p>\p{Script = Han} (From http://www.unicode.org/Public/9.0.0/ucd/Scripts.txt) \p{Script =
 * Hiragana} \p{LineBreak = Complex_Context} (From
 * http://www.unicode.org/Public/9.0.0/ucd/LineBreak.txt) \p{WordBreak = ALetter} (From
 * http://www.unicode.org/Public/9.0.0/ucd/auxiliary/WordBreakProperty.txt) \p{WordBreak =
 * Hebrew_Letter} \p{WordBreak = Katakana} \p{WordBreak = Numeric} (Excludes full-width Arabic
 * digits) [\uFF10-\uFF19] (Full-width Arabic digits)
 */
@Ignore
public class WordBreakTestUnicode_9_0_0 extends BaseTokenStreamTestCase {
  ...
  public void test(Analyzer analyzer) throws Exception {
    ...
    // ÷ 0001 ÷ 261D ÷  #  ÷ [0.2] <START OF HEADING> (Other) ÷ [999.0] WHITE UP POINTING INDEX
    // (E_Base) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u0001\u261D", new String[] {"\u261D"});

    // ÷ 0001 × 0308 ÷ 261D ÷  #  ÷ [0.2] <START OF HEADING> (Other) × [4.0] COMBINING DIAERESIS
    // (Extend_FE) ÷ [999.0] WHITE UP POINTING INDEX (E_Base) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u0001\u0308\u261D", new String[] {"\u261D"});

    // ÷ 0001 ÷ 1F3FB ÷  #  ÷ [0.2] <START OF HEADING> (Other) ÷ [999.0] EMOJI MODIFIER FITZPATRICK
    // TYPE-1-2 (E_Modifier) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u0001\uD83C\uDFFB", new String[] {"\uD83C\uDFFB"});

    // ÷ 0001 × 0308 ÷ 1F3FB ÷  #  ÷ [0.2] <START OF HEADING> (Other) × [4.0] COMBINING DIAERESIS
    // (Extend_FE) ÷ [999.0] EMOJI MODIFIER FITZPATRICK TYPE-1-2 (E_Modifier) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u0001\u0308\uD83C\uDFFB", new String[] {"\uD83C\uDFFB"});

    // ÷ 0001 ÷ 2764 ÷  #  ÷ [0.2] <START OF HEADING> (Other) ÷ [999.0] HEAVY BLACK HEART
    // (Glue_After_Zwj) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u0001\u2764", new String[] {"\u2764"});

    // ÷ 0001 × 0308 ÷ 2764 ÷  #  ÷ [0.2] <START OF HEADING> (Other) × [4.0] COMBINING DIAERESIS
    ...
    // ÷ 0001 × 0308 ÷ 1F466 ÷  #  ÷ [0.2] <START OF HEADING> (Other) × [4.0] COMBINING DIAERESIS
    // (Extend_FE) ÷ [999.0] BOY (EBG) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u0001\u0308\uD83D\uDC66", new String[] {"\uD83D\uDC66"});
    ...
    // ÷ 000D ÷ 261D ÷  #  ÷ [0.2] <CARRIAGE RETURN (CR)> (CR) ÷ [3.1] WHITE UP POINTING INDEX
    // (E_Base) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\r\u261D", new String[] {"\u261D"});

    // ÷ 000D ÷ 0308 ÷ 261D ÷  #  ÷ [0.2] <CARRIAGE RETURN (CR)> (CR) ÷ [3.1] COMBINING DIAERESIS
    // (Extend_FE) ÷ [999.0] WHITE UP POINTING INDEX (E_Base) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\r\u0308\u261D", new String[] {"\u261D"});

    // ÷ 000D ÷ 1F3FB ÷  #  ÷ [0.2] <CARRIAGE RETURN (CR)> (CR) ÷ [3.1] EMOJI MODIFIER FITZPATRICK
    // TYPE-1-2 (E_Modifier) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\r\uD83C\uDFFB", new String[] {"\uD83C\uDFFB"});

    // ÷ 000D ÷ 0308 ÷ 1F3FB ÷  #  ÷ [0.2] <CARRIAGE RETURN (CR)> (CR) ÷ [3.1] COMBINING DIAERESIS
    // (Extend_FE) ÷ [999.0] EMOJI MODIFIER FITZPATRICK TYPE-1-2 (E_Modifier) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\r\u0308\uD83C\uDFFB", new String[] {"\uD83C\uDFFB"});

    // ÷ 000D ÷ 2764 ÷  #  ÷ [0.2] <CARRIAGE RETURN (CR)> (CR) ÷ [3.1] HEAVY BLACK HEART
    // (Glue_After_Zwj) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\r\u2764", new String[] {"\u2764"});

    // ÷ 000D ÷ 0308 ÷ 2764 ÷  #  ÷ [0.2] <CARRIAGE RETURN (CR)> (CR) ÷ [3.1] COMBINING DIAERESIS
    // (Extend_FE) ÷ [999.0] HEAVY BLACK HEART (Glue_After_Zwj) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\r\u0308\u2764", new String[] {"\u2764"});
    ...
    // ÷ 000D ÷ 0308 ÷ 1F466 ÷  #  ÷ [0.2] <CARRIAGE RETURN (CR)> (CR) ÷ [3.1] COMBINING DIAERESIS
    // (Extend_FE) ÷ [999.0] BOY (EBG) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\r\u0308\uD83D\uDC66", new String[] {"\uD83D\uDC66"});
    ...
    // ÷ 000A ÷ 261D ÷  #  ÷ [0.2] <LINE FEED (LF)> (LF) ÷ [3.1] WHITE UP POINTING INDEX (E_Base) ÷
    // [0.3]
    assertAnalyzesTo(analyzer, "\n\u261D", new String[] {"\u261D"});

    // ÷ 000A ÷ 0308 ÷ 261D ÷  #  ÷ [0.2] <LINE FEED (LF)> (LF) ÷ [3.1] COMBINING DIAERESIS
    // (Extend_FE) ÷ [999.0] WHITE UP POINTING INDEX (E_Base) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\n\u0308\u261D", new String[] {"\u261D"});

    // ÷ 000A ÷ 1F3FB ÷  #  ÷ [0.2] <LINE FEED (LF)> (LF) ÷ [3.1] EMOJI MODIFIER FITZPATRICK
    // TYPE-1-2 (E_Modifier) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\n\uD83C\uDFFB", new String[] {"\uD83C\uDFFB"});

    // ÷ 000A ÷ 0308 ÷ 1F3FB ÷  #  ÷ [0.2] <LINE FEED (LF)> (LF) ÷ [3.1] COMBINING DIAERESIS
    // (Extend_FE) ÷ [999.0] EMOJI MODIFIER FITZPATRICK TYPE-1-2 (E_Modifier) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\n\u0308\uD83C\uDFFB", new String[] {"\uD83C\uDFFB"});

    // ÷ 000A ÷ 2764 ÷  #  ÷ [0.2] <LINE FEED (LF)> (LF) ÷ [3.1] HEAVY BLACK HEART (Glue_After_Zwj)
    // ÷ [0.3]
    assertAnalyzesTo(analyzer, "\n\u2764", new String[] {"\u2764"});

    // ÷ 000A ÷ 0308 ÷ 2764 ÷  #  ÷ [0.2] <LINE FEED (LF)> (LF) ÷ [3.1] COMBINING DIAERESIS
    // (Extend_FE) ÷ [999.0] HEAVY BLACK HEART (Glue_After_Zwj) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\n\u0308\u2764", new String[] {"\u2764"});
    ...
    // ÷ 000A ÷ 0308 ÷ 1F466 ÷  #  ÷ [0.2] <LINE FEED (LF)> (LF) ÷ [3.1] COMBINING DIAERESIS
    // (Extend_FE) ÷ [999.0] BOY (EBG) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\n\u0308\uD83D\uDC66", new String[] {"\uD83D\uDC66"});
    ...
    // ÷ 000B ÷ 261D ÷  #  ÷ [0.2] <LINE TABULATION> (Newline) ÷ [3.1] WHITE UP POINTING INDEX
    // (E_Base) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u000B\u261D", new String[] {"\u261D"});

    // ÷ 000B ÷ 0308 ÷ 261D ÷  #  ÷ [0.2] <LINE TABULATION> (Newline) ÷ [3.1] COMBINING DIAERESIS
    // (Extend_FE) ÷ [999.0] WHITE UP POINTING INDEX (E_Base) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u000B\u0308\u261D", new String[] {"\u261D"});

    // ÷ 000B ÷ 1F3FB ÷  #  ÷ [0.2] <LINE TABULATION> (Newline) ÷ [3.1] EMOJI MODIFIER FITZPATRICK
    // TYPE-1-2 (E_Modifier) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u000B\uD83C\uDFFB", new String[] {"\uD83C\uDFFB"});

    // ÷ 000B ÷ 0308 ÷ 1F3FB ÷  #  ÷ [0.2] <LINE TABULATION> (Newline) ÷ [3.1] COMBINING DIAERESIS
    // (Extend_FE) ÷ [999.0] EMOJI MODIFIER FITZPATRICK TYPE-1-2 (E_Modifier) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u000B\u0308\uD83C\uDFFB", new String[] {"\uD83C\uDFFB"});

    // ÷ 000B ÷ 2764 ÷  #  ÷ [0.2] <LINE TABULATION> (Newline) ÷ [3.1] HEAVY BLACK HEART
    // (Glue_After_Zwj) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u000B\u2764", new String[] {"\u2764"});

    // ÷ 000B ÷ 0308 ÷ 2764 ÷  #  ÷ [0.2] <LINE TABULATION> (Newline) ÷ [3.1] COMBINING DIAERESIS
    // (Extend_FE) ÷ [999.0] HEAVY BLACK HEART (Glue_After_Zwj) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u000B\u0308\u2764", new String[] {"\u2764"});
    ...
    // ÷ 000B ÷ 0308 ÷ 1F466 ÷  #  ÷ [0.2] <LINE TABULATION> (Newline) ÷ [3.1] COMBINING DIAERESIS
    // (Extend_FE) ÷ [999.0] BOY (EBG) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u000B\u0308\uD83D\uDC66", new String[] {"\uD83D\uDC66"});
    ...
    // ÷ 3031 ÷ 261D ÷  #  ÷ [0.2] VERTICAL KANA REPEAT MARK (Katakana) ÷ [999.0] WHITE UP POINTING
    // INDEX (E_Base) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u3031\u261D", new String[] {"\u3031", "\u261D"});

    // ÷ 3031 × 0308 ÷ 261D ÷  #  ÷ [0.2] VERTICAL KANA REPEAT MARK (Katakana) × [4.0] COMBINING
    // DIAERESIS (Extend_FE) ÷ [999.0] WHITE UP POINTING INDEX (E_Base) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u3031\u0308\u261D", new String[] {"\u3031\u0308", "\u261D"});

    // ÷ 3031 ÷ 1F3FB ÷  #  ÷ [0.2] VERTICAL KANA REPEAT MARK (Katakana) ÷ [999.0] EMOJI MODIFIER
    // FITZPATRICK TYPE-1-2 (E_Modifier) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u3031\uD83C\uDFFB", new String[] {"\u3031", "\uD83C\uDFFB"});

    // ÷ 3031 × 0308 ÷ 1F3FB ÷  #  ÷ [0.2] VERTICAL KANA REPEAT MARK (Katakana) × [4.0] COMBINING
    // DIAERESIS (Extend_FE) ÷ [999.0] EMOJI MODIFIER FITZPATRICK TYPE-1-2 (E_Modifier) ÷ [0.3]
    assertAnalyzesTo(
        analyzer, "\u3031\u0308\uD83C\uDFFB", new String[] {"\u3031\u0308", "\uD83C\uDFFB"});

    // ÷ 3031 ÷ 2764 ÷  #  ÷ [0.2] VERTICAL KANA REPEAT MARK (Katakana) ÷ [999.0] HEAVY BLACK HEART
    // (Glue_After_Zwj) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u3031\u2764", new String[] {"\u3031", "\u2764"});

    // ÷ 3031 × 0308 ÷ 2764 ÷  #  ÷ [0.2] VERTICAL KANA REPEAT MARK (Katakana) × [4.0] COMBINING
    ...
    // ÷ 3031 × 0308 ÷ 1F466 ÷  #  ÷ [0.2] VERTICAL KANA REPEAT MARK (Katakana) × [4.0] COMBINING
    // DIAERESIS (Extend_FE) ÷ [999.0] BOY (EBG) ÷ [0.3]
    assertAnalyzesTo(
        analyzer, "\u3031\u0308\uD83D\uDC66", new String[] {"\u3031\u0308", "\uD83D\uDC66"});
    ...
    // ÷ 0041 ÷ 261D ÷  #  ÷ [0.2] LATIN CAPITAL LETTER A (ALetter) ÷ [999.0] WHITE UP POINTING
    // INDEX (E_Base) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u0041\u261D", new String[] {"\u0041", "\u261D"});

    // ÷ 0041 × 0308 ÷ 261D ÷  #  ÷ [0.2] LATIN CAPITAL LETTER A (ALetter) × [4.0] COMBINING
    // DIAERESIS (Extend_FE) ÷ [999.0] WHITE UP POINTING INDEX (E_Base) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u0041\u0308\u261D", new String[] {"\u0041\u0308", "\u261D"});

    // ÷ 0041 ÷ 1F3FB ÷  #  ÷ [0.2] LATIN CAPITAL LETTER A (ALetter) ÷ [999.0] EMOJI MODIFIER
    // FITZPATRICK TYPE-1-2 (E_Modifier) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u0041\uD83C\uDFFB", new String[] {"\u0041", "\uD83C\uDFFB"});

    // ÷ 0041 × 0308 ÷ 1F3FB ÷  #  ÷ [0.2] LATIN CAPITAL LETTER A (ALetter) × [4.0] COMBINING
    // DIAERESIS (Extend_FE) ÷ [999.0] EMOJI MODIFIER FITZPATRICK TYPE-1-2 (E_Modifier) ÷ [0.3]
    assertAnalyzesTo(
        analyzer, "\u0041\u0308\uD83C\uDFFB", new String[] {"\u0041\u0308", "\uD83C\uDFFB"});

    // ÷ 0041 ÷ 2764 ÷  #  ÷ [0.2] LATIN CAPITAL LETTER A (ALetter) ÷ [999.0] HEAVY BLACK HEART
    // (Glue_After_Zwj) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u0041\u2764", new String[] {"\u0041", "\u2764"});

    // ÷ 0041 × 0308 ÷ 2764 ÷  #  ÷ [0.2] LATIN CAPITAL LETTER A (ALetter) × [4.0] COMBINING
    // DIAERESIS (Extend_FE) ÷ [999.0] HEAVY BLACK HEART (Glue_After_Zwj) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u0041\u0308\u2764", new String[] {"\u0041\u0308", "\u2764"});
    ...
    // ÷ 0041 × 0308 ÷ 1F466 ÷  #  ÷ [0.2] LATIN CAPITAL LETTER A (ALetter) × [4.0] COMBINING
    // DIAERESIS (Extend_FE) ÷ [999.0] BOY (EBG) ÷ [0.3]
    assertAnalyzesTo(
        analyzer, "\u0041\u0308\uD83D\uDC66", new String[] {"\u0041\u0308", "\uD83D\uDC66"});
    ...
    // ÷ 003A ÷ 261D ÷  #  ÷ [0.2] COLON (MidLetter) ÷ [999.0] WHITE UP POINTING INDEX (E_Base) ÷
    // [0.3]
    assertAnalyzesTo(analyzer, "\u003A\u261D", new String[] {"\u261D"});

    // ÷ 003A × 0308 ÷ 261D ÷  #  ÷ [0.2] COLON (MidLetter) × [4.0] COMBINING DIAERESIS (Extend_FE)
    // ÷ [999.0] WHITE UP POINTING INDEX (E_Base) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u003A\u0308\u261D", new String[] {"\u261D"});

    // ÷ 003A ÷ 1F3FB ÷  #  ÷ [0.2] COLON (MidLetter) ÷ [999.0] EMOJI MODIFIER FITZPATRICK TYPE-1-2
    // (E_Modifier) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u003A\uD83C\uDFFB", new String[] {"\uD83C\uDFFB"});

    // ÷ 003A × 0308 ÷ 1F3FB ÷  #  ÷ [0.2] COLON (MidLetter) × [4.0] COMBINING DIAERESIS (Extend_FE)
    // ÷ [999.0] EMOJI MODIFIER FITZPATRICK TYPE-1-2 (E_Modifier) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u003A\u0308\uD83C\uDFFB", new String[] {"\uD83C\uDFFB"});

    // ÷ 003A ÷ 2764 ÷  #  ÷ [0.2] COLON (MidLetter) ÷ [999.0] HEAVY BLACK HEART (Glue_After_Zwj) ÷
    // [0.3]
    assertAnalyzesTo(analyzer, "\u003A\u2764", new String[] {"\u2764"});

    // ÷ 003A × 0308 ÷ 2764 ÷  #  ÷ [0.2] COLON (MidLetter) × [4.0] COMBINING DIAERESIS (Extend_FE)
    // ÷ [999.0] HEAVY BLACK HEART (Glue_After_Zwj) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u003A\u0308\u2764", new String[] {"\u2764"});

    // ÷ 003A ÷ 1F466 ÷  #  ÷ [0.2] COLON (MidLetter) ÷ [999.0] BOY (EBG) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u003A\uD83D\uDC66", new String[] {"\uD83D\uDC66"});

    // ÷ 003A × 0308 ÷ 1F466 ÷  #  ÷ [0.2] COLON (MidLetter) × [4.0] COMBINING DIAERESIS (Extend_FE)
    // ÷ [999.0] BOY (EBG) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u003A\u0308\uD83D\uDC66", new String[] {"\uD83D\uDC66"});
    ...
    // ÷ 002C × 0308 ÷ 261D ÷  #  ÷ [0.2] COMMA (MidNum) × [4.0] COMBINING DIAERESIS (Extend_FE) ÷
    // [999.0] WHITE UP POINTING INDEX (E_Base) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u002C\u0308\u261D", new String[] {"\u261D"});

    // ÷ 002C ÷ 1F3FB ÷  #  ÷ [0.2] COMMA (MidNum) ÷ [999.0] EMOJI MODIFIER FITZPATRICK TYPE-1-2
    // (E_Modifier) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u002C\uD83C\uDFFB", new String[] {"\uD83C\uDFFB"});

    // ÷ 002C × 0308 ÷ 1F3FB ÷  #  ÷ [0.2] COMMA (MidNum) × [4.0] COMBINING DIAERESIS (Extend_FE) ÷
    // [999.0] EMOJI MODIFIER FITZPATRICK TYPE-1-2 (E_Modifier) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u002C\u0308\uD83C\uDFFB", new String[] {"\uD83C\uDFFB"});

    // ÷ 002C ÷ 2764 ÷  #  ÷ [0.2] COMMA (MidNum) ÷ [999.0] HEAVY BLACK HEART (Glue_After_Zwj) ÷
    // [0.3]
    assertAnalyzesTo(analyzer, "\u002C\u2764", new String[] {"\u2764"});

    // ÷ 002C × 0308 ÷ 2764 ÷  #  ÷ [0.2] COMMA (MidNum) × [4.0] COMBINING DIAERESIS (Extend_FE) ÷
    // [999.0] HEAVY BLACK HEART (Glue_After_Zwj) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u002C\u0308\u2764", new String[] {"\u2764"});
    ...
    // ÷ 002C × 0308 ÷ 1F466 ÷  #  ÷ [0.2] COMMA (MidNum) × [4.0] COMBINING DIAERESIS (Extend_FE) ÷
    // [999.0] BOY (EBG) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u002C\u0308\uD83D\uDC66", new String[] {"\uD83D\uDC66"});
    ...
    // ÷ 002E ÷ 261D ÷  #  ÷ [0.2] FULL STOP (MidNumLet) ÷ [999.0] WHITE UP POINTING INDEX (E_Base)
    // ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u002E\u261D", new String[] {"\u261D"});

    // ÷ 002E × 0308 ÷ 261D ÷  #  ÷ [0.2] FULL STOP (MidNumLet) × [4.0] COMBINING DIAERESIS
    // (Extend_FE) ÷ [999.0] WHITE UP POINTING INDEX (E_Base) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u002E\u0308\u261D", new String[] {"\u261D"});

    // ÷ 002E ÷ 1F3FB ÷  #  ÷ [0.2] FULL STOP (MidNumLet) ÷ [999.0] EMOJI MODIFIER FITZPATRICK
    // TYPE-1-2 (E_Modifier) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u002E\uD83C\uDFFB", new String[] {"\uD83C\uDFFB"});

    // ÷ 002E × 0308 ÷ 1F3FB ÷  #  ÷ [0.2] FULL STOP (MidNumLet) × [4.0] COMBINING DIAERESIS
    // (Extend_FE) ÷ [999.0] EMOJI MODIFIER FITZPATRICK TYPE-1-2 (E_Modifier) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u002E\u0308\uD83C\uDFFB", new String[] {"\uD83C\uDFFB"});

    // ÷ 002E ÷ 2764 ÷  #  ÷ [0.2] FULL STOP (MidNumLet) ÷ [999.0] HEAVY BLACK HEART
    // (Glue_After_Zwj) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u002E\u2764", new String[] {"\u2764"});

    // ÷ 002E × 0308 ÷ 2764 ÷  #  ÷ [0.2] FULL STOP (MidNumLet) × [4.0] COMBINING DIAERESIS
    // (Extend_FE) ÷ [999.0] HEAVY BLACK HEART (Glue_After_Zwj) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u002E\u0308\u2764", new String[] {"\u2764"});
    ...
    // ÷ 002E × 0308 ÷ 1F466 ÷  #  ÷ [0.2] FULL STOP (MidNumLet) × [4.0] COMBINING DIAERESIS
    // (Extend_FE) ÷ [999.0] BOY (EBG) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u002E\u0308\uD83D\uDC66", new String[] {"\uD83D\uDC66"});
    ...
    // ÷ 0030 ÷ 261D ÷  #  ÷ [0.2] DIGIT ZERO (Numeric) ÷ [999.0] WHITE UP POINTING INDEX (E_Base) ÷
    // [0.3]
    assertAnalyzesTo(analyzer, "\u0030\u261D", new String[] {"\u0030", "\u261D"});

    // ÷ 0030 × 0308 ÷ 261D ÷  #  ÷ [0.2] DIGIT ZERO (Numeric) × [4.0] COMBINING DIAERESIS
    // (Extend_FE) ÷ [999.0] WHITE UP POINTING INDEX (E_Base) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u0030\u0308\u261D", new String[] {"\u0030\u0308", "\u261D"});

    // ÷ 0030 ÷ 1F3FB ÷  #  ÷ [0.2] DIGIT ZERO (Numeric) ÷ [999.0] EMOJI MODIFIER FITZPATRICK
    // TYPE-1-2 (E_Modifier) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u0030\uD83C\uDFFB", new String[] {"\u0030", "\uD83C\uDFFB"});

    // ÷ 0030 × 0308 ÷ 1F3FB ÷  #  ÷ [0.2] DIGIT ZERO (Numeric) × [4.0] COMBINING DIAERESIS
    // (Extend_FE) ÷ [999.0] EMOJI MODIFIER FITZPATRICK TYPE-1-2 (E_Modifier) ÷ [0.3]
    assertAnalyzesTo(
        analyzer, "\u0030\u0308\uD83C\uDFFB", new String[] {"\u0030\u0308", "\uD83C\uDFFB"});

    // ÷ 0030 ÷ 2764 ÷  #  ÷ [0.2] DIGIT ZERO (Numeric) ÷ [999.0] HEAVY BLACK HEART (Glue_After_Zwj)
    // ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u0030\u2764", new String[] {"\u0030", "\u2764"});

    // ÷ 0030 × 0308 ÷ 2764 ÷  #  ÷ [0.2] DIGIT ZERO (Numeric) × [4.0] COMBINING DIAERESIS
    // (Extend_FE) ÷ [999.0] HEAVY BLACK HEART (Glue_After_Zwj) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u0030\u0308\u2764", new String[] {"\u0030\u0308", "\u2764"});
    ...
    // ÷ 0030 × 0308 ÷ 1F466 ÷  #  ÷ [0.2] DIGIT ZERO (Numeric) × [4.0] COMBINING DIAERESIS
    // (Extend_FE) ÷ [999.0] BOY (EBG) ÷ [0.3]
    assertAnalyzesTo(
        analyzer, "\u0030\u0308\uD83D\uDC66", new String[] {"\u0030\u0308", "\uD83D\uDC66"});
    ...
    // ÷ 005F ÷ 261D ÷  #  ÷ [0.2] LOW LINE (ExtendNumLet) ÷ [999.0] WHITE UP POINTING INDEX
    // (E_Base) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u005F\u261D", new String[] {"\u261D"});

    // ÷ 005F × 0308 ÷ 261D ÷  #  ÷ [0.2] LOW LINE (ExtendNumLet) × [4.0] COMBINING DIAERESIS
    // (Extend_FE) ÷ [999.0] WHITE UP POINTING INDEX (E_Base) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u005F\u0308\u261D", new String[] {"\u261D"});

    // ÷ 005F ÷ 1F3FB ÷  #  ÷ [0.2] LOW LINE (ExtendNumLet) ÷ [999.0] EMOJI MODIFIER FITZPATRICK
    // TYPE-1-2 (E_Modifier) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u005F\uD83C\uDFFB", new String[] {"\uD83C\uDFFB"});

    // ÷ 005F × 0308 ÷ 1F3FB ÷  #  ÷ [0.2] LOW LINE (ExtendNumLet) × [4.0] COMBINING DIAERESIS
    // (Extend_FE) ÷ [999.0] EMOJI MODIFIER FITZPATRICK TYPE-1-2 (E_Modifier) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u005F\u0308\uD83C\uDFFB", new String[] {"\uD83C\uDFFB"});

    // ÷ 005F ÷ 2764 ÷  #  ÷ [0.2] LOW LINE (ExtendNumLet) ÷ [999.0] HEAVY BLACK HEART
    // (Glue_After_Zwj) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u005F\u2764", new String[] {"\u2764"});

    // ÷ 005F × 0308 ÷ 2764 ÷  #  ÷ [0.2] LOW LINE (ExtendNumLet) × [4.0] COMBINING DIAERESIS
    // (Extend_FE) ÷ [999.0] HEAVY BLACK HEART (Glue_After_Zwj) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u005F\u0308\u2764", new String[] {"\u2764"});
    ...
    // ÷ 005F × 0308 ÷ 1F466 ÷  #  ÷ [0.2] LOW LINE (ExtendNumLet) × [4.0] COMBINING DIAERESIS
    // (Extend_FE) ÷ [999.0] BOY (EBG) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u005F\u0308\uD83D\uDC66", new String[] {"\uD83D\uDC66"});
    ...
    // ÷ 1F1E6 ÷ 261D ÷  #  ÷ [0.2] REGIONAL INDICATOR SYMBOL LETTER A (RI) ÷ [999.0] WHITE UP
    // POINTING INDEX (E_Base) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\uD83C\uDDE6\u261D", new String[] {"\u261D"});

    // ÷ 1F1E6 × 0308 ÷ 261D ÷  #  ÷ [0.2] REGIONAL INDICATOR SYMBOL LETTER A (RI) × [4.0] COMBINING
    // DIAERESIS (Extend_FE) ÷ [999.0] WHITE UP POINTING INDEX (E_Base) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\uD83C\uDDE6\u0308\u261D", new String[] {"\u261D"});

    // ÷ 1F1E6 ÷ 1F3FB ÷  #  ÷ [0.2] REGIONAL INDICATOR SYMBOL LETTER A (RI) ÷ [999.0] EMOJI
    // MODIFIER FITZPATRICK TYPE-1-2 (E_Modifier) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\uD83C\uDDE6\uD83C\uDFFB", new String[] {"\uD83C\uDFFB"});

    // ÷ 1F1E6 × 0308 ÷ 1F3FB ÷  #  ÷ [0.2] REGIONAL INDICATOR SYMBOL LETTER A (RI) × [4.0]
    // COMBINING DIAERESIS (Extend_FE) ÷ [999.0] EMOJI MODIFIER FITZPATRICK TYPE-1-2 (E_Modifier) ÷
    // [0.3]
    assertAnalyzesTo(analyzer, "\uD83C\uDDE6\u0308\uD83C\uDFFB", new String[] {"\uD83C\uDFFB"});

    // ÷ 1F1E6 ÷ 2764 ÷  #  ÷ [0.2] REGIONAL INDICATOR SYMBOL LETTER A (RI) ÷ [999.0] HEAVY BLACK
    // HEART (Glue_After_Zwj) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\uD83C\uDDE6\u2764", new String[] {"\u2764"});

    // ÷ 1F1E6 × 0308 ÷ 2764 ÷  #  ÷ [0.2] REGIONAL INDICATOR SYMBOL LETTER A (RI) × [4.0] COMBINING
    // DIAERESIS (Extend_FE) ÷ [999.0] HEAVY BLACK HEART (Glue_After_Zwj) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\uD83C\uDDE6\u0308\u2764", new String[] {"\u2764"});

    // ÷ 1F1E6 ÷ 1F466 ÷  #  ÷ [0.2] REGIONAL INDICATOR SYMBOL LETTER A (RI) ÷ [999.0] BOY (EBG) ÷
    // [0.3]
    assertAnalyzesTo(analyzer, "\uD83C\uDDE6\uD83D\uDC66", new String[] {"\uD83D\uDC66"});

    // ÷ 1F1E6 × 0308 ÷ 1F466 ÷  #  ÷ [0.2] REGIONAL INDICATOR SYMBOL LETTER A (RI) × [4.0]
    ...
    // ÷ 05D0 ÷ 261D ÷  #  ÷ [0.2] HEBREW LETTER ALEF (Hebrew_Letter) ÷ [999.0] WHITE UP POINTING
    // INDEX (E_Base) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u05D0\u261D", new String[] {"\u05D0", "\u261D"});

    // ÷ 05D0 × 0308 ÷ 261D ÷  #  ÷ [0.2] HEBREW LETTER ALEF (Hebrew_Letter) × [4.0] COMBINING
    // DIAERESIS (Extend_FE) ÷ [999.0] WHITE UP POINTING INDEX (E_Base) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u05D0\u0308\u261D", new String[] {"\u05D0\u0308", "\u261D"});

    // ÷ 05D0 ÷ 1F3FB ÷  #  ÷ [0.2] HEBREW LETTER ALEF (Hebrew_Letter) ÷ [999.0] EMOJI MODIFIER
    // FITZPATRICK TYPE-1-2 (E_Modifier) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u05D0\uD83C\uDFFB", new String[] {"\u05D0", "\uD83C\uDFFB"});

    // ÷ 05D0 × 0308 ÷ 1F3FB ÷  #  ÷ [0.2] HEBREW LETTER ALEF (Hebrew_Letter) × [4.0] COMBINING
    // DIAERESIS (Extend_FE) ÷ [999.0] EMOJI MODIFIER FITZPATRICK TYPE-1-2 (E_Modifier) ÷ [0.3]
    assertAnalyzesTo(
        analyzer, "\u05D0\u0308\uD83C\uDFFB", new String[] {"\u05D0\u0308", "\uD83C\uDFFB"});

    // ÷ 05D0 ÷ 2764 ÷  #  ÷ [0.2] HEBREW LETTER ALEF (Hebrew_Letter) ÷ [999.0] HEAVY BLACK HEART
    // (Glue_After_Zwj) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u05D0\u2764", new String[] {"\u05D0", "\u2764"});

    // ÷ 05D0 × 0308 ÷ 2764 ÷  #  ÷ [0.2] HEBREW LETTER ALEF (Hebrew_Letter) × [4.0] COMBINING
    // DIAERESIS (Extend_FE) ÷ [999.0] HEAVY BLACK HEART (Glue_After_Zwj) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u05D0\u0308\u2764", new String[] {"\u05D0\u0308", "\u2764"});
    ...
    // ÷ 05D0 × 0308 ÷ 1F466 ÷  #  ÷ [0.2] HEBREW LETTER ALEF (Hebrew_Letter) × [4.0] COMBINING
    // DIAERESIS (Extend_FE) ÷ [999.0] BOY (EBG) ÷ [0.3]
    assertAnalyzesTo(
        analyzer, "\u05D0\u0308\uD83D\uDC66", new String[] {"\u05D0\u0308", "\uD83D\uDC66"});
    ...
    // ÷ 0022 ÷ 261D ÷  #  ÷ [0.2] QUOTATION MARK (Double_Quote) ÷ [999.0] WHITE UP POINTING INDEX
    // (E_Base) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\"\u261D", new String[] {"\u261D"});

    // ÷ 0022 × 0308 ÷ 261D ÷  #  ÷ [0.2] QUOTATION MARK (Double_Quote) × [4.0] COMBINING DIAERESIS
    // (Extend_FE) ÷ [999.0] WHITE UP POINTING INDEX (E_Base) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\"\u0308\u261D", new String[] {"\u261D"});

    // ÷ 0022 ÷ 1F3FB ÷  #  ÷ [0.2] QUOTATION MARK (Double_Quote) ÷ [999.0] EMOJI MODIFIER
    // FITZPATRICK TYPE-1-2 (E_Modifier) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\"\uD83C\uDFFB", new String[] {"\uD83C\uDFFB"});

    // ÷ 0022 × 0308 ÷ 1F3FB ÷  #  ÷ [0.2] QUOTATION MARK (Double_Quote) × [4.0] COMBINING DIAERESIS
    // (Extend_FE) ÷ [999.0] EMOJI MODIFIER FITZPATRICK TYPE-1-2 (E_Modifier) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\"\u0308\uD83C\uDFFB", new String[] {"\uD83C\uDFFB"});

    // ÷ 0022 ÷ 2764 ÷  #  ÷ [0.2] QUOTATION MARK (Double_Quote) ÷ [999.0] HEAVY BLACK HEART
    // (Glue_After_Zwj) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\"\u2764", new String[] {"\u2764"});

    // ÷ 0022 × 0308 ÷ 2764 ÷  #  ÷ [0.2] QUOTATION MARK (Double_Quote) × [4.0] COMBINING DIAERESIS
    // (Extend_FE) ÷ [999.0] HEAVY BLACK HEART (Glue_After_Zwj) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\"\u0308\u2764", new String[] {"\u2764"});
    ...
    // ÷ 0022 × 0308 ÷ 1F466 ÷  #  ÷ [0.2] QUOTATION MARK (Double_Quote) × [4.0] COMBINING DIAERESIS
    // (Extend_FE) ÷ [999.0] BOY (EBG) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\"\u0308\uD83D\uDC66", new String[] {"\uD83D\uDC66"});
    ...
    // ÷ 0027 ÷ 261D ÷  #  ÷ [0.2] APOSTROPHE (Single_Quote) ÷ [999.0] WHITE UP POINTING INDEX
    // (E_Base) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u0027\u261D", new String[] {"\u261D"});

    // ÷ 0027 × 0308 ÷ 261D ÷  #  ÷ [0.2] APOSTROPHE (Single_Quote) × [4.0] COMBINING DIAERESIS
    // (Extend_FE) ÷ [999.0] WHITE UP POINTING INDEX (E_Base) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u0027\u0308\u261D", new String[] {"\u261D"});

    // ÷ 0027 ÷ 1F3FB ÷  #  ÷ [0.2] APOSTROPHE (Single_Quote) ÷ [999.0] EMOJI MODIFIER FITZPATRICK
    // TYPE-1-2 (E_Modifier) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u0027\uD83C\uDFFB", new String[] {"\uD83C\uDFFB"});

    // ÷ 0027 × 0308 ÷ 1F3FB ÷  #  ÷ [0.2] APOSTROPHE (Single_Quote) × [4.0] COMBINING DIAERESIS
    // (Extend_FE) ÷ [999.0] EMOJI MODIFIER FITZPATRICK TYPE-1-2 (E_Modifier) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u0027\u0308\uD83C\uDFFB", new String[] {"\uD83C\uDFFB"});

    // ÷ 0027 ÷ 2764 ÷  #  ÷ [0.2] APOSTROPHE (Single_Quote) ÷ [999.0] HEAVY BLACK HEART
    // (Glue_After_Zwj) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u0027\u2764", new String[] {"\u2764"});

    // ÷ 0027 × 0308 ÷ 2764 ÷  #  ÷ [0.2] APOSTROPHE (Single_Quote) × [4.0] COMBINING DIAERESIS
    // (Extend_FE) ÷ [999.0] HEAVY BLACK HEART (Glue_After_Zwj) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u0027\u0308\u2764", new String[] {"\u2764"});
    ...
    // ÷ 0027 × 0308 ÷ 1F466 ÷  #  ÷ [0.2] APOSTROPHE (Single_Quote) × [4.0] COMBINING DIAERESIS
    // (Extend_FE) ÷ [999.0] BOY (EBG) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u0027\u0308\uD83D\uDC66", new String[] {"\uD83D\uDC66"});
    ...
    // ÷ 261D ÷ 0001 ÷  #  ÷ [0.2] WHITE UP POINTING INDEX (E_Base) ÷ [999.0] <START OF HEADING>
    // (Other) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u261D\u0001", new String[] {"\u261D"});

    // ÷ 261D × 0308 ÷ 0001 ÷  #  ÷ [0.2] WHITE UP POINTING INDEX (E_Base) × [4.0] COMBINING
    // DIAERESIS (Extend_FE) ÷ [999.0] <START OF HEADING> (Other) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u261D\u0308\u0001", new String[] {"\u261D\u0308"});

    // ÷ 261D ÷ 000D ÷  #  ÷ [0.2] WHITE UP POINTING INDEX (E_Base) ÷ [3.2] <CARRIAGE RETURN (CR)>
    // (CR) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u261D\r", new String[] {"\u261D"});

    // ÷ 261D × 0308 ÷ 000D ÷  #  ÷ [0.2] WHITE UP POINTING INDEX (E_Base) × [4.0] COMBINING
    // DIAERESIS (Extend_FE) ÷ [3.2] <CARRIAGE RETURN (CR)> (CR) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u261D\u0308\r", new String[] {"\u261D\u0308"});

    // ÷ 261D ÷ 000A ÷  #  ÷ [0.2] WHITE UP POINTING INDEX (E_Base) ÷ [3.2] <LINE FEED (LF)> (LF) ÷
    // [0.3]
    assertAnalyzesTo(analyzer, "\u261D\n", new String[] {"\u261D"});

    // ÷ 261D × 0308 ÷ 000A ÷  #  ÷ [0.2] WHITE UP POINTING INDEX (E_Base) × [4.0] COMBINING
    // DIAERESIS (Extend_FE) ÷ [3.2] <LINE FEED (LF)> (LF) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u261D\u0308\n", new String[] {"\u261D\u0308"});

    // ÷ 261D ÷ 000B ÷  #  ÷ [0.2] WHITE UP POINTING INDEX (E_Base) ÷ [3.2] <LINE TABULATION>
    // (Newline) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u261D\u000B", new String[] {"\u261D"});

    // ÷ 261D × 0308 ÷ 000B ÷  #  ÷ [0.2] WHITE UP POINTING INDEX (E_Base) × [4.0] COMBINING
    // DIAERESIS (Extend_FE) ÷ [3.2] <LINE TABULATION> (Newline) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u261D\u0308\u000B", new String[] {"\u261D\u0308"});

    // ÷ 261D ÷ 3031 ÷  #  ÷ [0.2] WHITE UP POINTING INDEX (E_Base) ÷ [999.0] VERTICAL KANA REPEAT
    // MARK (Katakana) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u261D\u3031", new String[] {"\u261D", "\u3031"});

    // ÷ 261D × 0308 ÷ 3031 ÷  #  ÷ [0.2] WHITE UP POINTING INDEX (E_Base) × [4.0] COMBINING
    // DIAERESIS (Extend_FE) ÷ [999.0] VERTICAL KANA REPEAT MARK (Katakana) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u261D\u0308\u3031", new String[] {"\u261D\u0308", "\u3031"});

    // ÷ 261D ÷ 0041 ÷  #  ÷ [0.2] WHITE UP POINTING INDEX (E_Base) ÷ [999.0] LATIN CAPITAL LETTER A
    // (ALetter) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u261D\u0041", new String[] {"\u261D", "\u0041"});

    // ÷ 261D × 0308 ÷ 0041 ÷  #  ÷ [0.2] WHITE UP POINTING INDEX (E_Base) × [4.0] COMBINING
    // DIAERESIS (Extend_FE) ÷ [999.0] LATIN CAPITAL LETTER A (ALetter) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u261D\u0308\u0041", new String[] {"\u261D\u0308", "\u0041"});

    // ÷ 261D ÷ 003A ÷  #  ÷ [0.2] WHITE UP POINTING INDEX (E_Base) ÷ [999.0] COLON (MidLetter) ÷
    // [0.3]
    assertAnalyzesTo(analyzer, "\u261D\u003A", new String[] {"\u261D"});

    // ÷ 261D × 0308 ÷ 003A ÷  #  ÷ [0.2] WHITE UP POINTING INDEX (E_Base) × [4.0] COMBINING
    // DIAERESIS (Extend_FE) ÷ [999.0] COLON (MidLetter) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u261D\u0308\u003A", new String[] {"\u261D\u0308"});
    ...
    // ÷ 261D × 0308 ÷ 002C ÷  #  ÷ [0.2] WHITE UP POINTING INDEX (E_Base) × [4.0] COMBINING
    // DIAERESIS (Extend_FE) ÷ [999.0] COMMA (MidNum) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u261D\u0308\u002C", new String[] {"\u261D\u0308"});

    // ÷ 261D ÷ 002E ÷  #  ÷ [0.2] WHITE UP POINTING INDEX (E_Base) ÷ [999.0] FULL STOP (MidNumLet)
    // ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u261D\u002E", new String[] {"\u261D"});

    // ÷ 261D × 0308 ÷ 002E ÷  #  ÷ [0.2] WHITE UP POINTING INDEX (E_Base) × [4.0] COMBINING
    // DIAERESIS (Extend_FE) ÷ [999.0] FULL STOP (MidNumLet) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u261D\u0308\u002E", new String[] {"\u261D\u0308"});

    // ÷ 261D ÷ 0030 ÷  #  ÷ [0.2] WHITE UP POINTING INDEX (E_Base) ÷ [999.0] DIGIT ZERO (Numeric) ÷
    // [0.3]
    assertAnalyzesTo(analyzer, "\u261D\u0030", new String[] {"\u261D", "\u0030"});

    // ÷ 261D × 0308 ÷ 0030 ÷  #  ÷ [0.2] WHITE UP POINTING INDEX (E_Base) × [4.0] COMBINING
    // DIAERESIS (Extend_FE) ÷ [999.0] DIGIT ZERO (Numeric) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u261D\u0308\u0030", new String[] {"\u261D\u0308", "\u0030"});

    // ÷ 261D ÷ 005F ÷  #  ÷ [0.2] WHITE UP POINTING INDEX (E_Base) ÷ [999.0] LOW LINE
    // (ExtendNumLet) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u261D\u005F", new String[] {"\u261D"});

    // ÷ 261D × 0308 ÷ 005F ÷  #  ÷ [0.2] WHITE UP POINTING INDEX (E_Base) × [4.0] COMBINING
    // DIAERESIS (Extend_FE) ÷ [999.0] LOW LINE (ExtendNumLet) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u261D\u0308\u005F", new String[] {"\u261D\u0308"});

    // ÷ 261D ÷ 1F1E6 ÷  #  ÷ [0.2] WHITE UP POINTING INDEX (E_Base) ÷ [999.0] REGIONAL INDICATOR
    // SYMBOL LETTER A (RI) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u261D\uD83C\uDDE6", new String[] {"\u261D"});

    // ÷ 261D × 0308 ÷ 1F1E6 ÷  #  ÷ [0.2] WHITE UP POINTING INDEX (E_Base) × [4.0] COMBINING
    // DIAERESIS (Extend_FE) ÷ [999.0] REGIONAL INDICATOR SYMBOL LETTER A (RI) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u261D\u0308\uD83C\uDDE6", new String[] {"\u261D\u0308"});

    // ÷ 261D ÷ 05D0 ÷  #  ÷ [0.2] WHITE UP POINTING INDEX (E_Base) ÷ [999.0] HEBREW LETTER ALEF
    // (Hebrew_Letter) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u261D\u05D0", new String[] {"\u261D", "\u05D0"});

    // ÷ 261D × 0308 ÷ 05D0 ÷  #  ÷ [0.2] WHITE UP POINTING INDEX (E_Base) × [4.0] COMBINING
    // DIAERESIS (Extend_FE) ÷ [999.0] HEBREW LETTER ALEF (Hebrew_Letter) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u261D\u0308\u05D0", new String[] {"\u261D\u0308", "\u05D0"});

    // ÷ 261D ÷ 0022 ÷  #  ÷ [0.2] WHITE UP POINTING INDEX (E_Base) ÷ [999.0] QUOTATION MARK
    // (Double_Quote) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u261D\"", new String[] {"\u261D"});

    // ÷ 261D × 0308 ÷ 0022 ÷  #  ÷ [0.2] WHITE UP POINTING INDEX (E_Base) × [4.0] COMBINING
    // DIAERESIS (Extend_FE) ÷ [999.0] QUOTATION MARK (Double_Quote) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u261D\u0308\"", new String[] {"\u261D\u0308"});

    // ÷ 261D ÷ 0027 ÷  #  ÷ [0.2] WHITE UP POINTING INDEX (E_Base) ÷ [999.0] APOSTROPHE
    // (Single_Quote) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u261D\u0027", new String[] {"\u261D"});

    // ÷ 261D × 0308 ÷ 0027 ÷  #  ÷ [0.2] WHITE UP POINTING INDEX (E_Base) × [4.0] COMBINING
    // DIAERESIS (Extend_FE) ÷ [999.0] APOSTROPHE (Single_Quote) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u261D\u0308\u0027", new String[] {"\u261D\u0308"});

    // ÷ 261D ÷ 261D ÷  #  ÷ [0.2] WHITE UP POINTING INDEX (E_Base) ÷ [999.0] WHITE UP POINTING
    // INDEX (E_Base) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u261D\u261D", new String[] {"\u261D", "\u261D"});

    // ÷ 261D × 0308 ÷ 261D ÷  #  ÷ [0.2] WHITE UP POINTING INDEX (E_Base) × [4.0] COMBINING
    // DIAERESIS (Extend_FE) ÷ [999.0] WHITE UP POINTING INDEX (E_Base) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u261D\u0308\u261D", new String[] {"\u261D\u0308", "\u261D"});

    // ÷ 261D × 1F3FB ÷  #  ÷ [0.2] WHITE UP POINTING INDEX (E_Base) × [14.0] EMOJI MODIFIER
    // FITZPATRICK TYPE-1-2 (E_Modifier) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u261D\uD83C\uDFFB", new String[] {"\u261D\uD83C\uDFFB"});

    // ÷ 261D × 0308 × 1F3FB ÷  #  ÷ [0.2] WHITE UP POINTING INDEX (E_Base) × [4.0] COMBINING
    // DIAERESIS (Extend_FE) × [14.0] EMOJI MODIFIER FITZPATRICK TYPE-1-2 (E_Modifier) ÷ [0.3]
    assertAnalyzesTo(
        analyzer, "\u261D\u0308\uD83C\uDFFB", new String[] {"\u261D\u0308\uD83C\uDFFB"});

    // ÷ 261D ÷ 2764 ÷  #  ÷ [0.2] WHITE UP POINTING INDEX (E_Base) ÷ [999.0] HEAVY BLACK HEART
    // (Glue_After_Zwj) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u261D\u2764", new String[] {"\u261D", "\u2764"});

    // ÷ 261D × 0308 ÷ 2764 ÷  #  ÷ [0.2] WHITE UP POINTING INDEX (E_Base) × [4.0] COMBINING
    // DIAERESIS (Extend_FE) ÷ [999.0] HEAVY BLACK HEART (Glue_After_Zwj) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u261D\u0308\u2764", new String[] {"\u261D\u0308", "\u2764"});
    ...
    // ÷ 261D × 0308 ÷ 1F466 ÷  #  ÷ [0.2] WHITE UP POINTING INDEX (E_Base) × [4.0] COMBINING
    // DIAERESIS (Extend_FE) ÷ [999.0] BOY (EBG) ÷ [0.3]
    assertAnalyzesTo(
        analyzer, "\u261D\u0308\uD83D\uDC66", new String[] {"\u261D\u0308", "\uD83D\uDC66"});

    // ÷ 261D × 00AD ÷  #  ÷ [0.2] WHITE UP POINTING INDEX (E_Base) × [4.0] SOFT HYPHEN (Format_FE)
    // ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u261D\u00AD", new String[] {"\u261D\u00AD"});

    // ÷ 261D × 0308 × 00AD ÷  #  ÷ [0.2] WHITE UP POINTING INDEX (E_Base) × [4.0] COMBINING
    // DIAERESIS (Extend_FE) × [4.0] SOFT HYPHEN (Format_FE) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u261D\u0308\u00AD", new String[] {"\u261D\u0308\u00AD"});

    // ÷ 261D × 0300 ÷  #  ÷ [0.2] WHITE UP POINTING INDEX (E_Base) × [4.0] COMBINING GRAVE ACCENT
    // (Extend_FE) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u261D\u0300", new String[] {"\u261D\u0300"});

    // ÷ 261D × 0308 × 0300 ÷  #  ÷ [0.2] WHITE UP POINTING INDEX (E_Base) × [4.0] COMBINING
    // DIAERESIS (Extend_FE) × [4.0] COMBINING GRAVE ACCENT (Extend_FE) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u261D\u0308\u0300", new String[] {"\u261D\u0308\u0300"});

    // ÷ 261D × 200D ÷  #  ÷ [0.2] WHITE UP POINTING INDEX (E_Base) × [4.0] ZERO WIDTH JOINER
    // (ZWJ_FE) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u261D\u200D", new String[] {"\u261D\u200D"});

    // ÷ 261D × 0308 × 200D ÷  #  ÷ [0.2] WHITE UP POINTING INDEX (E_Base) × [4.0] COMBINING
    // DIAERESIS (Extend_FE) × [4.0] ZERO WIDTH JOINER (ZWJ_FE) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u261D\u0308\u200D", new String[] {"\u261D\u0308\u200D"});

    // ÷ 261D ÷ 0061 × 2060 ÷  #  ÷ [0.2] WHITE UP POINTING INDEX (E_Base) ÷ [999.0] LATIN SMALL
    // LETTER A (ALetter) × [4.0] WORD JOINER (Format_FE) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u261D\u0061\u2060", new String[] {"\u261D", "\u0061\u2060"});

    // ÷ 261D × 0308 ÷ 0061 × 2060 ÷  #  ÷ [0.2] WHITE UP POINTING INDEX (E_Base) × [4.0] COMBINING
    // DIAERESIS (Extend_FE) ÷ [999.0] LATIN SMALL LETTER A (ALetter) × [4.0] WORD JOINER
    // (Format_FE) ÷ [0.3]
    assertAnalyzesTo(
        analyzer, "\u261D\u0308\u0061\u2060", new String[] {"\u261D\u0308", "\u0061\u2060"});

    // ÷ 261D ÷ 0061 ÷ 003A ÷  #  ÷ [0.2] WHITE UP POINTING INDEX (E_Base) ÷ [999.0] LATIN SMALL
    // LETTER A (ALetter) ÷ [999.0] COLON (MidLetter) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u261D\u0061\u003A", new String[] {"\u261D", "\u0061"});

    // ÷ 261D × 0308 ÷ 0061 ÷ 003A ÷  #  ÷ [0.2] WHITE UP POINTING INDEX (E_Base) × [4.0] COMBINING
    // DIAERESIS (Extend_FE) ÷ [999.0] LATIN SMALL LETTER A (ALetter) ÷ [999.0] COLON (MidLetter) ÷
    // [0.3]
    assertAnalyzesTo(analyzer, "\u261D\u0308\u0061\u003A", new String[] {"\u261D\u0308", "\u0061"});

    // ÷ 261D ÷ 0061 ÷ 0027 ÷  #  ÷ [0.2] WHITE UP POINTING INDEX (E_Base) ÷ [999.0] LATIN SMALL
    // LETTER A (ALetter) ÷ [999.0] APOSTROPHE (Single_Quote) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u261D\u0061\u0027", new String[] {"\u261D", "\u0061"});

    // ÷ 261D × 0308 ÷ 0061 ÷ 0027 ÷  #  ÷ [0.2] WHITE UP POINTING INDEX (E_Base) × [4.0] COMBINING
    // DIAERESIS (Extend_FE) ÷ [999.0] LATIN SMALL LETTER A (ALetter) ÷ [999.0] APOSTROPHE
    // (Single_Quote) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u261D\u0308\u0061\u0027", new String[] {"\u261D\u0308", "\u0061"});

    // ÷ 261D ÷ 0061 ÷ 0027 × 2060 ÷  #  ÷ [0.2] WHITE UP POINTING INDEX (E_Base) ÷ [999.0] LATIN
    // SMALL LETTER A (ALetter) ÷ [999.0] APOSTROPHE (Single_Quote) × [4.0] WORD JOINER (Format_FE)
    // ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u261D\u0061\u0027\u2060", new String[] {"\u261D", "\u0061"});

    // ÷ 261D × 0308 ÷ 0061 ÷ 0027 × 2060 ÷  #  ÷ [0.2] WHITE UP POINTING INDEX (E_Base) × [4.0]
    // COMBINING DIAERESIS (Extend_FE) ÷ [999.0] LATIN SMALL LETTER A (ALetter) ÷ [999.0] APOSTROPHE
    // (Single_Quote) × [4.0] WORD JOINER (Format_FE) ÷ [0.3]
    assertAnalyzesTo(
        analyzer, "\u261D\u0308\u0061\u0027\u2060", new String[] {"\u261D\u0308", "\u0061"});

    // ÷ 261D ÷ 0061 ÷ 002C ÷  #  ÷ [0.2] WHITE UP POINTING INDEX (E_Base) ÷ [999.0] LATIN SMALL
    // LETTER A (ALetter) ÷ [999.0] COMMA (MidNum) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u261D\u0061\u002C", new String[] {"\u261D", "\u0061"});

    // ÷ 261D × 0308 ÷ 0061 ÷ 002C ÷  #  ÷ [0.2] WHITE UP POINTING INDEX (E_Base) × [4.0] COMBINING
    // DIAERESIS (Extend_FE) ÷ [999.0] LATIN SMALL LETTER A (ALetter) ÷ [999.0] COMMA (MidNum) ÷
    // [0.3]
    assertAnalyzesTo(analyzer, "\u261D\u0308\u0061\u002C", new String[] {"\u261D\u0308", "\u0061"});

    // ÷ 261D ÷ 0031 ÷ 003A ÷  #  ÷ [0.2] WHITE UP POINTING INDEX (E_Base) ÷ [999.0] DIGIT ONE
    // (Numeric) ÷ [999.0] COLON (MidLetter) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u261D\u0031\u003A", new String[] {"\u261D", "\u0031"});

    // ÷ 261D × 0308 ÷ 0031 ÷ 003A ÷  #  ÷ [0.2] WHITE UP POINTING INDEX (E_Base) × [4.0] COMBINING
    // DIAERESIS (Extend_FE) ÷ [999.0] DIGIT ONE (Numeric) ÷ [999.0] COLON (MidLetter) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u261D\u0308\u0031\u003A", new String[] {"\u261D\u0308", "\u0031"});

    // ÷ 261D ÷ 0031 ÷ 0027 ÷  #  ÷ [0.2] WHITE UP POINTING INDEX (E_Base) ÷ [999.0] DIGIT ONE
    // (Numeric) ÷ [999.0] APOSTROPHE (Single_Quote) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u261D\u0031\u0027", new String[] {"\u261D", "\u0031"});

    // ÷ 261D × 0308 ÷ 0031 ÷ 0027 ÷  #  ÷ [0.2] WHITE UP POINTING INDEX (E_Base) × [4.0] COMBINING
    // DIAERESIS (Extend_FE) ÷ [999.0] DIGIT ONE (Numeric) ÷ [999.0] APOSTROPHE (Single_Quote) ÷
    // [0.3]
    assertAnalyzesTo(analyzer, "\u261D\u0308\u0031\u0027", new String[] {"\u261D\u0308", "\u0031"});

    // ÷ 261D ÷ 0031 ÷ 002C ÷  #  ÷ [0.2] WHITE UP POINTING INDEX (E_Base) ÷ [999.0] DIGIT ONE
    // (Numeric) ÷ [999.0] COMMA (MidNum) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u261D\u0031\u002C", new String[] {"\u261D", "\u0031"});

    // ÷ 261D × 0308 ÷ 0031 ÷ 002C ÷  #  ÷ [0.2] WHITE UP POINTING INDEX (E_Base) × [4.0] COMBINING
    // DIAERESIS (Extend_FE) ÷ [999.0] DIGIT ONE (Numeric) ÷ [999.0] COMMA (MidNum) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u261D\u0308\u0031\u002C", new String[] {"\u261D\u0308", "\u0031"});

    // ÷ 261D ÷ 0031 ÷ 002E × 2060 ÷  #  ÷ [0.2] WHITE UP POINTING INDEX (E_Base) ÷ [999.0] DIGIT
    // ONE (Numeric) ÷ [999.0] FULL STOP (MidNumLet) × [4.0] WORD JOINER (Format_FE) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u261D\u0031\u002E\u2060", new String[] {"\u261D", "\u0031"});

    // ÷ 261D × 0308 ÷ 0031 ÷ 002E × 2060 ÷  #  ÷ [0.2] WHITE UP POINTING INDEX (E_Base) × [4.0]
    // COMBINING DIAERESIS (Extend_FE) ÷ [999.0] DIGIT ONE (Numeric) ÷ [999.0] FULL STOP (MidNumLet)
    // × [4.0] WORD JOINER (Format_FE) ÷ [0.3]
    assertAnalyzesTo(
        analyzer, "\u261D\u0308\u0031\u002E\u2060", new String[] {"\u261D\u0308", "\u0031"});

    // ÷ 1F3FB ÷ 0001 ÷  #  ÷ [0.2] EMOJI MODIFIER FITZPATRICK TYPE-1-2 (E_Modifier) ÷ [999.0]
    // <START OF HEADING> (Other) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\uD83C\uDFFB\u0001", new String[] {"\uD83C\uDFFB"});

    // ÷ 1F3FB × 0308 ÷ 0001 ÷  #  ÷ [0.2] EMOJI MODIFIER FITZPATRICK TYPE-1-2 (E_Modifier) × [4.0]
    // COMBINING DIAERESIS (Extend_FE) ÷ [999.0] <START OF HEADING> (Other) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\uD83C\uDFFB\u0308\u0001", new String[] {"\uD83C\uDFFB\u0308"});

    // ÷ 1F3FB ÷ 000D ÷  #  ÷ [0.2] EMOJI MODIFIER FITZPATRICK TYPE-1-2 (E_Modifier) ÷ [3.2]
    // <CARRIAGE RETURN (CR)> (CR) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\uD83C\uDFFB\r", new String[] {"\uD83C\uDFFB"});

    // ÷ 1F3FB × 0308 ÷ 000D ÷  #  ÷ [0.2] EMOJI MODIFIER FITZPATRICK TYPE-1-2 (E_Modifier) × [4.0]
    // COMBINING DIAERESIS (Extend_FE) ÷ [3.2] <CARRIAGE RETURN (CR)> (CR) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\uD83C\uDFFB\u0308\r", new String[] {"\uD83C\uDFFB\u0308"});

    // ÷ 1F3FB ÷ 000A ÷  #  ÷ [0.2] EMOJI MODIFIER FITZPATRICK TYPE-1-2 (E_Modifier) ÷ [3.2] <LINE
    // FEED (LF)> (LF) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\uD83C\uDFFB\n", new String[] {"\uD83C\uDFFB"});

    // ÷ 1F3FB × 0308 ÷ 000A ÷  #  ÷ [0.2] EMOJI MODIFIER FITZPATRICK TYPE-1-2 (E_Modifier) × [4.0]
    // COMBINING DIAERESIS (Extend_FE) ÷ [3.2] <LINE FEED (LF)> (LF) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\uD83C\uDFFB\u0308\n", new String[] {"\uD83C\uDFFB\u0308"});

    // ÷ 1F3FB ÷ 000B ÷  #  ÷ [0.2] EMOJI MODIFIER FITZPATRICK TYPE-1-2 (E_Modifier) ÷ [3.2] <LINE
    // TABULATION> (Newline) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\uD83C\uDFFB\u000B", new String[] {"\uD83C\uDFFB"});

    // ÷ 1F3FB × 0308 ÷ 000B ÷  #  ÷ [0.2] EMOJI MODIFIER FITZPATRICK TYPE-1-2 (E_Modifier) × [4.0]
    // COMBINING DIAERESIS (Extend_FE) ÷ [3.2] <LINE TABULATION> (Newline) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\uD83C\uDFFB\u0308\u000B", new String[] {"\uD83C\uDFFB\u0308"});

    // ÷ 1F3FB ÷ 3031 ÷  #  ÷ [0.2] EMOJI MODIFIER FITZPATRICK TYPE-1-2 (E_Modifier) ÷ [999.0]
    // VERTICAL KANA REPEAT MARK (Katakana) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\uD83C\uDFFB\u3031", new String[] {"\uD83C\uDFFB", "\u3031"});

    // ÷ 1F3FB × 0308 ÷ 3031 ÷  #  ÷ [0.2] EMOJI MODIFIER FITZPATRICK TYPE-1-2 (E_Modifier) × [4.0]
    // COMBINING DIAERESIS (Extend_FE) ÷ [999.0] VERTICAL KANA REPEAT MARK (Katakana) ÷ [0.3]
    assertAnalyzesTo(
        analyzer, "\uD83C\uDFFB\u0308\u3031", new String[] {"\uD83C\uDFFB\u0308", "\u3031"});

    // ÷ 1F3FB ÷ 0041 ÷  #  ÷ [0.2] EMOJI MODIFIER FITZPATRICK TYPE-1-2 (E_Modifier) ÷ [999.0] LATIN
    // CAPITAL LETTER A (ALetter) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\uD83C\uDFFB\u0041", new String[] {"\uD83C\uDFFB", "\u0041"});

    // ÷ 1F3FB × 0308 ÷ 0041 ÷  #  ÷ [0.2] EMOJI MODIFIER FITZPATRICK TYPE-1-2 (E_Modifier) × [4.0]
    // COMBINING DIAERESIS (Extend_FE) ÷ [999.0] LATIN CAPITAL LETTER A (ALetter) ÷ [0.3]
    assertAnalyzesTo(
        analyzer, "\uD83C\uDFFB\u0308\u0041", new String[] {"\uD83C\uDFFB\u0308", "\u0041"});

    // ÷ 1F3FB ÷ 003A ÷  #  ÷ [0.2] EMOJI MODIFIER FITZPATRICK TYPE-1-2 (E_Modifier) ÷ [999.0] COLON
    // (MidLetter) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\uD83C\uDFFB\u003A", new String[] {"\uD83C\uDFFB"});

    // ÷ 1F3FB × 0308 ÷ 003A ÷  #  ÷ [0.2] EMOJI MODIFIER FITZPATRICK TYPE-1-2 (E_Modifier) × [4.0]
    // COMBINING DIAERESIS (Extend_FE) ÷ [999.0] COLON (MidLetter) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\uD83C\uDFFB\u0308\u003A", new String[] {"\uD83C\uDFFB\u0308"});

    // ÷ 1F3FB ÷ 002C ÷  #  ÷ [0.2] EMOJI MODIFIER FITZPATRICK TYPE-1-2 (E_Modifier) ÷ [999.0] COMMA
    // (MidNum) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\uD83C\uDFFB\u002C", new String[] {"\uD83C\uDFFB"});

    // ÷ 1F3FB × 0308 ÷ 002C ÷  #  ÷ [0.2] EMOJI MODIFIER FITZPATRICK TYPE-1-2 (E_Modifier) × [4.0]
    // COMBINING DIAERESIS (Extend_FE) ÷ [999.0] COMMA (MidNum) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\uD83C\uDFFB\u0308\u002C", new String[] {"\uD83C\uDFFB\u0308"});

    // ÷ 1F3FB ÷ 002E ÷  #  ÷ [0.2] EMOJI MODIFIER FITZPATRICK TYPE-1-2 (E_Modifier) ÷ [999.0] FULL
    // STOP (MidNumLet) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\uD83C\uDFFB\u002E", new String[] {"\uD83C\uDFFB"});

    // ÷ 1F3FB × 0308 ÷ 002E ÷  #  ÷ [0.2] EMOJI MODIFIER FITZPATRICK TYPE-1-2 (E_Modifier) × [4.0]
    // COMBINING DIAERESIS (Extend_FE) ÷ [999.0] FULL STOP (MidNumLet) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\uD83C\uDFFB\u0308\u002E", new String[] {"\uD83C\uDFFB\u0308"});

    // ÷ 1F3FB ÷ 0030 ÷  #  ÷ [0.2] EMOJI MODIFIER FITZPATRICK TYPE-1-2 (E_Modifier) ÷ [999.0] DIGIT
    // ZERO (Numeric) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\uD83C\uDFFB\u0030", new String[] {"\uD83C\uDFFB", "\u0030"});

    // ÷ 1F3FB × 0308 ÷ 0030 ÷  #  ÷ [0.2] EMOJI MODIFIER FITZPATRICK TYPE-1-2 (E_Modifier) × [4.0]
    // COMBINING DIAERESIS (Extend_FE) ÷ [999.0] DIGIT ZERO (Numeric) ÷ [0.3]
    assertAnalyzesTo(
        analyzer, "\uD83C\uDFFB\u0308\u0030", new String[] {"\uD83C\uDFFB\u0308", "\u0030"});

    // ÷ 1F3FB ÷ 005F ÷  #  ÷ [0.2] EMOJI MODIFIER FITZPATRICK TYPE-1-2 (E_Modifier) ÷ [999.0] LOW
    // LINE (ExtendNumLet) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\uD83C\uDFFB\u005F", new String[] {"\uD83C\uDFFB"});

    // ÷ 1F3FB × 0308 ÷ 005F ÷  #  ÷ [0.2] EMOJI MODIFIER FITZPATRICK TYPE-1-2 (E_Modifier) × [4.0]
    // COMBINING DIAERESIS (Extend_FE) ÷ [999.0] LOW LINE (ExtendNumLet) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\uD83C\uDFFB\u0308\u005F", new String[] {"\uD83C\uDFFB\u0308"});

    // ÷ 1F3FB ÷ 1F1E6 ÷  #  ÷ [0.2] EMOJI MODIFIER FITZPATRICK TYPE-1-2 (E_Modifier) ÷ [999.0]
    // REGIONAL INDICATOR SYMBOL LETTER A (RI) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\uD83C\uDFFB\uD83C\uDDE6", new String[] {"\uD83C\uDFFB"});

    // ÷ 1F3FB × 0308 ÷ 1F1E6 ÷  #  ÷ [0.2] EMOJI MODIFIER FITZPATRICK TYPE-1-2 (E_Modifier) × [4.0]
    // COMBINING DIAERESIS (Extend_FE) ÷ [999.0] REGIONAL INDICATOR SYMBOL LETTER A (RI) ÷ [0.3]
    assertAnalyzesTo(
        analyzer, "\uD83C\uDFFB\u0308\uD83C\uDDE6", new String[] {"\uD83C\uDFFB\u0308"});

    // ÷ 1F3FB ÷ 05D0 ÷  #  ÷ [0.2] EMOJI MODIFIER FITZPATRICK TYPE-1-2 (E_Modifier) ÷ [999.0]
    // HEBREW LETTER ALEF (Hebrew_Letter) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\uD83C\uDFFB\u05D0", new String[] {"\uD83C\uDFFB", "\u05D0"});

    // ÷ 1F3FB × 0308 ÷ 05D0 ÷  #  ÷ [0.2] EMOJI MODIFIER FITZPATRICK TYPE-1-2 (E_Modifier) × [4.0]
    // COMBINING DIAERESIS (Extend_FE) ÷ [999.0] HEBREW LETTER ALEF (Hebrew_Letter) ÷ [0.3]
    assertAnalyzesTo(
        analyzer, "\uD83C\uDFFB\u0308\u05D0", new String[] {"\uD83C\uDFFB\u0308", "\u05D0"});

    // ÷ 1F3FB ÷ 0022 ÷  #  ÷ [0.2] EMOJI MODIFIER FITZPATRICK TYPE-1-2 (E_Modifier) ÷ [999.0]
    // QUOTATION MARK (Double_Quote) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\uD83C\uDFFB\"", new String[] {"\uD83C\uDFFB"});

    // ÷ 1F3FB × 0308 ÷ 0022 ÷  #  ÷ [0.2] EMOJI MODIFIER FITZPATRICK TYPE-1-2 (E_Modifier) × [4.0]
    // COMBINING DIAERESIS (Extend_FE) ÷ [999.0] QUOTATION MARK (Double_Quote) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\uD83C\uDFFB\u0308\"", new String[] {"\uD83C\uDFFB\u0308"});

    // ÷ 1F3FB ÷ 0027 ÷  #  ÷ [0.2] EMOJI MODIFIER FITZPATRICK TYPE-1-2 (E_Modifier) ÷ [999.0]
    // APOSTROPHE (Single_Quote) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\uD83C\uDFFB\u0027", new String[] {"\uD83C\uDFFB"});

    // ÷ 1F3FB × 0308 ÷ 0027 ÷  #  ÷ [0.2] EMOJI MODIFIER FITZPATRICK TYPE-1-2 (E_Modifier) × [4.0]
    // COMBINING DIAERESIS (Extend_FE) ÷ [999.0] APOSTROPHE (Single_Quote) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\uD83C\uDFFB\u0308\u0027", new String[] {"\uD83C\uDFFB\u0308"});

    // ÷ 1F3FB ÷ 261D ÷  #  ÷ [0.2] EMOJI MODIFIER FITZPATRICK TYPE-1-2 (E_Modifier) ÷ [999.0] WHITE
    // UP POINTING INDEX (E_Base) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\uD83C\uDFFB\u261D", new String[] {"\uD83C\uDFFB", "\u261D"});

    // ÷ 1F3FB × 0308 ÷ 261D ÷  #  ÷ [0.2] EMOJI MODIFIER FITZPATRICK TYPE-1-2 (E_Modifier) × [4.0]
    // COMBINING DIAERESIS (Extend_FE) ÷ [999.0] WHITE UP POINTING INDEX (E_Base) ÷ [0.3]
    assertAnalyzesTo(
        analyzer, "\uD83C\uDFFB\u0308\u261D", new String[] {"\uD83C\uDFFB\u0308", "\u261D"});

    // ÷ 1F3FB ÷ 1F3FB ÷  #  ÷ [0.2] EMOJI MODIFIER FITZPATRICK TYPE-1-2 (E_Modifier) ÷ [999.0]
    // EMOJI MODIFIER FITZPATRICK TYPE-1-2 (E_Modifier) ÷ [0.3]
    assertAnalyzesTo(
        analyzer, "\uD83C\uDFFB\uD83C\uDFFB", new String[] {"\uD83C\uDFFB", "\uD83C\uDFFB"});

    // ÷ 1F3FB × 0308 ÷ 1F3FB ÷  #  ÷ [0.2] EMOJI MODIFIER FITZPATRICK TYPE-1-2 (E_Modifier) × [4.0]
    // COMBINING DIAERESIS (Extend_FE) ÷ [999.0] EMOJI MODIFIER FITZPATRICK TYPE-1-2 (E_Modifier) ÷
    // [0.3]
    assertAnalyzesTo(
        analyzer,
    ...
    // ÷ 1F3FB ÷ 2764 ÷  #  ÷ [0.2] EMOJI MODIFIER FITZPATRICK TYPE-1-2 (E_Modifier) ÷ [999.0] HEAVY
    // BLACK HEART (Glue_After_Zwj) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\uD83C\uDFFB\u2764", new String[] {"\uD83C\uDFFB", "\u2764"});

    // ÷ 1F3FB × 0308 ÷ 2764 ÷  #  ÷ [0.2] EMOJI MODIFIER FITZPATRICK TYPE-1-2 (E_Modifier) × [4.0]
    // COMBINING DIAERESIS (Extend_FE) ÷ [999.0] HEAVY BLACK HEART (Glue_After_Zwj) ÷ [0.3]
    assertAnalyzesTo(
        analyzer, "\uD83C\uDFFB\u0308\u2764", new String[] {"\uD83C\uDFFB\u0308", "\u2764"});

    // ÷ 1F3FB ÷ 1F466 ÷  #  ÷ [0.2] EMOJI MODIFIER FITZPATRICK TYPE-1-2 (E_Modifier) ÷ [999.0] BOY
    // (EBG) ÷ [0.3]
    assertAnalyzesTo(
        analyzer, "\uD83C\uDFFB\uD83D\uDC66", new String[] {"\uD83C\uDFFB", "\uD83D\uDC66"});

    // ÷ 1F3FB × 0308 ÷ 1F466 ÷  #  ÷ [0.2] EMOJI MODIFIER FITZPATRICK TYPE-1-2 (E_Modifier) × [4.0]
    // COMBINING DIAERESIS (Extend_FE) ÷ [999.0] BOY (EBG) ÷ [0.3]
    assertAnalyzesTo(
        analyzer,
        "\uD83C\uDFFB\u0308\uD83D\uDC66",
    ...
    // ÷ 1F3FB × 00AD ÷  #  ÷ [0.2] EMOJI MODIFIER FITZPATRICK TYPE-1-2 (E_Modifier) × [4.0] SOFT
    // HYPHEN (Format_FE) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\uD83C\uDFFB\u00AD", new String[] {"\uD83C\uDFFB\u00AD"});

    // ÷ 1F3FB × 0308 × 00AD ÷  #  ÷ [0.2] EMOJI MODIFIER FITZPATRICK TYPE-1-2 (E_Modifier) × [4.0]
    // COMBINING DIAERESIS (Extend_FE) × [4.0] SOFT HYPHEN (Format_FE) ÷ [0.3]
    assertAnalyzesTo(
        analyzer, "\uD83C\uDFFB\u0308\u00AD", new String[] {"\uD83C\uDFFB\u0308\u00AD"});

    // ÷ 1F3FB × 0300 ÷  #  ÷ [0.2] EMOJI MODIFIER FITZPATRICK TYPE-1-2 (E_Modifier) × [4.0]
    // COMBINING GRAVE ACCENT (Extend_FE) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\uD83C\uDFFB\u0300", new String[] {"\uD83C\uDFFB\u0300"});

    // ÷ 1F3FB × 0308 × 0300 ÷  #  ÷ [0.2] EMOJI MODIFIER FITZPATRICK TYPE-1-2 (E_Modifier) × [4.0]
    // COMBINING DIAERESIS (Extend_FE) × [4.0] COMBINING GRAVE ACCENT (Extend_FE) ÷ [0.3]
    assertAnalyzesTo(
        analyzer, "\uD83C\uDFFB\u0308\u0300", new String[] {"\uD83C\uDFFB\u0308\u0300"});

    // ÷ 1F3FB × 200D ÷  #  ÷ [0.2] EMOJI MODIFIER FITZPATRICK TYPE-1-2 (E_Modifier) × [4.0] ZERO
    // WIDTH JOINER (ZWJ_FE) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\uD83C\uDFFB\u200D", new String[] {"\uD83C\uDFFB\u200D"});

    // ÷ 1F3FB × 0308 × 200D ÷  #  ÷ [0.2] EMOJI MODIFIER FITZPATRICK TYPE-1-2 (E_Modifier) × [4.0]
    // COMBINING DIAERESIS (Extend_FE) × [4.0] ZERO WIDTH JOINER (ZWJ_FE) ÷ [0.3]
    assertAnalyzesTo(
        analyzer, "\uD83C\uDFFB\u0308\u200D", new String[] {"\uD83C\uDFFB\u0308\u200D"});

    // ÷ 1F3FB ÷ 0061 × 2060 ÷  #  ÷ [0.2] EMOJI MODIFIER FITZPATRICK TYPE-1-2 (E_Modifier) ÷
    // [999.0] LATIN SMALL LETTER A (ALetter) × [4.0] WORD JOINER (Format_FE) ÷ [0.3]
    assertAnalyzesTo(
        analyzer, "\uD83C\uDFFB\u0061\u2060", new String[] {"\uD83C\uDFFB", "\u0061\u2060"});

    // ÷ 1F3FB × 0308 ÷ 0061 × 2060 ÷  #  ÷ [0.2] EMOJI MODIFIER FITZPATRICK TYPE-1-2 (E_Modifier) ×
    ...
    // ÷ 1F3FB ÷ 0061 ÷ 003A ÷  #  ÷ [0.2] EMOJI MODIFIER FITZPATRICK TYPE-1-2 (E_Modifier) ÷
    // [999.0] LATIN SMALL LETTER A (ALetter) ÷ [999.0] COLON (MidLetter) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\uD83C\uDFFB\u0061\u003A", new String[] {"\uD83C\uDFFB", "\u0061"});

    // ÷ 1F3FB × 0308 ÷ 0061 ÷ 003A ÷  #  ÷ [0.2] EMOJI MODIFIER FITZPATRICK TYPE-1-2 (E_Modifier) ×
    // [4.0] COMBINING DIAERESIS (Extend_FE) ÷ [999.0] LATIN SMALL LETTER A (ALetter) ÷ [999.0]
    // COLON (MidLetter) ÷ [0.3]
    assertAnalyzesTo(
        analyzer, "\uD83C\uDFFB\u0308\u0061\u003A", new String[] {"\uD83C\uDFFB\u0308", "\u0061"});

    // ÷ 1F3FB ÷ 0061 ÷ 0027 ÷  #  ÷ [0.2] EMOJI MODIFIER FITZPATRICK TYPE-1-2 (E_Modifier) ÷
    // [999.0] LATIN SMALL LETTER A (ALetter) ÷ [999.0] APOSTROPHE (Single_Quote) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\uD83C\uDFFB\u0061\u0027", new String[] {"\uD83C\uDFFB", "\u0061"});

    // ÷ 1F3FB × 0308 ÷ 0061 ÷ 0027 ÷  #  ÷ [0.2] EMOJI MODIFIER FITZPATRICK TYPE-1-2 (E_Modifier) ×
    // [4.0] COMBINING DIAERESIS (Extend_FE) ÷ [999.0] LATIN SMALL LETTER A (ALetter) ÷ [999.0]
    // APOSTROPHE (Single_Quote) ÷ [0.3]
    assertAnalyzesTo(
        analyzer, "\uD83C\uDFFB\u0308\u0061\u0027", new String[] {"\uD83C\uDFFB\u0308", "\u0061"});

    // ÷ 1F3FB ÷ 0061 ÷ 0027 × 2060 ÷  #  ÷ [0.2] EMOJI MODIFIER FITZPATRICK TYPE-1-2 (E_Modifier) ÷
    // [999.0] LATIN SMALL LETTER A (ALetter) ÷ [999.0] APOSTROPHE (Single_Quote) × [4.0] WORD
    // JOINER (Format_FE) ÷ [0.3]
    assertAnalyzesTo(
        analyzer, "\uD83C\uDFFB\u0061\u0027\u2060", new String[] {"\uD83C\uDFFB", "\u0061"});

    // ÷ 1F3FB × 0308 ÷ 0061 ÷ 0027 × 2060 ÷  #  ÷ [0.2] EMOJI MODIFIER FITZPATRICK TYPE-1-2
    // (E_Modifier) × [4.0] COMBINING DIAERESIS (Extend_FE) ÷ [999.0] LATIN SMALL LETTER A (ALetter)
    ...
    // ÷ 1F3FB ÷ 0061 ÷ 002C ÷  #  ÷ [0.2] EMOJI MODIFIER FITZPATRICK TYPE-1-2 (E_Modifier) ÷
    // [999.0] LATIN SMALL LETTER A (ALetter) ÷ [999.0] COMMA (MidNum) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\uD83C\uDFFB\u0061\u002C", new String[] {"\uD83C\uDFFB", "\u0061"});

    // ÷ 1F3FB × 0308 ÷ 0061 ÷ 002C ÷  #  ÷ [0.2] EMOJI MODIFIER FITZPATRICK TYPE-1-2 (E_Modifier) ×
    // [4.0] COMBINING DIAERESIS (Extend_FE) ÷ [999.0] LATIN SMALL LETTER A (ALetter) ÷ [999.0]
    // COMMA (MidNum) ÷ [0.3]
    assertAnalyzesTo(
        analyzer, "\uD83C\uDFFB\u0308\u0061\u002C", new String[] {"\uD83C\uDFFB\u0308", "\u0061"});

    // ÷ 1F3FB ÷ 0031 ÷ 003A ÷  #  ÷ [0.2] EMOJI MODIFIER FITZPATRICK TYPE-1-2 (E_Modifier) ÷
    // [999.0] DIGIT ONE (Numeric) ÷ [999.0] COLON (MidLetter) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\uD83C\uDFFB\u0031\u003A", new String[] {"\uD83C\uDFFB", "\u0031"});

    // ÷ 1F3FB × 0308 ÷ 0031 ÷ 003A ÷  #  ÷ [0.2] EMOJI MODIFIER FITZPATRICK TYPE-1-2 (E_Modifier) ×
    // [4.0] COMBINING DIAERESIS (Extend_FE) ÷ [999.0] DIGIT ONE (Numeric) ÷ [999.0] COLON
    // (MidLetter) ÷ [0.3]
    assertAnalyzesTo(
        analyzer, "\uD83C\uDFFB\u0308\u0031\u003A", new String[] {"\uD83C\uDFFB\u0308", "\u0031"});

    // ÷ 1F3FB ÷ 0031 ÷ 0027 ÷  #  ÷ [0.2] EMOJI MODIFIER FITZPATRICK TYPE-1-2 (E_Modifier) ÷
    // [999.0] DIGIT ONE (Numeric) ÷ [999.0] APOSTROPHE (Single_Quote) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\uD83C\uDFFB\u0031\u0027", new String[] {"\uD83C\uDFFB", "\u0031"});

    // ÷ 1F3FB × 0308 ÷ 0031 ÷ 0027 ÷  #  ÷ [0.2] EMOJI MODIFIER FITZPATRICK TYPE-1-2 (E_Modifier) ×
    // [4.0] COMBINING DIAERESIS (Extend_FE) ÷ [999.0] DIGIT ONE (Numeric) ÷ [999.0] APOSTROPHE
    // (Single_Quote) ÷ [0.3]
    assertAnalyzesTo(
        analyzer, "\uD83C\uDFFB\u0308\u0031\u0027", new String[] {"\uD83C\uDFFB\u0308", "\u0031"});

    // ÷ 1F3FB ÷ 0031 ÷ 002C ÷  #  ÷ [0.2] EMOJI MODIFIER FITZPATRICK TYPE-1-2 (E_Modifier) ÷
    // [999.0] DIGIT ONE (Numeric) ÷ [999.0] COMMA (MidNum) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\uD83C\uDFFB\u0031\u002C", new String[] {"\uD83C\uDFFB", "\u0031"});

    // ÷ 1F3FB × 0308 ÷ 0031 ÷ 002C ÷  #  ÷ [0.2] EMOJI MODIFIER FITZPATRICK TYPE-1-2 (E_Modifier) ×
    // [4.0] COMBINING DIAERESIS (Extend_FE) ÷ [999.0] DIGIT ONE (Numeric) ÷ [999.0] COMMA (MidNum)
    // ÷ [0.3]
    assertAnalyzesTo(
        analyzer, "\uD83C\uDFFB\u0308\u0031\u002C", new String[] {"\uD83C\uDFFB\u0308", "\u0031"});

    // ÷ 1F3FB ÷ 0031 ÷ 002E × 2060 ÷  #  ÷ [0.2] EMOJI MODIFIER FITZPATRICK TYPE-1-2 (E_Modifier) ÷
    // [999.0] DIGIT ONE (Numeric) ÷ [999.0] FULL STOP (MidNumLet) × [4.0] WORD JOINER (Format_FE) ÷
    // [0.3]
    assertAnalyzesTo(
        analyzer, "\uD83C\uDFFB\u0031\u002E\u2060", new String[] {"\uD83C\uDFFB", "\u0031"});

    // ÷ 1F3FB × 0308 ÷ 0031 ÷ 002E × 2060 ÷  #  ÷ [0.2] EMOJI MODIFIER FITZPATRICK TYPE-1-2
    // (E_Modifier) × [4.0] COMBINING DIAERESIS (Extend_FE) ÷ [999.0] DIGIT ONE (Numeric) ÷ [999.0]
    ...
    // ÷ 2764 ÷ 0001 ÷  #  ÷ [0.2] HEAVY BLACK HEART (Glue_After_Zwj) ÷ [999.0] <START OF HEADING>
    // (Other) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u2764\u0001", new String[] {"\u2764"});

    // ÷ 2764 × 0308 ÷ 0001 ÷  #  ÷ [0.2] HEAVY BLACK HEART (Glue_After_Zwj) × [4.0] COMBINING
    // DIAERESIS (Extend_FE) ÷ [999.0] <START OF HEADING> (Other) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u2764\u0308\u0001", new String[] {"\u2764\u0308"});

    // ÷ 2764 ÷ 000D ÷  #  ÷ [0.2] HEAVY BLACK HEART (Glue_After_Zwj) ÷ [3.2] <CARRIAGE RETURN (CR)>
    // (CR) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u2764\r", new String[] {"\u2764"});

    // ÷ 2764 × 0308 ÷ 000D ÷  #  ÷ [0.2] HEAVY BLACK HEART (Glue_After_Zwj) × [4.0] COMBINING
    // DIAERESIS (Extend_FE) ÷ [3.2] <CARRIAGE RETURN (CR)> (CR) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u2764\u0308\r", new String[] {"\u2764\u0308"});

    // ÷ 2764 ÷ 000A ÷  #  ÷ [0.2] HEAVY BLACK HEART (Glue_After_Zwj) ÷ [3.2] <LINE FEED (LF)> (LF)
    // ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u2764\n", new String[] {"\u2764"});

    // ÷ 2764 × 0308 ÷ 000A ÷  #  ÷ [0.2] HEAVY BLACK HEART (Glue_After_Zwj) × [4.0] COMBINING
    // DIAERESIS (Extend_FE) ÷ [3.2] <LINE FEED (LF)> (LF) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u2764\u0308\n", new String[] {"\u2764\u0308"});

    // ÷ 2764 ÷ 000B ÷  #  ÷ [0.2] HEAVY BLACK HEART (Glue_After_Zwj) ÷ [3.2] <LINE TABULATION>
    // (Newline) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u2764\u000B", new String[] {"\u2764"});

    // ÷ 2764 × 0308 ÷ 000B ÷  #  ÷ [0.2] HEAVY BLACK HEART (Glue_After_Zwj) × [4.0] COMBINING
    // DIAERESIS (Extend_FE) ÷ [3.2] <LINE TABULATION> (Newline) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u2764\u0308\u000B", new String[] {"\u2764\u0308"});

    // ÷ 2764 ÷ 3031 ÷  #  ÷ [0.2] HEAVY BLACK HEART (Glue_After_Zwj) ÷ [999.0] VERTICAL KANA REPEAT
    // MARK (Katakana) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u2764\u3031", new String[] {"\u2764", "\u3031"});

    // ÷ 2764 × 0308 ÷ 3031 ÷  #  ÷ [0.2] HEAVY BLACK HEART (Glue_After_Zwj) × [4.0] COMBINING
    // DIAERESIS (Extend_FE) ÷ [999.0] VERTICAL KANA REPEAT MARK (Katakana) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u2764\u0308\u3031", new String[] {"\u2764\u0308", "\u3031"});

    // ÷ 2764 ÷ 0041 ÷  #  ÷ [0.2] HEAVY BLACK HEART (Glue_After_Zwj) ÷ [999.0] LATIN CAPITAL LETTER
    // A (ALetter) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u2764\u0041", new String[] {"\u2764", "\u0041"});

    // ÷ 2764 × 0308 ÷ 0041 ÷  #  ÷ [0.2] HEAVY BLACK HEART (Glue_After_Zwj) × [4.0] COMBINING
    // DIAERESIS (Extend_FE) ÷ [999.0] LATIN CAPITAL LETTER A (ALetter) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u2764\u0308\u0041", new String[] {"\u2764\u0308", "\u0041"});

    // ÷ 2764 ÷ 003A ÷  #  ÷ [0.2] HEAVY BLACK HEART (Glue_After_Zwj) ÷ [999.0] COLON (MidLetter) ÷
    // [0.3]
    assertAnalyzesTo(analyzer, "\u2764\u003A", new String[] {"\u2764"});

    // ÷ 2764 × 0308 ÷ 003A ÷  #  ÷ [0.2] HEAVY BLACK HEART (Glue_After_Zwj) × [4.0] COMBINING
    // DIAERESIS (Extend_FE) ÷ [999.0] COLON (MidLetter) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u2764\u0308\u003A", new String[] {"\u2764\u0308"});

    // ÷ 2764 ÷ 002C ÷  #  ÷ [0.2] HEAVY BLACK HEART (Glue_After_Zwj) ÷ [999.0] COMMA (MidNum) ÷
    // [0.3]
    assertAnalyzesTo(analyzer, "\u2764\u002C", new String[] {"\u2764"});

    // ÷ 2764 × 0308 ÷ 002C ÷  #  ÷ [0.2] HEAVY BLACK HEART (Glue_After_Zwj) × [4.0] COMBINING
    // DIAERESIS (Extend_FE) ÷ [999.0] COMMA (MidNum) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u2764\u0308\u002C", new String[] {"\u2764\u0308"});

    // ÷ 2764 ÷ 002E ÷  #  ÷ [0.2] HEAVY BLACK HEART (Glue_After_Zwj) ÷ [999.0] FULL STOP
    // (MidNumLet) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u2764\u002E", new String[] {"\u2764"});

    // ÷ 2764 × 0308 ÷ 002E ÷  #  ÷ [0.2] HEAVY BLACK HEART (Glue_After_Zwj) × [4.0] COMBINING
    // DIAERESIS (Extend_FE) ÷ [999.0] FULL STOP (MidNumLet) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u2764\u0308\u002E", new String[] {"\u2764\u0308"});

    // ÷ 2764 ÷ 0030 ÷  #  ÷ [0.2] HEAVY BLACK HEART (Glue_After_Zwj) ÷ [999.0] DIGIT ZERO (Numeric)
    // ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u2764\u0030", new String[] {"\u2764", "\u0030"});

    // ÷ 2764 × 0308 ÷ 0030 ÷  #  ÷ [0.2] HEAVY BLACK HEART (Glue_After_Zwj) × [4.0] COMBINING
    // DIAERESIS (Extend_FE) ÷ [999.0] DIGIT ZERO (Numeric) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u2764\u0308\u0030", new String[] {"\u2764\u0308", "\u0030"});

    // ÷ 2764 ÷ 005F ÷  #  ÷ [0.2] HEAVY BLACK HEART (Glue_After_Zwj) ÷ [999.0] LOW LINE
    // (ExtendNumLet) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u2764\u005F", new String[] {"\u2764"});

    // ÷ 2764 × 0308 ÷ 005F ÷  #  ÷ [0.2] HEAVY BLACK HEART (Glue_After_Zwj) × [4.0] COMBINING
    // DIAERESIS (Extend_FE) ÷ [999.0] LOW LINE (ExtendNumLet) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u2764\u0308\u005F", new String[] {"\u2764\u0308"});

    // ÷ 2764 ÷ 1F1E6 ÷  #  ÷ [0.2] HEAVY BLACK HEART (Glue_After_Zwj) ÷ [999.0] REGIONAL INDICATOR
    // SYMBOL LETTER A (RI) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u2764\uD83C\uDDE6", new String[] {"\u2764"});

    // ÷ 2764 × 0308 ÷ 1F1E6 ÷  #  ÷ [0.2] HEAVY BLACK HEART (Glue_After_Zwj) × [4.0] COMBINING
    // DIAERESIS (Extend_FE) ÷ [999.0] REGIONAL INDICATOR SYMBOL LETTER A (RI) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u2764\u0308\uD83C\uDDE6", new String[] {"\u2764\u0308"});

    // ÷ 2764 ÷ 05D0 ÷  #  ÷ [0.2] HEAVY BLACK HEART (Glue_After_Zwj) ÷ [999.0] HEBREW LETTER ALEF
    // (Hebrew_Letter) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u2764\u05D0", new String[] {"\u2764", "\u05D0"});

    // ÷ 2764 × 0308 ÷ 05D0 ÷  #  ÷ [0.2] HEAVY BLACK HEART (Glue_After_Zwj) × [4.0] COMBINING
    // DIAERESIS (Extend_FE) ÷ [999.0] HEBREW LETTER ALEF (Hebrew_Letter) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u2764\u0308\u05D0", new String[] {"\u2764\u0308", "\u05D0"});

    // ÷ 2764 ÷ 0022 ÷  #  ÷ [0.2] HEAVY BLACK HEART (Glue_After_Zwj) ÷ [999.0] QUOTATION MARK
    // (Double_Quote) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u2764\"", new String[] {"\u2764"});

    // ÷ 2764 × 0308 ÷ 0022 ÷  #  ÷ [0.2] HEAVY BLACK HEART (Glue_After_Zwj) × [4.0] COMBINING
    // DIAERESIS (Extend_FE) ÷ [999.0] QUOTATION MARK (Double_Quote) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u2764\u0308\"", new String[] {"\u2764\u0308"});

    // ÷ 2764 ÷ 0027 ÷  #  ÷ [0.2] HEAVY BLACK HEART (Glue_After_Zwj) ÷ [999.0] APOSTROPHE
    // (Single_Quote) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u2764\u0027", new String[] {"\u2764"});

    // ÷ 2764 × 0308 ÷ 0027 ÷  #  ÷ [0.2] HEAVY BLACK HEART (Glue_After_Zwj) × [4.0] COMBINING
    // DIAERESIS (Extend_FE) ÷ [999.0] APOSTROPHE (Single_Quote) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u2764\u0308\u0027", new String[] {"\u2764\u0308"});

    // ÷ 2764 ÷ 261D ÷  #  ÷ [0.2] HEAVY BLACK HEART (Glue_After_Zwj) ÷ [999.0] WHITE UP POINTING
    // INDEX (E_Base) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u2764\u261D", new String[] {"\u2764", "\u261D"});

    // ÷ 2764 × 0308 ÷ 261D ÷  #  ÷ [0.2] HEAVY BLACK HEART (Glue_After_Zwj) × [4.0] COMBINING
    // DIAERESIS (Extend_FE) ÷ [999.0] WHITE UP POINTING INDEX (E_Base) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u2764\u0308\u261D", new String[] {"\u2764\u0308", "\u261D"});

    // ÷ 2764 ÷ 1F3FB ÷  #  ÷ [0.2] HEAVY BLACK HEART (Glue_After_Zwj) ÷ [999.0] EMOJI MODIFIER
    // FITZPATRICK TYPE-1-2 (E_Modifier) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u2764\uD83C\uDFFB", new String[] {"\u2764", "\uD83C\uDFFB"});

    // ÷ 2764 × 0308 ÷ 1F3FB ÷  #  ÷ [0.2] HEAVY BLACK HEART (Glue_After_Zwj) × [4.0] COMBINING
    // DIAERESIS (Extend_FE) ÷ [999.0] EMOJI MODIFIER FITZPATRICK TYPE-1-2 (E_Modifier) ÷ [0.3]
    assertAnalyzesTo(
        analyzer, "\u2764\u0308\uD83C\uDFFB", new String[] {"\u2764\u0308", "\uD83C\uDFFB"});

    // ÷ 2764 ÷ 2764 ÷  #  ÷ [0.2] HEAVY BLACK HEART (Glue_After_Zwj) ÷ [999.0] HEAVY BLACK HEART
    // (Glue_After_Zwj) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u2764\u2764", new String[] {"\u2764", "\u2764"});

    // ÷ 2764 × 0308 ÷ 2764 ÷  #  ÷ [0.2] HEAVY BLACK HEART (Glue_After_Zwj) × [4.0] COMBINING
    // DIAERESIS (Extend_FE) ÷ [999.0] HEAVY BLACK HEART (Glue_After_Zwj) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u2764\u0308\u2764", new String[] {"\u2764\u0308", "\u2764"});
    ...
    // ÷ 2764 × 0308 ÷ 1F466 ÷  #  ÷ [0.2] HEAVY BLACK HEART (Glue_After_Zwj) × [4.0] COMBINING
    // DIAERESIS (Extend_FE) ÷ [999.0] BOY (EBG) ÷ [0.3]
    assertAnalyzesTo(
        analyzer, "\u2764\u0308\uD83D\uDC66", new String[] {"\u2764\u0308", "\uD83D\uDC66"});

    // ÷ 2764 × 00AD ÷  #  ÷ [0.2] HEAVY BLACK HEART (Glue_After_Zwj) × [4.0] SOFT HYPHEN
    // (Format_FE) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u2764\u00AD", new String[] {"\u2764\u00AD"});

    // ÷ 2764 × 0308 × 00AD ÷  #  ÷ [0.2] HEAVY BLACK HEART (Glue_After_Zwj) × [4.0] COMBINING
    // DIAERESIS (Extend_FE) × [4.0] SOFT HYPHEN (Format_FE) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u2764\u0308\u00AD", new String[] {"\u2764\u0308\u00AD"});

    // ÷ 2764 × 0300 ÷  #  ÷ [0.2] HEAVY BLACK HEART (Glue_After_Zwj) × [4.0] COMBINING GRAVE ACCENT
    // (Extend_FE) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u2764\u0300", new String[] {"\u2764\u0300"});

    // ÷ 2764 × 0308 × 0300 ÷  #  ÷ [0.2] HEAVY BLACK HEART (Glue_After_Zwj) × [4.0] COMBINING
    // DIAERESIS (Extend_FE) × [4.0] COMBINING GRAVE ACCENT (Extend_FE) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u2764\u0308\u0300", new String[] {"\u2764\u0308\u0300"});

    // ÷ 2764 × 200D ÷  #  ÷ [0.2] HEAVY BLACK HEART (Glue_After_Zwj) × [4.0] ZERO WIDTH JOINER
    // (ZWJ_FE) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u2764\u200D", new String[] {"\u2764\u200D"});

    // ÷ 2764 × 0308 × 200D ÷  #  ÷ [0.2] HEAVY BLACK HEART (Glue_After_Zwj) × [4.0] COMBINING
    // DIAERESIS (Extend_FE) × [4.0] ZERO WIDTH JOINER (ZWJ_FE) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u2764\u0308\u200D", new String[] {"\u2764\u0308\u200D"});

    // ÷ 2764 ÷ 0061 × 2060 ÷  #  ÷ [0.2] HEAVY BLACK HEART (Glue_After_Zwj) ÷ [999.0] LATIN SMALL
    // LETTER A (ALetter) × [4.0] WORD JOINER (Format_FE) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u2764\u0061\u2060", new String[] {"\u2764", "\u0061\u2060"});

    // ÷ 2764 × 0308 ÷ 0061 × 2060 ÷  #  ÷ [0.2] HEAVY BLACK HEART (Glue_After_Zwj) × [4.0]
    // COMBINING DIAERESIS (Extend_FE) ÷ [999.0] LATIN SMALL LETTER A (ALetter) × [4.0] WORD JOINER
    // (Format_FE) ÷ [0.3]
    assertAnalyzesTo(
        analyzer, "\u2764\u0308\u0061\u2060", new String[] {"\u2764\u0308", "\u0061\u2060"});

    // ÷ 2764 ÷ 0061 ÷ 003A ÷  #  ÷ [0.2] HEAVY BLACK HEART (Glue_After_Zwj) ÷ [999.0] LATIN SMALL
    // LETTER A (ALetter) ÷ [999.0] COLON (MidLetter) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u2764\u0061\u003A", new String[] {"\u2764", "\u0061"});

    // ÷ 2764 × 0308 ÷ 0061 ÷ 003A ÷  #  ÷ [0.2] HEAVY BLACK HEART (Glue_After_Zwj) × [4.0]
    // COMBINING DIAERESIS (Extend_FE) ÷ [999.0] LATIN SMALL LETTER A (ALetter) ÷ [999.0] COLON
    // (MidLetter) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u2764\u0308\u0061\u003A", new String[] {"\u2764\u0308", "\u0061"});

    // ÷ 2764 ÷ 0061 ÷ 0027 ÷  #  ÷ [0.2] HEAVY BLACK HEART (Glue_After_Zwj) ÷ [999.0] LATIN SMALL
    // LETTER A (ALetter) ÷ [999.0] APOSTROPHE (Single_Quote) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u2764\u0061\u0027", new String[] {"\u2764", "\u0061"});

    // ÷ 2764 × 0308 ÷ 0061 ÷ 0027 ÷  #  ÷ [0.2] HEAVY BLACK HEART (Glue_After_Zwj) × [4.0]
    // COMBINING DIAERESIS (Extend_FE) ÷ [999.0] LATIN SMALL LETTER A (ALetter) ÷ [999.0] APOSTROPHE
    // (Single_Quote) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u2764\u0308\u0061\u0027", new String[] {"\u2764\u0308", "\u0061"});

    // ÷ 2764 ÷ 0061 ÷ 0027 × 2060 ÷  #  ÷ [0.2] HEAVY BLACK HEART (Glue_After_Zwj) ÷ [999.0] LATIN
    // SMALL LETTER A (ALetter) ÷ [999.0] APOSTROPHE (Single_Quote) × [4.0] WORD JOINER (Format_FE)
    // ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u2764\u0061\u0027\u2060", new String[] {"\u2764", "\u0061"});

    // ÷ 2764 × 0308 ÷ 0061 ÷ 0027 × 2060 ÷  #  ÷ [0.2] HEAVY BLACK HEART (Glue_After_Zwj) × [4.0]
    // COMBINING DIAERESIS (Extend_FE) ÷ [999.0] LATIN SMALL LETTER A (ALetter) ÷ [999.0] APOSTROPHE
    // (Single_Quote) × [4.0] WORD JOINER (Format_FE) ÷ [0.3]
    assertAnalyzesTo(
        analyzer, "\u2764\u0308\u0061\u0027\u2060", new String[] {"\u2764\u0308", "\u0061"});

    // ÷ 2764 ÷ 0061 ÷ 002C ÷  #  ÷ [0.2] HEAVY BLACK HEART (Glue_After_Zwj) ÷ [999.0] LATIN SMALL
    // LETTER A (ALetter) ÷ [999.0] COMMA (MidNum) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u2764\u0061\u002C", new String[] {"\u2764", "\u0061"});

    // ÷ 2764 × 0308 ÷ 0061 ÷ 002C ÷  #  ÷ [0.2] HEAVY BLACK HEART (Glue_After_Zwj) × [4.0]
    // COMBINING DIAERESIS (Extend_FE) ÷ [999.0] LATIN SMALL LETTER A (ALetter) ÷ [999.0] COMMA
    // (MidNum) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u2764\u0308\u0061\u002C", new String[] {"\u2764\u0308", "\u0061"});

    // ÷ 2764 ÷ 0031 ÷ 003A ÷  #  ÷ [0.2] HEAVY BLACK HEART (Glue_After_Zwj) ÷ [999.0] DIGIT ONE
    // (Numeric) ÷ [999.0] COLON (MidLetter) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u2764\u0031\u003A", new String[] {"\u2764", "\u0031"});

    // ÷ 2764 × 0308 ÷ 0031 ÷ 003A ÷  #  ÷ [0.2] HEAVY BLACK HEART (Glue_After_Zwj) × [4.0]
    // COMBINING DIAERESIS (Extend_FE) ÷ [999.0] DIGIT ONE (Numeric) ÷ [999.0] COLON (MidLetter) ÷
    // [0.3]
    assertAnalyzesTo(analyzer, "\u2764\u0308\u0031\u003A", new String[] {"\u2764\u0308", "\u0031"});

    // ÷ 2764 ÷ 0031 ÷ 0027 ÷  #  ÷ [0.2] HEAVY BLACK HEART (Glue_After_Zwj) ÷ [999.0] DIGIT ONE
    // (Numeric) ÷ [999.0] APOSTROPHE (Single_Quote) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u2764\u0031\u0027", new String[] {"\u2764", "\u0031"});

    // ÷ 2764 × 0308 ÷ 0031 ÷ 0027 ÷  #  ÷ [0.2] HEAVY BLACK HEART (Glue_After_Zwj) × [4.0]
    // COMBINING DIAERESIS (Extend_FE) ÷ [999.0] DIGIT ONE (Numeric) ÷ [999.0] APOSTROPHE
    // (Single_Quote) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u2764\u0308\u0031\u0027", new String[] {"\u2764\u0308", "\u0031"});

    // ÷ 2764 ÷ 0031 ÷ 002C ÷  #  ÷ [0.2] HEAVY BLACK HEART (Glue_After_Zwj) ÷ [999.0] DIGIT ONE
    // (Numeric) ÷ [999.0] COMMA (MidNum) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u2764\u0031\u002C", new String[] {"\u2764", "\u0031"});

    // ÷ 2764 × 0308 ÷ 0031 ÷ 002C ÷  #  ÷ [0.2] HEAVY BLACK HEART (Glue_After_Zwj) × [4.0]
    // COMBINING DIAERESIS (Extend_FE) ÷ [999.0] DIGIT ONE (Numeric) ÷ [999.0] COMMA (MidNum) ÷
    // [0.3]
    assertAnalyzesTo(analyzer, "\u2764\u0308\u0031\u002C", new String[] {"\u2764\u0308", "\u0031"});

    // ÷ 2764 ÷ 0031 ÷ 002E × 2060 ÷  #  ÷ [0.2] HEAVY BLACK HEART (Glue_After_Zwj) ÷ [999.0] DIGIT
    // ONE (Numeric) ÷ [999.0] FULL STOP (MidNumLet) × [4.0] WORD JOINER (Format_FE) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u2764\u0031\u002E\u2060", new String[] {"\u2764", "\u0031"});

    // ÷ 2764 × 0308 ÷ 0031 ÷ 002E × 2060 ÷  #  ÷ [0.2] HEAVY BLACK HEART (Glue_After_Zwj) × [4.0]
    // COMBINING DIAERESIS (Extend_FE) ÷ [999.0] DIGIT ONE (Numeric) ÷ [999.0] FULL STOP (MidNumLet)
    // × [4.0] WORD JOINER (Format_FE) ÷ [0.3]
    assertAnalyzesTo(
        analyzer, "\u2764\u0308\u0031\u002E\u2060", new String[] {"\u2764\u0308", "\u0031"});
    ...
    // ÷ 1F466 × 0308 ÷ 0001 ÷  #  ÷ [0.2] BOY (EBG) × [4.0] COMBINING DIAERESIS (Extend_FE) ÷
    // [999.0] <START OF HEADING> (Other) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\uD83D\uDC66\u0308\u0001", new String[] {"\uD83D\uDC66\u0308"});
    ...
    // ÷ 1F466 × 0308 ÷ 000D ÷  #  ÷ [0.2] BOY (EBG) × [4.0] COMBINING DIAERESIS (Extend_FE) ÷ [3.2]
    // <CARRIAGE RETURN (CR)> (CR) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\uD83D\uDC66\u0308\r", new String[] {"\uD83D\uDC66\u0308"});
    ...
    // ÷ 1F466 × 0308 ÷ 000A ÷  #  ÷ [0.2] BOY (EBG) × [4.0] COMBINING DIAERESIS (Extend_FE) ÷ [3.2]
    // <LINE FEED (LF)> (LF) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\uD83D\uDC66\u0308\n", new String[] {"\uD83D\uDC66\u0308"});
    ...
    // ÷ 1F466 × 0308 ÷ 000B ÷  #  ÷ [0.2] BOY (EBG) × [4.0] COMBINING DIAERESIS (Extend_FE) ÷ [3.2]
    ...
    // ÷ 1F466 × 0308 ÷ 3031 ÷  #  ÷ [0.2] BOY (EBG) × [4.0] COMBINING DIAERESIS (Extend_FE) ÷
    // [999.0] VERTICAL KANA REPEAT MARK (Katakana) ÷ [0.3]
    assertAnalyzesTo(
        analyzer, "\uD83D\uDC66\u0308\u3031", new String[] {"\uD83D\uDC66\u0308", "\u3031"});
    ...
    // ÷ 1F466 × 0308 ÷ 0041 ÷  #  ÷ [0.2] BOY (EBG) × [4.0] COMBINING DIAERESIS (Extend_FE) ÷
    // [999.0] LATIN CAPITAL LETTER A (ALetter) ÷ [0.3]
    assertAnalyzesTo(
        analyzer, "\uD83D\uDC66\u0308\u0041", new String[] {"\uD83D\uDC66\u0308", "\u0041"});
    ...
    // ÷ 1F466 × 0308 ÷ 003A ÷  #  ÷ [0.2] BOY (EBG) × [4.0] COMBINING DIAERESIS (Extend_FE) ÷
    // [999.0] COLON (MidLetter) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\uD83D\uDC66\u0308\u003A", new String[] {"\uD83D\uDC66\u0308"});
    ...
    // ÷ 1F466 × 0308 ÷ 002C ÷  #  ÷ [0.2] BOY (EBG) × [4.0] COMBINING DIAERESIS (Extend_FE) ÷
    // [999.0] COMMA (MidNum) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\uD83D\uDC66\u0308\u002C", new String[] {"\uD83D\uDC66\u0308"});
    ...
    // ÷ 1F466 × 0308 ÷ 002E ÷  #  ÷ [0.2] BOY (EBG) × [4.0] COMBINING DIAERESIS (Extend_FE) ÷
    // [999.0] FULL STOP (MidNumLet) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\uD83D\uDC66\u0308\u002E", new String[] {"\uD83D\uDC66\u0308"});
    ...
    // ÷ 1F466 × 0308 ÷ 0030 ÷  #  ÷ [0.2] BOY (EBG) × [4.0] COMBINING DIAERESIS (Extend_FE) ÷
    // [999.0] DIGIT ZERO (Numeric) ÷ [0.3]
    assertAnalyzesTo(
        analyzer, "\uD83D\uDC66\u0308\u0030", new String[] {"\uD83D\uDC66\u0308", "\u0030"});
    ...
    // ÷ 1F466 × 0308 ÷ 005F ÷  #  ÷ [0.2] BOY (EBG) × [4.0] COMBINING DIAERESIS (Extend_FE) ÷
    // [999.0] LOW LINE (ExtendNumLet) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\uD83D\uDC66\u0308\u005F", new String[] {"\uD83D\uDC66\u0308"});

    // ÷ 1F466 ÷ 1F1E6 ÷  #  ÷ [0.2] BOY (EBG) ÷ [999.0] REGIONAL INDICATOR SYMBOL LETTER A (RI) ÷
    // [0.3]
    assertAnalyzesTo(analyzer, "\uD83D\uDC66\uD83C\uDDE6", new String[] {"\uD83D\uDC66"});

    // ÷ 1F466 × 0308 ÷ 1F1E6 ÷  #  ÷ [0.2] BOY (EBG) × [4.0] COMBINING DIAERESIS (Extend_FE) ÷
    // [999.0] REGIONAL INDICATOR SYMBOL LETTER A (RI) ÷ [0.3]
    assertAnalyzesTo(
        analyzer, "\uD83D\uDC66\u0308\uD83C\uDDE6", new String[] {"\uD83D\uDC66\u0308"});
    ...
    // ÷ 1F466 × 0308 ÷ 05D0 ÷  #  ÷ [0.2] BOY (EBG) × [4.0] COMBINING DIAERESIS (Extend_FE) ÷
    // [999.0] HEBREW LETTER ALEF (Hebrew_Letter) ÷ [0.3]
    assertAnalyzesTo(
        analyzer, "\uD83D\uDC66\u0308\u05D0", new String[] {"\uD83D\uDC66\u0308", "\u05D0"});
    ...
    // ÷ 1F466 × 0308 ÷ 0022 ÷  #  ÷ [0.2] BOY (EBG) × [4.0] COMBINING DIAERESIS (Extend_FE) ÷
    // [999.0] QUOTATION MARK (Double_Quote) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\uD83D\uDC66\u0308\"", new String[] {"\uD83D\uDC66\u0308"});
    ...
    // ÷ 1F466 × 0308 ÷ 0027 ÷  #  ÷ [0.2] BOY (EBG) × [4.0] COMBINING DIAERESIS (Extend_FE) ÷
    // [999.0] APOSTROPHE (Single_Quote) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\uD83D\uDC66\u0308\u0027", new String[] {"\uD83D\uDC66\u0308"});
    ...
    // ÷ 1F466 × 0308 ÷ 261D ÷  #  ÷ [0.2] BOY (EBG) × [4.0] COMBINING DIAERESIS (Extend_FE) ÷
    // [999.0] WHITE UP POINTING INDEX (E_Base) ÷ [0.3]
    assertAnalyzesTo(
        analyzer, "\uD83D\uDC66\u0308\u261D", new String[] {"\uD83D\uDC66\u0308", "\u261D"});

    // ÷ 1F466 × 1F3FB ÷  #  ÷ [0.2] BOY (EBG) × [14.0] EMOJI MODIFIER FITZPATRICK TYPE-1-2
    // (E_Modifier) ÷ [0.3]
    assertAnalyzesTo(
        analyzer, "\uD83D\uDC66\uD83C\uDFFB", new String[] {"\uD83D\uDC66\uD83C\uDFFB"});

    // ÷ 1F466 × 0308 × 1F3FB ÷  #  ÷ [0.2] BOY (EBG) × [4.0] COMBINING DIAERESIS (Extend_FE) ×
    // [14.0] EMOJI MODIFIER FITZPATRICK TYPE-1-2 (E_Modifier) ÷ [0.3]
    assertAnalyzesTo(
        analyzer,
        "\uD83D\uDC66\u0308\uD83C\uDFFB",
        new String[] {"\uD83D\uDC66\u0308\uD83C\uDFFB"});
    ...
    // ÷ 1F466 × 0308 ÷ 2764 ÷  #  ÷ [0.2] BOY (EBG) × [4.0] COMBINING DIAERESIS (Extend_FE) ÷
    // [999.0] HEAVY BLACK HEART (Glue_After_Zwj) ÷ [0.3]
    assertAnalyzesTo(
        analyzer, "\uD83D\uDC66\u0308\u2764", new String[] {"\uD83D\uDC66\u0308", "\u2764"});
    ...
    // ÷ 1F466 × 0308 ÷ 1F466 ÷  #  ÷ [0.2] BOY (EBG) × [4.0] COMBINING DIAERESIS (Extend_FE) ÷
    // [999.0] BOY (EBG) ÷ [0.3]
    assertAnalyzesTo(
        analyzer,
        "\uD83D\uDC66\u0308\uD83D\uDC66",
    ...
    // ÷ 1F466 × 0308 × 00AD ÷  #  ÷ [0.2] BOY (EBG) × [4.0] COMBINING DIAERESIS (Extend_FE) × [4.0]
    ...
    // ÷ 1F466 × 0308 × 0300 ÷  #  ÷ [0.2] BOY (EBG) × [4.0] COMBINING DIAERESIS (Extend_FE) × [4.0]
    // COMBINING GRAVE ACCENT (Extend_FE) ÷ [0.3]
    assertAnalyzesTo(
        analyzer, "\uD83D\uDC66\u0308\u0300", new String[] {"\uD83D\uDC66\u0308\u0300"});
    ...
    // ÷ 1F466 × 0308 × 200D ÷  #  ÷ [0.2] BOY (EBG) × [4.0] COMBINING DIAERESIS (Extend_FE) × [4.0]
    // ZERO WIDTH JOINER (ZWJ_FE) ÷ [0.3]
    assertAnalyzesTo(
        analyzer, "\uD83D\uDC66\u0308\u200D", new String[] {"\uD83D\uDC66\u0308\u200D"});

    // ÷ 1F466 ÷ 0061 × 2060 ÷  #  ÷ [0.2] BOY (EBG) ÷ [999.0] LATIN SMALL LETTER A (ALetter) ×
    // [4.0] WORD JOINER (Format_FE) ÷ [0.3]
    assertAnalyzesTo(
        analyzer, "\uD83D\uDC66\u0061\u2060", new String[] {"\uD83D\uDC66", "\u0061\u2060"});

    // ÷ 1F466 × 0308 ÷ 0061 × 2060 ÷  #  ÷ [0.2] BOY (EBG) × [4.0] COMBINING DIAERESIS (Extend_FE)
    // ÷ [999.0] LATIN SMALL LETTER A (ALetter) × [4.0] WORD JOINER (Format_FE) ÷ [0.3]
    assertAnalyzesTo(
        analyzer,
        "\uD83D\uDC66\u0308\u0061\u2060",
    ...
    // ÷ 1F466 ÷ 0061 ÷ 003A ÷  #  ÷ [0.2] BOY (EBG) ÷ [999.0] LATIN SMALL LETTER A (ALetter) ÷
    // [999.0] COLON (MidLetter) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\uD83D\uDC66\u0061\u003A", new String[] {"\uD83D\uDC66", "\u0061"});

    // ÷ 1F466 × 0308 ÷ 0061 ÷ 003A ÷  #  ÷ [0.2] BOY (EBG) × [4.0] COMBINING DIAERESIS (Extend_FE)
    // ÷ [999.0] LATIN SMALL LETTER A (ALetter) ÷ [999.0] COLON (MidLetter) ÷ [0.3]
    assertAnalyzesTo(
        analyzer, "\uD83D\uDC66\u0308\u0061\u003A", new String[] {"\uD83D\uDC66\u0308", "\u0061"});

    // ÷ 1F466 ÷ 0061 ÷ 0027 ÷  #  ÷ [0.2] BOY (EBG) ÷ [999.0] LATIN SMALL LETTER A (ALetter) ÷
    // [999.0] APOSTROPHE (Single_Quote) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\uD83D\uDC66\u0061\u0027", new String[] {"\uD83D\uDC66", "\u0061"});

    // ÷ 1F466 × 0308 ÷ 0061 ÷ 0027 ÷  #  ÷ [0.2] BOY (EBG) × [4.0] COMBINING DIAERESIS (Extend_FE)
    // ÷ [999.0] LATIN SMALL LETTER A (ALetter) ÷ [999.0] APOSTROPHE (Single_Quote) ÷ [0.3]
    assertAnalyzesTo(
        analyzer, "\uD83D\uDC66\u0308\u0061\u0027", new String[] {"\uD83D\uDC66\u0308", "\u0061"});

    // ÷ 1F466 ÷ 0061 ÷ 0027 × 2060 ÷  #  ÷ [0.2] BOY (EBG) ÷ [999.0] LATIN SMALL LETTER A (ALetter)
    // ÷ [999.0] APOSTROPHE (Single_Quote) × [4.0] WORD JOINER (Format_FE) ÷ [0.3]
    assertAnalyzesTo(
        analyzer, "\uD83D\uDC66\u0061\u0027\u2060", new String[] {"\uD83D\uDC66", "\u0061"});

    // ÷ 1F466 × 0308 ÷ 0061 ÷ 0027 × 2060 ÷  #  ÷ [0.2] BOY (EBG) × [4.0] COMBINING DIAERESIS
    // (Extend_FE) ÷ [999.0] LATIN SMALL LETTER A (ALetter) ÷ [999.0] APOSTROPHE (Single_Quote) ×
    // [4.0] WORD JOINER (Format_FE) ÷ [0.3]
    assertAnalyzesTo(
        analyzer,
    ...
    // ÷ 1F466 ÷ 0061 ÷ 002C ÷  #  ÷ [0.2] BOY (EBG) ÷ [999.0] LATIN SMALL LETTER A (ALetter) ÷
    // [999.0] COMMA (MidNum) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\uD83D\uDC66\u0061\u002C", new String[] {"\uD83D\uDC66", "\u0061"});

    // ÷ 1F466 × 0308 ÷ 0061 ÷ 002C ÷  #  ÷ [0.2] BOY (EBG) × [4.0] COMBINING DIAERESIS (Extend_FE)
    // ÷ [999.0] LATIN SMALL LETTER A (ALetter) ÷ [999.0] COMMA (MidNum) ÷ [0.3]
    assertAnalyzesTo(
        analyzer, "\uD83D\uDC66\u0308\u0061\u002C", new String[] {"\uD83D\uDC66\u0308", "\u0061"});

    // ÷ 1F466 ÷ 0031 ÷ 003A ÷  #  ÷ [0.2] BOY (EBG) ÷ [999.0] DIGIT ONE (Numeric) ÷ [999.0] COLON
    // (MidLetter) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\uD83D\uDC66\u0031\u003A", new String[] {"\uD83D\uDC66", "\u0031"});

    // ÷ 1F466 × 0308 ÷ 0031 ÷ 003A ÷  #  ÷ [0.2] BOY (EBG) × [4.0] COMBINING DIAERESIS (Extend_FE)
    // ÷ [999.0] DIGIT ONE (Numeric) ÷ [999.0] COLON (MidLetter) ÷ [0.3]
    assertAnalyzesTo(
        analyzer, "\uD83D\uDC66\u0308\u0031\u003A", new String[] {"\uD83D\uDC66\u0308", "\u0031"});

    // ÷ 1F466 ÷ 0031 ÷ 0027 ÷  #  ÷ [0.2] BOY (EBG) ÷ [999.0] DIGIT ONE (Numeric) ÷ [999.0]
    // APOSTROPHE (Single_Quote) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\uD83D\uDC66\u0031\u0027", new String[] {"\uD83D\uDC66", "\u0031"});

    // ÷ 1F466 × 0308 ÷ 0031 ÷ 0027 ÷  #  ÷ [0.2] BOY (EBG) × [4.0] COMBINING DIAERESIS (Extend_FE)
    // ÷ [999.0] DIGIT ONE (Numeric) ÷ [999.0] APOSTROPHE (Single_Quote) ÷ [0.3]
    assertAnalyzesTo(
        analyzer, "\uD83D\uDC66\u0308\u0031\u0027", new String[] {"\uD83D\uDC66\u0308", "\u0031"});

    // ÷ 1F466 ÷ 0031 ÷ 002C ÷  #  ÷ [0.2] BOY (EBG) ÷ [999.0] DIGIT ONE (Numeric) ÷ [999.0] COMMA
    // (MidNum) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\uD83D\uDC66\u0031\u002C", new String[] {"\uD83D\uDC66", "\u0031"});

    // ÷ 1F466 × 0308 ÷ 0031 ÷ 002C ÷  #  ÷ [0.2] BOY (EBG) × [4.0] COMBINING DIAERESIS (Extend_FE)
    // ÷ [999.0] DIGIT ONE (Numeric) ÷ [999.0] COMMA (MidNum) ÷ [0.3]
    assertAnalyzesTo(
        analyzer, "\uD83D\uDC66\u0308\u0031\u002C", new String[] {"\uD83D\uDC66\u0308", "\u0031"});

    // ÷ 1F466 ÷ 0031 ÷ 002E × 2060 ÷  #  ÷ [0.2] BOY (EBG) ÷ [999.0] DIGIT ONE (Numeric) ÷ [999.0]
    // FULL STOP (MidNumLet) × [4.0] WORD JOINER (Format_FE) ÷ [0.3]
    assertAnalyzesTo(
        analyzer, "\uD83D\uDC66\u0031\u002E\u2060", new String[] {"\uD83D\uDC66", "\u0031"});

    // ÷ 1F466 × 0308 ÷ 0031 ÷ 002E × 2060 ÷  #  ÷ [0.2] BOY (EBG) × [4.0] COMBINING DIAERESIS
    // (Extend_FE) ÷ [999.0] DIGIT ONE (Numeric) ÷ [999.0] FULL STOP (MidNumLet) × [4.0] WORD JOINER
    // (Format_FE) ÷ [0.3]
    assertAnalyzesTo(
        analyzer,
    ...
    // ÷ 00AD ÷ 261D ÷  #  ÷ [0.2] SOFT HYPHEN (Format_FE) ÷ [999.0] WHITE UP POINTING INDEX
    // (E_Base) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u00AD\u261D", new String[] {"\u261D"});

    // ÷ 00AD × 0308 ÷ 261D ÷  #  ÷ [0.2] SOFT HYPHEN (Format_FE) × [4.0] COMBINING DIAERESIS
    // (Extend_FE) ÷ [999.0] WHITE UP POINTING INDEX (E_Base) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u00AD\u0308\u261D", new String[] {"\u261D"});

    // ÷ 00AD ÷ 1F3FB ÷  #  ÷ [0.2] SOFT HYPHEN (Format_FE) ÷ [999.0] EMOJI MODIFIER FITZPATRICK
    // TYPE-1-2 (E_Modifier) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u00AD\uD83C\uDFFB", new String[] {"\uD83C\uDFFB"});

    // ÷ 00AD × 0308 ÷ 1F3FB ÷  #  ÷ [0.2] SOFT HYPHEN (Format_FE) × [4.0] COMBINING DIAERESIS
    // (Extend_FE) ÷ [999.0] EMOJI MODIFIER FITZPATRICK TYPE-1-2 (E_Modifier) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u00AD\u0308\uD83C\uDFFB", new String[] {"\uD83C\uDFFB"});

    // ÷ 00AD ÷ 2764 ÷  #  ÷ [0.2] SOFT HYPHEN (Format_FE) ÷ [999.0] HEAVY BLACK HEART
    // (Glue_After_Zwj) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u00AD\u2764", new String[] {"\u2764"});

    // ÷ 00AD × 0308 ÷ 2764 ÷  #  ÷ [0.2] SOFT HYPHEN (Format_FE) × [4.0] COMBINING DIAERESIS
    // (Extend_FE) ÷ [999.0] HEAVY BLACK HEART (Glue_After_Zwj) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u00AD\u0308\u2764", new String[] {"\u2764"});
    ...
    // ÷ 00AD × 0308 ÷ 1F466 ÷  #  ÷ [0.2] SOFT HYPHEN (Format_FE) × [4.0] COMBINING DIAERESIS
    // (Extend_FE) ÷ [999.0] BOY (EBG) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u00AD\u0308\uD83D\uDC66", new String[] {"\uD83D\uDC66"});
    ...
    // ÷ 0300 ÷ 261D ÷  #  ÷ [0.2] COMBINING GRAVE ACCENT (Extend_FE) ÷ [999.0] WHITE UP POINTING
    // INDEX (E_Base) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u0300\u261D", new String[] {"\u261D"});

    // ÷ 0300 × 0308 ÷ 261D ÷  #  ÷ [0.2] COMBINING GRAVE ACCENT (Extend_FE) × [4.0] COMBINING
    // DIAERESIS (Extend_FE) ÷ [999.0] WHITE UP POINTING INDEX (E_Base) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u0300\u0308\u261D", new String[] {"\u261D"});

    // ÷ 0300 ÷ 1F3FB ÷  #  ÷ [0.2] COMBINING GRAVE ACCENT (Extend_FE) ÷ [999.0] EMOJI MODIFIER
    // FITZPATRICK TYPE-1-2 (E_Modifier) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u0300\uD83C\uDFFB", new String[] {"\uD83C\uDFFB"});

    // ÷ 0300 × 0308 ÷ 1F3FB ÷  #  ÷ [0.2] COMBINING GRAVE ACCENT (Extend_FE) × [4.0] COMBINING
    // DIAERESIS (Extend_FE) ÷ [999.0] EMOJI MODIFIER FITZPATRICK TYPE-1-2 (E_Modifier) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u0300\u0308\uD83C\uDFFB", new String[] {"\uD83C\uDFFB"});

    // ÷ 0300 ÷ 2764 ÷  #  ÷ [0.2] COMBINING GRAVE ACCENT (Extend_FE) ÷ [999.0] HEAVY BLACK HEART
    // (Glue_After_Zwj) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u0300\u2764", new String[] {"\u2764"});

    // ÷ 0300 × 0308 ÷ 2764 ÷  #  ÷ [0.2] COMBINING GRAVE ACCENT (Extend_FE) × [4.0] COMBINING
    // DIAERESIS (Extend_FE) ÷ [999.0] HEAVY BLACK HEART (Glue_After_Zwj) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u0300\u0308\u2764", new String[] {"\u2764"});
    ...
    // ÷ 0300 × 0308 ÷ 1F466 ÷  #  ÷ [0.2] COMBINING GRAVE ACCENT (Extend_FE) × [4.0] COMBINING
    // DIAERESIS (Extend_FE) ÷ [999.0] BOY (EBG) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u0300\u0308\uD83D\uDC66", new String[] {"\uD83D\uDC66"});
    ...
    // ÷ 200D ÷ 261D ÷  #  ÷ [0.2] ZERO WIDTH JOINER (ZWJ_FE) ÷ [999.0] WHITE UP POINTING INDEX
    // (E_Base) ÷ [0.3]
    // Skipping this test because it conflicts with TR#51 v11.0 rules.

    // ÷ 200D × 0308 ÷ 261D ÷  #  ÷ [0.2] ZERO WIDTH JOINER (ZWJ_FE) × [4.0] COMBINING DIAERESIS
    // (Extend_FE) ÷ [999.0] WHITE UP POINTING INDEX (E_Base) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u200D\u0308\u261D", new String[] {"\u261D"});

    // ÷ 200D ÷ 1F3FB ÷  #  ÷ [0.2] ZERO WIDTH JOINER (ZWJ_FE) ÷ [999.0] EMOJI MODIFIER FITZPATRICK
    // TYPE-1-2 (E_Modifier) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u200D\uD83C\uDFFB", new String[] {"\uD83C\uDFFB"});

    // ÷ 200D × 0308 ÷ 1F3FB ÷  #  ÷ [0.2] ZERO WIDTH JOINER (ZWJ_FE) × [4.0] COMBINING DIAERESIS
    // (Extend_FE) ÷ [999.0] EMOJI MODIFIER FITZPATRICK TYPE-1-2 (E_Modifier) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u200D\u0308\uD83C\uDFFB", new String[] {"\uD83C\uDFFB"});

    // ÷ 200D × 2764 ÷  #  ÷ [0.2] ZERO WIDTH JOINER (ZWJ_FE) × [3.3] HEAVY BLACK HEART
    // (Glue_After_Zwj) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u200D\u2764", new String[] {"\u200D\u2764"});

    // ÷ 200D × 0308 ÷ 2764 ÷  #  ÷ [0.2] ZERO WIDTH JOINER (ZWJ_FE) × [4.0] COMBINING DIAERESIS
    // (Extend_FE) ÷ [999.0] HEAVY BLACK HEART (Glue_After_Zwj) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u200D\u0308\u2764", new String[] {"\u2764"});
    ...
    // ÷ 200D × 0308 ÷ 1F466 ÷  #  ÷ [0.2] ZERO WIDTH JOINER (ZWJ_FE) × [4.0] COMBINING DIAERESIS
    // (Extend_FE) ÷ [999.0] BOY (EBG) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u200D\u0308\uD83D\uDC66", new String[] {"\uD83D\uDC66"});
    ...
    // ÷ 0061 × 2060 ÷ 261D ÷  #  ÷ [0.2] LATIN SMALL LETTER A (ALetter) × [4.0] WORD JOINER
    // (Format_FE) ÷ [999.0] WHITE UP POINTING INDEX (E_Base) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u0061\u2060\u261D", new String[] {"\u0061\u2060", "\u261D"});

    // ÷ 0061 × 2060 × 0308 ÷ 261D ÷  #  ÷ [0.2] LATIN SMALL LETTER A (ALetter) × [4.0] WORD JOINER
    // (Format_FE) × [4.0] COMBINING DIAERESIS (Extend_FE) ÷ [999.0] WHITE UP POINTING INDEX
    // (E_Base) ÷ [0.3]
    assertAnalyzesTo(
        analyzer, "\u0061\u2060\u0308\u261D", new String[] {"\u0061\u2060\u0308", "\u261D"});

    // ÷ 0061 × 2060 ÷ 1F3FB ÷  #  ÷ [0.2] LATIN SMALL LETTER A (ALetter) × [4.0] WORD JOINER
    // (Format_FE) ÷ [999.0] EMOJI MODIFIER FITZPATRICK TYPE-1-2 (E_Modifier) ÷ [0.3]
    assertAnalyzesTo(
        analyzer, "\u0061\u2060\uD83C\uDFFB", new String[] {"\u0061\u2060", "\uD83C\uDFFB"});

    // ÷ 0061 × 2060 × 0308 ÷ 1F3FB ÷  #  ÷ [0.2] LATIN SMALL LETTER A (ALetter) × [4.0] WORD JOINER
    // (Format_FE) × [4.0] COMBINING DIAERESIS (Extend_FE) ÷ [999.0] EMOJI MODIFIER FITZPATRICK
    // TYPE-1-2 (E_Modifier) ÷ [0.3]
    assertAnalyzesTo(
        analyzer,
        "\u0061\u2060\u0308\uD83C\uDFFB",
    ...
    // ÷ 0061 × 2060 ÷ 2764 ÷  #  ÷ [0.2] LATIN SMALL LETTER A (ALetter) × [4.0] WORD JOINER
    // (Format_FE) ÷ [999.0] HEAVY BLACK HEART (Glue_After_Zwj) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u0061\u2060\u2764", new String[] {"\u0061\u2060", "\u2764"});

    // ÷ 0061 × 2060 × 0308 ÷ 2764 ÷  #  ÷ [0.2] LATIN SMALL LETTER A (ALetter) × [4.0] WORD JOINER
    // (Format_FE) × [4.0] COMBINING DIAERESIS (Extend_FE) ÷ [999.0] HEAVY BLACK HEART
    // (Glue_After_Zwj) ÷ [0.3]
    assertAnalyzesTo(
        analyzer, "\u0061\u2060\u0308\u2764", new String[] {"\u0061\u2060\u0308", "\u2764"});

    // ÷ 0061 × 2060 ÷ 1F466 ÷  #  ÷ [0.2] LATIN SMALL LETTER A (ALetter) × [4.0] WORD JOINER
    // (Format_FE) ÷ [999.0] BOY (EBG) ÷ [0.3]
    assertAnalyzesTo(
        analyzer, "\u0061\u2060\uD83D\uDC66", new String[] {"\u0061\u2060", "\uD83D\uDC66"});

    // ÷ 0061 × 2060 × 0308 ÷ 1F466 ÷  #  ÷ [0.2] LATIN SMALL LETTER A (ALetter) × [4.0] WORD JOINER
    // (Format_FE) × [4.0] COMBINING DIAERESIS (Extend_FE) ÷ [999.0] BOY (EBG) ÷ [0.3]
    assertAnalyzesTo(
        analyzer,
        "\u0061\u2060\u0308\uD83D\uDC66",
        new String[] {"\u0061\u2060\u0308", "\uD83D\uDC66"});
    ...
    // ÷ 0061 ÷ 003A ÷ 261D ÷  #  ÷ [0.2] LATIN SMALL LETTER A (ALetter) ÷ [999.0] COLON (MidLetter)
    // ÷ [999.0] WHITE UP POINTING INDEX (E_Base) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u0061\u003A\u261D", new String[] {"\u0061", "\u261D"});

    // ÷ 0061 ÷ 003A × 0308 ÷ 261D ÷  #  ÷ [0.2] LATIN SMALL LETTER A (ALetter) ÷ [999.0] COLON
    // (MidLetter) × [4.0] COMBINING DIAERESIS (Extend_FE) ÷ [999.0] WHITE UP POINTING INDEX
    // (E_Base) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u0061\u003A\u0308\u261D", new String[] {"\u0061", "\u261D"});

    // ÷ 0061 ÷ 003A ÷ 1F3FB ÷  #  ÷ [0.2] LATIN SMALL LETTER A (ALetter) ÷ [999.0] COLON
    // (MidLetter) ÷ [999.0] EMOJI MODIFIER FITZPATRICK TYPE-1-2 (E_Modifier) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u0061\u003A\uD83C\uDFFB", new String[] {"\u0061", "\uD83C\uDFFB"});

    // ÷ 0061 ÷ 003A × 0308 ÷ 1F3FB ÷  #  ÷ [0.2] LATIN SMALL LETTER A (ALetter) ÷ [999.0] COLON
    // (MidLetter) × [4.0] COMBINING DIAERESIS (Extend_FE) ÷ [999.0] EMOJI MODIFIER FITZPATRICK
    // TYPE-1-2 (E_Modifier) ÷ [0.3]
    assertAnalyzesTo(
        analyzer, "\u0061\u003A\u0308\uD83C\uDFFB", new String[] {"\u0061", "\uD83C\uDFFB"});

    // ÷ 0061 ÷ 003A ÷ 2764 ÷  #  ÷ [0.2] LATIN SMALL LETTER A (ALetter) ÷ [999.0] COLON (MidLetter)
    // ÷ [999.0] HEAVY BLACK HEART (Glue_After_Zwj) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u0061\u003A\u2764", new String[] {"\u0061", "\u2764"});

    // ÷ 0061 ÷ 003A × 0308 ÷ 2764 ÷  #  ÷ [0.2] LATIN SMALL LETTER A (ALetter) ÷ [999.0] COLON
    // (MidLetter) × [4.0] COMBINING DIAERESIS (Extend_FE) ÷ [999.0] HEAVY BLACK HEART
    // (Glue_After_Zwj) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u0061\u003A\u0308\u2764", new String[] {"\u0061", "\u2764"});

    // ÷ 0061 ÷ 003A ÷ 1F466 ÷  #  ÷ [0.2] LATIN SMALL LETTER A (ALetter) ÷ [999.0] COLON
    // (MidLetter) ÷ [999.0] BOY (EBG) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u0061\u003A\uD83D\uDC66", new String[] {"\u0061", "\uD83D\uDC66"});

    // ÷ 0061 ÷ 003A × 0308 ÷ 1F466 ÷  #  ÷ [0.2] LATIN SMALL LETTER A (ALetter) ÷ [999.0] COLON
    // (MidLetter) × [4.0] COMBINING DIAERESIS (Extend_FE) ÷ [999.0] BOY (EBG) ÷ [0.3]
    assertAnalyzesTo(
        analyzer, "\u0061\u003A\u0308\uD83D\uDC66", new String[] {"\u0061", "\uD83D\uDC66"});
    ...
    // ÷ 0061 ÷ 0027 ÷ 261D ÷  #  ÷ [0.2] LATIN SMALL LETTER A (ALetter) ÷ [999.0] APOSTROPHE
    // (Single_Quote) ÷ [999.0] WHITE UP POINTING INDEX (E_Base) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u0061\u0027\u261D", new String[] {"\u0061", "\u261D"});

    // ÷ 0061 ÷ 0027 × 0308 ÷ 261D ÷  #  ÷ [0.2] LATIN SMALL LETTER A (ALetter) ÷ [999.0] APOSTROPHE
    // (Single_Quote) × [4.0] COMBINING DIAERESIS (Extend_FE) ÷ [999.0] WHITE UP POINTING INDEX
    // (E_Base) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u0061\u0027\u0308\u261D", new String[] {"\u0061", "\u261D"});

    // ÷ 0061 ÷ 0027 ÷ 1F3FB ÷  #  ÷ [0.2] LATIN SMALL LETTER A (ALetter) ÷ [999.0] APOSTROPHE
    // (Single_Quote) ÷ [999.0] EMOJI MODIFIER FITZPATRICK TYPE-1-2 (E_Modifier) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u0061\u0027\uD83C\uDFFB", new String[] {"\u0061", "\uD83C\uDFFB"});

    // ÷ 0061 ÷ 0027 × 0308 ÷ 1F3FB ÷  #  ÷ [0.2] LATIN SMALL LETTER A (ALetter) ÷ [999.0]
    // APOSTROPHE (Single_Quote) × [4.0] COMBINING DIAERESIS (Extend_FE) ÷ [999.0] EMOJI MODIFIER
    // FITZPATRICK TYPE-1-2 (E_Modifier) ÷ [0.3]
    assertAnalyzesTo(
        analyzer, "\u0061\u0027\u0308\uD83C\uDFFB", new String[] {"\u0061", "\uD83C\uDFFB"});

    // ÷ 0061 ÷ 0027 ÷ 2764 ÷  #  ÷ [0.2] LATIN SMALL LETTER A (ALetter) ÷ [999.0] APOSTROPHE
    // (Single_Quote) ÷ [999.0] HEAVY BLACK HEART (Glue_After_Zwj) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u0061\u0027\u2764", new String[] {"\u0061", "\u2764"});

    // ÷ 0061 ÷ 0027 × 0308 ÷ 2764 ÷  #  ÷ [0.2] LATIN SMALL LETTER A (ALetter) ÷ [999.0] APOSTROPHE
    // (Single_Quote) × [4.0] COMBINING DIAERESIS (Extend_FE) ÷ [999.0] HEAVY BLACK HEART
    // (Glue_After_Zwj) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u0061\u0027\u0308\u2764", new String[] {"\u0061", "\u2764"});

    // ÷ 0061 ÷ 0027 ÷ 1F466 ÷  #  ÷ [0.2] LATIN SMALL LETTER A (ALetter) ÷ [999.0] APOSTROPHE
    // (Single_Quote) ÷ [999.0] BOY (EBG) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u0061\u0027\uD83D\uDC66", new String[] {"\u0061", "\uD83D\uDC66"});

    // ÷ 0061 ÷ 0027 × 0308 ÷ 1F466 ÷  #  ÷ [0.2] LATIN SMALL LETTER A (ALetter) ÷ [999.0]
    // APOSTROPHE (Single_Quote) × [4.0] COMBINING DIAERESIS (Extend_FE) ÷ [999.0] BOY (EBG) ÷ [0.3]
    assertAnalyzesTo(
        analyzer, "\u0061\u0027\u0308\uD83D\uDC66", new String[] {"\u0061", "\uD83D\uDC66"});
    ...
    // ÷ 0061 ÷ 0027 × 2060 ÷ 261D ÷  #  ÷ [0.2] LATIN SMALL LETTER A (ALetter) ÷ [999.0] APOSTROPHE
    // (Single_Quote) × [4.0] WORD JOINER (Format_FE) ÷ [999.0] WHITE UP POINTING INDEX (E_Base) ÷
    // [0.3]
    assertAnalyzesTo(analyzer, "\u0061\u0027\u2060\u261D", new String[] {"\u0061", "\u261D"});

    // ÷ 0061 ÷ 0027 × 2060 × 0308 ÷ 261D ÷  #  ÷ [0.2] LATIN SMALL LETTER A (ALetter) ÷ [999.0]
    // APOSTROPHE (Single_Quote) × [4.0] WORD JOINER (Format_FE) × [4.0] COMBINING DIAERESIS
    // (Extend_FE) ÷ [999.0] WHITE UP POINTING INDEX (E_Base) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u0061\u0027\u2060\u0308\u261D", new String[] {"\u0061", "\u261D"});

    // ÷ 0061 ÷ 0027 × 2060 ÷ 1F3FB ÷  #  ÷ [0.2] LATIN SMALL LETTER A (ALetter) ÷ [999.0]
    // APOSTROPHE (Single_Quote) × [4.0] WORD JOINER (Format_FE) ÷ [999.0] EMOJI MODIFIER
    // FITZPATRICK TYPE-1-2 (E_Modifier) ÷ [0.3]
    assertAnalyzesTo(
        analyzer, "\u0061\u0027\u2060\uD83C\uDFFB", new String[] {"\u0061", "\uD83C\uDFFB"});

    // ÷ 0061 ÷ 0027 × 2060 × 0308 ÷ 1F3FB ÷  #  ÷ [0.2] LATIN SMALL LETTER A (ALetter) ÷ [999.0]
    // APOSTROPHE (Single_Quote) × [4.0] WORD JOINER (Format_FE) × [4.0] COMBINING DIAERESIS
    // (Extend_FE) ÷ [999.0] EMOJI MODIFIER FITZPATRICK TYPE-1-2 (E_Modifier) ÷ [0.3]
    assertAnalyzesTo(
        analyzer, "\u0061\u0027\u2060\u0308\uD83C\uDFFB", new String[] {"\u0061", "\uD83C\uDFFB"});

    // ÷ 0061 ÷ 0027 × 2060 ÷ 2764 ÷  #  ÷ [0.2] LATIN SMALL LETTER A (ALetter) ÷ [999.0] APOSTROPHE
    // (Single_Quote) × [4.0] WORD JOINER (Format_FE) ÷ [999.0] HEAVY BLACK HEART (Glue_After_Zwj) ÷
    // [0.3]
    assertAnalyzesTo(analyzer, "\u0061\u0027\u2060\u2764", new String[] {"\u0061", "\u2764"});

    // ÷ 0061 ÷ 0027 × 2060 × 0308 ÷ 2764 ÷  #  ÷ [0.2] LATIN SMALL LETTER A (ALetter) ÷ [999.0]
    // APOSTROPHE (Single_Quote) × [4.0] WORD JOINER (Format_FE) × [4.0] COMBINING DIAERESIS
    // (Extend_FE) ÷ [999.0] HEAVY BLACK HEART (Glue_After_Zwj) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u0061\u0027\u2060\u0308\u2764", new String[] {"\u0061", "\u2764"});

    // ÷ 0061 ÷ 0027 × 2060 ÷ 1F466 ÷  #  ÷ [0.2] LATIN SMALL LETTER A (ALetter) ÷ [999.0]
    // APOSTROPHE (Single_Quote) × [4.0] WORD JOINER (Format_FE) ÷ [999.0] BOY (EBG) ÷ [0.3]
    assertAnalyzesTo(
        analyzer, "\u0061\u0027\u2060\uD83D\uDC66", new String[] {"\u0061", "\uD83D\uDC66"});

    // ÷ 0061 ÷ 0027 × 2060 × 0308 ÷ 1F466 ÷  #  ÷ [0.2] LATIN SMALL LETTER A (ALetter) ÷ [999.0]
    // APOSTROPHE (Single_Quote) × [4.0] WORD JOINER (Format_FE) × [4.0] COMBINING DIAERESIS
    // (Extend_FE) ÷ [999.0] BOY (EBG) ÷ [0.3]
    assertAnalyzesTo(
        analyzer, "\u0061\u0027\u2060\u0308\uD83D\uDC66", new String[] {"\u0061", "\uD83D\uDC66"});
    ...
    // ÷ 0061 ÷ 002C ÷ 261D ÷  #  ÷ [0.2] LATIN SMALL LETTER A (ALetter) ÷ [999.0] COMMA (MidNum) ÷
    // [999.0] WHITE UP POINTING INDEX (E_Base) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u0061\u002C\u261D", new String[] {"\u0061", "\u261D"});

    // ÷ 0061 ÷ 002C × 0308 ÷ 261D ÷  #  ÷ [0.2] LATIN SMALL LETTER A (ALetter) ÷ [999.0] COMMA
    // (MidNum) × [4.0] COMBINING DIAERESIS (Extend_FE) ÷ [999.0] WHITE UP POINTING INDEX (E_Base) ÷
    // [0.3]
    assertAnalyzesTo(analyzer, "\u0061\u002C\u0308\u261D", new String[] {"\u0061", "\u261D"});

    // ÷ 0061 ÷ 002C ÷ 1F3FB ÷  #  ÷ [0.2] LATIN SMALL LETTER A (ALetter) ÷ [999.0] COMMA (MidNum) ÷
    // [999.0] EMOJI MODIFIER FITZPATRICK TYPE-1-2 (E_Modifier) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u0061\u002C\uD83C\uDFFB", new String[] {"\u0061", "\uD83C\uDFFB"});

    // ÷ 0061 ÷ 002C × 0308 ÷ 1F3FB ÷  #  ÷ [0.2] LATIN SMALL LETTER A (ALetter) ÷ [999.0] COMMA
    // (MidNum) × [4.0] COMBINING DIAERESIS (Extend_FE) ÷ [999.0] EMOJI MODIFIER FITZPATRICK
    // TYPE-1-2 (E_Modifier) ÷ [0.3]
    assertAnalyzesTo(
        analyzer, "\u0061\u002C\u0308\uD83C\uDFFB", new String[] {"\u0061", "\uD83C\uDFFB"});

    // ÷ 0061 ÷ 002C ÷ 2764 ÷  #  ÷ [0.2] LATIN SMALL LETTER A (ALetter) ÷ [999.0] COMMA (MidNum) ÷
    // [999.0] HEAVY BLACK HEART (Glue_After_Zwj) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u0061\u002C\u2764", new String[] {"\u0061", "\u2764"});

    // ÷ 0061 ÷ 002C × 0308 ÷ 2764 ÷  #  ÷ [0.2] LATIN SMALL LETTER A (ALetter) ÷ [999.0] COMMA
    // (MidNum) × [4.0] COMBINING DIAERESIS (Extend_FE) ÷ [999.0] HEAVY BLACK HEART (Glue_After_Zwj)
    // ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u0061\u002C\u0308\u2764", new String[] {"\u0061", "\u2764"});

    // ÷ 0061 ÷ 002C ÷ 1F466 ÷  #  ÷ [0.2] LATIN SMALL LETTER A (ALetter) ÷ [999.0] COMMA (MidNum) ÷
    // [999.0] BOY (EBG) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u0061\u002C\uD83D\uDC66", new String[] {"\u0061", "\uD83D\uDC66"});

    // ÷ 0061 ÷ 002C × 0308 ÷ 1F466 ÷  #  ÷ [0.2] LATIN SMALL LETTER A (ALetter) ÷ [999.0] COMMA
    // (MidNum) × [4.0] COMBINING DIAERESIS (Extend_FE) ÷ [999.0] BOY (EBG) ÷ [0.3]
    assertAnalyzesTo(
        analyzer, "\u0061\u002C\u0308\uD83D\uDC66", new String[] {"\u0061", "\uD83D\uDC66"});
    ...
    // ÷ 0031 ÷ 003A ÷ 261D ÷  #  ÷ [0.2] DIGIT ONE (Numeric) ÷ [999.0] COLON (MidLetter) ÷ [999.0]
    // WHITE UP POINTING INDEX (E_Base) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u0031\u003A\u261D", new String[] {"\u0031", "\u261D"});

    // ÷ 0031 ÷ 003A × 0308 ÷ 261D ÷  #  ÷ [0.2] DIGIT ONE (Numeric) ÷ [999.0] COLON (MidLetter) ×
    // [4.0] COMBINING DIAERESIS (Extend_FE) ÷ [999.0] WHITE UP POINTING INDEX (E_Base) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u0031\u003A\u0308\u261D", new String[] {"\u0031", "\u261D"});

    // ÷ 0031 ÷ 003A ÷ 1F3FB ÷  #  ÷ [0.2] DIGIT ONE (Numeric) ÷ [999.0] COLON (MidLetter) ÷ [999.0]
    // EMOJI MODIFIER FITZPATRICK TYPE-1-2 (E_Modifier) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u0031\u003A\uD83C\uDFFB", new String[] {"\u0031", "\uD83C\uDFFB"});

    // ÷ 0031 ÷ 003A × 0308 ÷ 1F3FB ÷  #  ÷ [0.2] DIGIT ONE (Numeric) ÷ [999.0] COLON (MidLetter) ×
    // [4.0] COMBINING DIAERESIS (Extend_FE) ÷ [999.0] EMOJI MODIFIER FITZPATRICK TYPE-1-2
    // (E_Modifier) ÷ [0.3]
    assertAnalyzesTo(
        analyzer, "\u0031\u003A\u0308\uD83C\uDFFB", new String[] {"\u0031", "\uD83C\uDFFB"});

    // ÷ 0031 ÷ 003A ÷ 2764 ÷  #  ÷ [0.2] DIGIT ONE (Numeric) ÷ [999.0] COLON (MidLetter) ÷ [999.0]
    // HEAVY BLACK HEART (Glue_After_Zwj) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u0031\u003A\u2764", new String[] {"\u0031", "\u2764"});

    // ÷ 0031 ÷ 003A × 0308 ÷ 2764 ÷  #  ÷ [0.2] DIGIT ONE (Numeric) ÷ [999.0] COLON (MidLetter) ×
    // [4.0] COMBINING DIAERESIS (Extend_FE) ÷ [999.0] HEAVY BLACK HEART (Glue_After_Zwj) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u0031\u003A\u0308\u2764", new String[] {"\u0031", "\u2764"});

    // ÷ 0031 ÷ 003A ÷ 1F466 ÷  #  ÷ [0.2] DIGIT ONE (Numeric) ÷ [999.0] COLON (MidLetter) ÷ [999.0]
    // BOY (EBG) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u0031\u003A\uD83D\uDC66", new String[] {"\u0031", "\uD83D\uDC66"});

    // ÷ 0031 ÷ 003A × 0308 ÷ 1F466 ÷  #  ÷ [0.2] DIGIT ONE (Numeric) ÷ [999.0] COLON (MidLetter) ×
    ...
    // ÷ 0031 ÷ 0027 ÷ 261D ÷  #  ÷ [0.2] DIGIT ONE (Numeric) ÷ [999.0] APOSTROPHE (Single_Quote) ÷
    // [999.0] WHITE UP POINTING INDEX (E_Base) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u0031\u0027\u261D", new String[] {"\u0031", "\u261D"});

    // ÷ 0031 ÷ 0027 × 0308 ÷ 261D ÷  #  ÷ [0.2] DIGIT ONE (Numeric) ÷ [999.0] APOSTROPHE
    // (Single_Quote) × [4.0] COMBINING DIAERESIS (Extend_FE) ÷ [999.0] WHITE UP POINTING INDEX
    // (E_Base) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u0031\u0027\u0308\u261D", new String[] {"\u0031", "\u261D"});

    // ÷ 0031 ÷ 0027 ÷ 1F3FB ÷  #  ÷ [0.2] DIGIT ONE (Numeric) ÷ [999.0] APOSTROPHE (Single_Quote) ÷
    // [999.0] EMOJI MODIFIER FITZPATRICK TYPE-1-2 (E_Modifier) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u0031\u0027\uD83C\uDFFB", new String[] {"\u0031", "\uD83C\uDFFB"});

    // ÷ 0031 ÷ 0027 × 0308 ÷ 1F3FB ÷  #  ÷ [0.2] DIGIT ONE (Numeric) ÷ [999.0] APOSTROPHE
    // (Single_Quote) × [4.0] COMBINING DIAERESIS (Extend_FE) ÷ [999.0] EMOJI MODIFIER FITZPATRICK
    // TYPE-1-2 (E_Modifier) ÷ [0.3]
    assertAnalyzesTo(
        analyzer, "\u0031\u0027\u0308\uD83C\uDFFB", new String[] {"\u0031", "\uD83C\uDFFB"});

    // ÷ 0031 ÷ 0027 ÷ 2764 ÷  #  ÷ [0.2] DIGIT ONE (Numeric) ÷ [999.0] APOSTROPHE (Single_Quote) ÷
    // [999.0] HEAVY BLACK HEART (Glue_After_Zwj) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u0031\u0027\u2764", new String[] {"\u0031", "\u2764"});

    // ÷ 0031 ÷ 0027 × 0308 ÷ 2764 ÷  #  ÷ [0.2] DIGIT ONE (Numeric) ÷ [999.0] APOSTROPHE
    // (Single_Quote) × [4.0] COMBINING DIAERESIS (Extend_FE) ÷ [999.0] HEAVY BLACK HEART
    // (Glue_After_Zwj) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u0031\u0027\u0308\u2764", new String[] {"\u0031", "\u2764"});

    // ÷ 0031 ÷ 0027 ÷ 1F466 ÷  #  ÷ [0.2] DIGIT ONE (Numeric) ÷ [999.0] APOSTROPHE (Single_Quote) ÷
    // [999.0] BOY (EBG) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u0031\u0027\uD83D\uDC66", new String[] {"\u0031", "\uD83D\uDC66"});

    // ÷ 0031 ÷ 0027 × 0308 ÷ 1F466 ÷  #  ÷ [0.2] DIGIT ONE (Numeric) ÷ [999.0] APOSTROPHE
    // (Single_Quote) × [4.0] COMBINING DIAERESIS (Extend_FE) ÷ [999.0] BOY (EBG) ÷ [0.3]
    assertAnalyzesTo(
        analyzer, "\u0031\u0027\u0308\uD83D\uDC66", new String[] {"\u0031", "\uD83D\uDC66"});
    ...
    // ÷ 0031 ÷ 002C ÷ 261D ÷  #  ÷ [0.2] DIGIT ONE (Numeric) ÷ [999.0] COMMA (MidNum) ÷ [999.0]
    // WHITE UP POINTING INDEX (E_Base) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u0031\u002C\u261D", new String[] {"\u0031", "\u261D"});

    // ÷ 0031 ÷ 002C × 0308 ÷ 261D ÷  #  ÷ [0.2] DIGIT ONE (Numeric) ÷ [999.0] COMMA (MidNum) ×
    // [4.0] COMBINING DIAERESIS (Extend_FE) ÷ [999.0] WHITE UP POINTING INDEX (E_Base) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u0031\u002C\u0308\u261D", new String[] {"\u0031", "\u261D"});

    // ÷ 0031 ÷ 002C ÷ 1F3FB ÷  #  ÷ [0.2] DIGIT ONE (Numeric) ÷ [999.0] COMMA (MidNum) ÷ [999.0]
    // EMOJI MODIFIER FITZPATRICK TYPE-1-2 (E_Modifier) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u0031\u002C\uD83C\uDFFB", new String[] {"\u0031", "\uD83C\uDFFB"});

    // ÷ 0031 ÷ 002C × 0308 ÷ 1F3FB ÷  #  ÷ [0.2] DIGIT ONE (Numeric) ÷ [999.0] COMMA (MidNum) ×
    // [4.0] COMBINING DIAERESIS (Extend_FE) ÷ [999.0] EMOJI MODIFIER FITZPATRICK TYPE-1-2
    // (E_Modifier) ÷ [0.3]
    assertAnalyzesTo(
        analyzer, "\u0031\u002C\u0308\uD83C\uDFFB", new String[] {"\u0031", "\uD83C\uDFFB"});

    // ÷ 0031 ÷ 002C ÷ 2764 ÷  #  ÷ [0.2] DIGIT ONE (Numeric) ÷ [999.0] COMMA (MidNum) ÷ [999.0]
    // HEAVY BLACK HEART (Glue_After_Zwj) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u0031\u002C\u2764", new String[] {"\u0031", "\u2764"});

    // ÷ 0031 ÷ 002C × 0308 ÷ 2764 ÷  #  ÷ [0.2] DIGIT ONE (Numeric) ÷ [999.0] COMMA (MidNum) ×
    // [4.0] COMBINING DIAERESIS (Extend_FE) ÷ [999.0] HEAVY BLACK HEART (Glue_After_Zwj) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u0031\u002C\u0308\u2764", new String[] {"\u0031", "\u2764"});

    // ÷ 0031 ÷ 002C ÷ 1F466 ÷  #  ÷ [0.2] DIGIT ONE (Numeric) ÷ [999.0] COMMA (MidNum) ÷ [999.0]
    // BOY (EBG) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u0031\u002C\uD83D\uDC66", new String[] {"\u0031", "\uD83D\uDC66"});

    // ÷ 0031 ÷ 002C × 0308 ÷ 1F466 ÷  #  ÷ [0.2] DIGIT ONE (Numeric) ÷ [999.0] COMMA (MidNum) ×
    // [4.0] COMBINING DIAERESIS (Extend_FE) ÷ [999.0] BOY (EBG) ÷ [0.3]
    assertAnalyzesTo(
        analyzer, "\u0031\u002C\u0308\uD83D\uDC66", new String[] {"\u0031", "\uD83D\uDC66"});
    ...
    // ÷ 0031 ÷ 002E × 2060 ÷ 261D ÷  #  ÷ [0.2] DIGIT ONE (Numeric) ÷ [999.0] FULL STOP (MidNumLet)
    // × [4.0] WORD JOINER (Format_FE) ÷ [999.0] WHITE UP POINTING INDEX (E_Base) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u0031\u002E\u2060\u261D", new String[] {"\u0031", "\u261D"});

    // ÷ 0031 ÷ 002E × 2060 × 0308 ÷ 261D ÷  #  ÷ [0.2] DIGIT ONE (Numeric) ÷ [999.0] FULL STOP
    // (MidNumLet) × [4.0] WORD JOINER (Format_FE) × [4.0] COMBINING DIAERESIS (Extend_FE) ÷ [999.0]
    // WHITE UP POINTING INDEX (E_Base) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u0031\u002E\u2060\u0308\u261D", new String[] {"\u0031", "\u261D"});

    // ÷ 0031 ÷ 002E × 2060 ÷ 1F3FB ÷  #  ÷ [0.2] DIGIT ONE (Numeric) ÷ [999.0] FULL STOP
    // (MidNumLet) × [4.0] WORD JOINER (Format_FE) ÷ [999.0] EMOJI MODIFIER FITZPATRICK TYPE-1-2
    // (E_Modifier) ÷ [0.3]
    assertAnalyzesTo(
        analyzer, "\u0031\u002E\u2060\uD83C\uDFFB", new String[] {"\u0031", "\uD83C\uDFFB"});

    // ÷ 0031 ÷ 002E × 2060 × 0308 ÷ 1F3FB ÷  #  ÷ [0.2] DIGIT ONE (Numeric) ÷ [999.0] FULL STOP
    // (MidNumLet) × [4.0] WORD JOINER (Format_FE) × [4.0] COMBINING DIAERESIS (Extend_FE) ÷ [999.0]
    // EMOJI MODIFIER FITZPATRICK TYPE-1-2 (E_Modifier) ÷ [0.3]
    assertAnalyzesTo(
        analyzer, "\u0031\u002E\u2060\u0308\uD83C\uDFFB", new String[] {"\u0031", "\uD83C\uDFFB"});

    // ÷ 0031 ÷ 002E × 2060 ÷ 2764 ÷  #  ÷ [0.2] DIGIT ONE (Numeric) ÷ [999.0] FULL STOP (MidNumLet)
    // × [4.0] WORD JOINER (Format_FE) ÷ [999.0] HEAVY BLACK HEART (Glue_After_Zwj) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u0031\u002E\u2060\u2764", new String[] {"\u0031", "\u2764"});

    // ÷ 0031 ÷ 002E × 2060 × 0308 ÷ 2764 ÷  #  ÷ [0.2] DIGIT ONE (Numeric) ÷ [999.0] FULL STOP
    // (MidNumLet) × [4.0] WORD JOINER (Format_FE) × [4.0] COMBINING DIAERESIS (Extend_FE) ÷ [999.0]
    // HEAVY BLACK HEART (Glue_After_Zwj) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u0031\u002E\u2060\u0308\u2764", new String[] {"\u0031", "\u2764"});

    // ÷ 0031 ÷ 002E × 2060 ÷ 1F466 ÷  #  ÷ [0.2] DIGIT ONE (Numeric) ÷ [999.0] FULL STOP
    // (MidNumLet) × [4.0] WORD JOINER (Format_FE) ÷ [999.0] BOY (EBG) ÷ [0.3]
    assertAnalyzesTo(
        analyzer, "\u0031\u002E\u2060\uD83D\uDC66", new String[] {"\u0031", "\uD83D\uDC66"});

    // ÷ 0031 ÷ 002E × 2060 × 0308 ÷ 1F466 ÷  #  ÷ [0.2] DIGIT ONE (Numeric) ÷ [999.0] FULL STOP
    // (MidNumLet) × [4.0] WORD JOINER (Format_FE) × [4.0] COMBINING DIAERESIS (Extend_FE) ÷ [999.0]
    // BOY (EBG) ÷ [0.3]
    assertAnalyzesTo(
        analyzer, "\u0031\u002E\u2060\u0308\uD83D\uDC66", new String[] {"\u0031", "\uD83D\uDC66"});
    ...
    // ÷ 0020 × 200D ÷ 0646 ÷  #  ÷ [0.2] SPACE (Other) × [4.0] ZERO WIDTH JOINER (ZWJ_FE) ÷ [999.0]
    // ARABIC LETTER NOON (ALetter) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u0020\u200D\u0646", new String[] {"\u0646"});

    // ÷ 0646 × 200D ÷ 0020 ÷  #  ÷ [0.2] ARABIC LETTER NOON (ALetter) × [4.0] ZERO WIDTH JOINER
    // (ZWJ_FE) ÷ [999.0] SPACE (Other) ÷ [0.3]
    assertAnalyzesTo(analyzer, "\u0646\u200D\u0020", new String[] {"\u0646\u200D"});
    ...
    // ÷ 261D × 1F3FB ÷ 261D ÷  #  ÷ [0.2] WHITE UP POINTING INDEX (E_Base) × [14.0] EMOJI MODIFIER
    // FITZPATRICK TYPE-1-2 (E_Modifier) ÷ [999.0] WHITE UP POINTING INDEX (E_Base) ÷ [0.3]
    assertAnalyzesTo(
        analyzer, "\u261D\uD83C\uDFFB\u261D", new String[] {"\u261D\uD83C\uDFFB", "\u261D"});
    ...
    // ÷ 200D × 1F466 × 1F3FB ÷  #  ÷ [0.2] ZERO WIDTH JOINER (ZWJ_FE) × [3.3] BOY (EBG) × [14.0]
    // EMOJI MODIFIER FITZPATRICK TYPE-1-2 (E_Modifier) ÷ [0.3]
    assertAnalyzesTo(
        analyzer,
        "\u200D\uD83D\uDC66\uD83C\uDFFB",
