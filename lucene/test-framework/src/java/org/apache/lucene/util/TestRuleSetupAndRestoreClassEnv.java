...
final class TestRuleSetupAndRestoreClassEnv extends AbstractBeforeAfterRule {
  ...
  protected void before() throws Exception {
    ...
    } else if ("Lucene87".equals(TEST_CODEC)
        || ("random".equals(TEST_CODEC) && randomVal == 5 && !shouldAvoidCodec("Lucene87"))) {
      codec =
          new Lucene87Codec(
              RandomPicks.randomFrom(random, Lucene87StoredFieldsFormat.Mode.values()));
