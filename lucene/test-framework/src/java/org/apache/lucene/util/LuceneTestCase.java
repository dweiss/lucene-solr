...
@ThreadLeakLingering(
    linger = 20000) // Wait long for leaked threads to complete before failure. zk needs this.
...
public abstract class LuceneTestCase extends Assert {
  ...
  public static void setupSpins() {
    // Randomize IOUtils.spins() count so CMS varies its dynamic defaults, and this also "fixes"
    // core
    // count from the master seed so it will always be the same on reproduce:
