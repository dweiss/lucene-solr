...
public class JtsPolygonTest extends StrategyTestCase {
  ...
  private static final double LUCENE_4464_distErrPct =
  ...
  public JtsPolygonTest() {
    ...
    ((RecursivePrefixTreeStrategy) this.strategy)
  ...
  public void testBadPrefixTreePrune() throws Exception {
    ...
    Shape area =
        ctx.readShapeFromWkt(
            "POLYGON((-122.83 48.57, -122.77 48.56, -122.79 48.53, -122.83 48.57))");
    ...
    Query query =
        strategy.makeQuery(
            new SpatialArgs(
                SpatialOperation.Intersects, ctx.getShapeFactory().rect(upperleft, lowerright)));
    commit();
