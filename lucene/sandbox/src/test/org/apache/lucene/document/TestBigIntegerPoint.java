...
public class TestBigIntegerPoint extends LuceneTestCase {
    ...
    assertEquals(
        ...
        searcher.count(
            BigIntegerPoint.newRangeQuery(
                "field", large.subtract(BigInteger.ONE), large.add(BigInteger.ONE))));
    assertEquals(1, searcher.count(BigIntegerPoint.newSetQuery("field", large)));
    assertEquals(
        0, searcher.count(BigIntegerPoint.newSetQuery("field", large.subtract(BigInteger.ONE))));
  ...
  public void testNegative() throws Exception {
    ...
    Document document = new Document();
    BigInteger negative =
        BigInteger.valueOf(Long.MAX_VALUE).multiply(BigInteger.valueOf(64)).negate();
    ...
    assertEquals(
        ...
        searcher.count(
            BigIntegerPoint.newRangeQuery(
                "field", negative.subtract(BigInteger.ONE), negative.add(BigInteger.ONE))));
  ...
  public void testToString() throws Exception {
    ...
    assertEquals(
        ...
        new BigIntegerPoint("field", BigInteger.ONE, BigInteger.valueOf(-2)).toString());
    assertEquals(
        "field:[1 TO 1]", BigIntegerPoint.newExactQuery("field", BigInteger.ONE).toString());
    assertEquals(
        "field:[1 TO 17]",
        BigIntegerPoint.newRangeQuery("field", BigInteger.ONE, BigInteger.valueOf(17)).toString());
    assertEquals(
  ...
  public void testQueryEquals() throws Exception {
    ...
    assertFalse(
        q1.equals(
            BigIntegerPoint.newRangeQuery("a", BigInteger.valueOf(1), BigInteger.valueOf(1000))));
    assertFalse(
        q1.equals(
            BigIntegerPoint.newRangeQuery("b", BigInteger.valueOf(0), BigInteger.valueOf(1000))));
    ...
    q1 =
        BigIntegerPoint.newSetQuery(
            "a", BigInteger.valueOf(0), BigInteger.valueOf(1000), BigInteger.valueOf(17));
    q2 =
        BigIntegerPoint.newSetQuery(
            "a", BigInteger.valueOf(17), BigInteger.valueOf(0), BigInteger.valueOf(1000));
    assertEquals(q1, q2);
    assertEquals(q1.hashCode(), q2.hashCode());
    assertFalse(
        q1.equals(
            BigIntegerPoint.newSetQuery(
                "a", BigInteger.valueOf(1), BigInteger.valueOf(17), BigInteger.valueOf(1000))));
  }
}
