 ...
 *
 * <p>Features that should be supported for the future, related with the parser: - QueryNode tree
 * should be able convertible to any parser syntax. - The query syntax should support calling other
 * parsers. - QueryNode tree created by multiple parsers.
 */
