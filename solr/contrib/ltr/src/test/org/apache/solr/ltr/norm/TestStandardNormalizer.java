...
public class TestStandardNormalizer {
  ...
  private Normalizer implTestStandard(
    ...
    final Normalizer n =
        Normalizer.getInstance(solrResourceLoader, StandardNormalizer.class.getName(), params);
  ...
  public void testInvalidSTD() {
    ...
    NormalizerException ex =
        SolrTestCaseJ4.expectThrows(
            NormalizerException.class, () -> implTestStandard(params, 0.0f, 0.0f));
  ...
  public void testInvalidSTD2() {
    ...
    NormalizerException ex =
        SolrTestCaseJ4.expectThrows(
            NormalizerException.class, () -> implTestStandard(params, 0.0f, -1f));
    assertEquals(expectedException.toString(), ex.toString());
  }
  ...
  public void testInvalidSTD3() {
    ...
    NormalizerException ex =
        SolrTestCaseJ4.expectThrows(
            NormalizerException.class, () -> implTestStandard(params, 1f, 0f));
    assertEquals(expectedException.toString(), ex.toString());
  }
    ...
    final StandardNormalizer n2 =
        (StandardNormalizer)
            Normalizer.getInstance(
                new SolrResourceLoader(), StandardNormalizer.class.getName(), params);
