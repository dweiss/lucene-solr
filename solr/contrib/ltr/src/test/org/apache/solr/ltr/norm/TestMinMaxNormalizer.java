...
public class TestMinMaxNormalizer {
  ...
  private Normalizer implTestMinMax(
    ...
    final Normalizer n =
        Normalizer.getInstance(solrResourceLoader, MinMaxNormalizer.class.getName(), params);
    ...
    assertEquals(
        "{min=" + expectedMin + ", max=" + expectedMax + "}", mmn.paramsToMap().toString());
    return n;
  }
  ...
  public void testMinMaxNormalizerMinEqualToMax() {
    ...
    NormalizerException ex =
        SolrTestCaseJ4.expectThrows(
            NormalizerException.class, () -> implTestMinMax(params, 10.0f, 10.0f));
    ...
    final MinMaxNormalizer n2 =
        (MinMaxNormalizer)
            Normalizer.getInstance(
                new SolrResourceLoader(), MinMaxNormalizer.class.getName(), params);
