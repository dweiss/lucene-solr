...
public abstract class AbstractClusteringTestCase extends SolrTestCaseJ4 {
  ...
  public static void beforeClass() throws Exception {
    ...
    multiValuedSnippet.addField(
        "snippet", "First value of multi field. Some more text. And still more.");
    multiValuedSnippet.addField(
        "snippet", "Second value of multi field. Some more text. And still more.");
    multiValuedSnippet.addField(
        "snippet", "Third value of multi field. Some more text. And still more.");
    ...
    multiFieldDoc.addField(
        "body",
        "Body field: this is the contents of the body field that will get clustered together with snippet.");
  ...
  protected final Map<String, SearchClusteringEngine> getSearchClusteringEngines(
