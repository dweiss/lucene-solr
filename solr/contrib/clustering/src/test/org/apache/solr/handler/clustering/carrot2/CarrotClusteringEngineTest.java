...
public class CarrotClusteringEngineTest extends AbstractClusteringTestCase {
  ...
  public void testSummaryFragSize() throws Exception {
    ...
    assertEquals(
        "Equal number of clusters", shortSummaryClusters.size(), longSummaryClusters.size());
  ...
  private List<NamedList<Object>> clusterWithHighlighting(boolean enableHighlighting, int fragSize)
      throws IOException {
  ...
  private List<NamedList<Object>> clusterWithHighlighting(
    ...
    summaryParams.add(CarrotParams.PRODUCE_SUMMARY, Boolean.toString(enableHighlighting));
    summaryParams.add(CarrotParams.SUMMARY_FRAGSIZE, Integer.toString(fragSize));
    summaryParams.add(CarrotParams.SUMMARY_SNIPPETS, Integer.toString(summarySnippets));
    final List<NamedList<Object>> summaryClusters =
        checkEngine(
            getClusteringEngine("echo"),
  ...
  public void testWithoutSubclusters() throws Exception {
    checkClusters(
        checkEngine(getClusteringEngine("mock"), AbstractClusteringTestCase.numberOfDocs), 1, 1, 0);
  }

  @Test
  public void testExternalXmlAttributesFile() throws Exception {
    checkClusters(checkEngine(getClusteringEngine("mock-external-attrs"), 13), 1, 4, 0);
  }
  ...
  public void testWithSubclusters() throws Exception {
    ...
    checkClusters(
        checkEngine(getClusteringEngine("mock"), AbstractClusteringTestCase.numberOfDocs), 1, 1, 2);
  }
  ...
  public void testNumDescriptions() throws Exception {
    ...
    checkClusters(
        checkEngine(getClusteringEngine("mock"), AbstractClusteringTestCase.numberOfDocs, params),
        1,
        3,
        0);
  }
  ...
  public void testClusterScores() throws Exception {
    ...
    List<NamedList<Object>> clusters =
        checkEngine(getClusteringEngine("mock"), AbstractClusteringTestCase.numberOfDocs, params);
    int i = 1;
  ...
  public void testLexicalResourcesFromSolrConfigDefaultDir() throws Exception {
    checkLexicalResourcesFromSolrConfig(
        "lexical-resource-check", "online,customsolrstopword,customsolrstoplabel");
  }

  @Test
  public void testLexicalResourcesFromSolrConfigCustomDir() throws Exception {
    checkLexicalResourcesFromSolrConfig(
        "lexical-resource-check-custom-resource-dir",
  ...
  private void checkLexicalResourcesFromSolrConfig(String engineName, String wordsToCheck)
    ...
    params.set(
        AttributeUtils.getKey(LexicalResourcesCheckClusteringAlgorithm.class, "wordsToCheck"),
        wordsToCheck);
    ...
    final List<NamedList<Object>> clusters =
        checkEngine(getClusteringEngine(engineName), 1, params);
  ...
  public void testSolrStopWordsUsedInCarrot2Clustering() throws Exception {
    ...
    final List<NamedList<Object>> clusters =
        checkEngine(getClusteringEngine("lexical-resource-check"), 1, params);
    assertEquals(getLabels(clusters.get(0)), Collections.singletonList("online"));
  }
  ...
  public void testSolrStopWordsNotDefinedOnAFieldForClustering() throws Exception {
    ...
    final List<NamedList<Object>> clusters =
        checkEngine(getClusteringEngine("lexical-resource-check"), 2, params);
  ...
  public void testHighlightingOfMultiValueField() throws Exception {
    final String snippetWithoutSummary =
        getLabels(clusterWithHighlighting(false, 30, 3, "multi", 1).get(0)).get(1);
    ...
    final String snippetWithSummary =
        getLabels(clusterWithHighlighting(true, 30, 3, "multi", 1).get(0)).get(1);
    assertTrue(
        "Snippet with summary shorter than full snippet",
    ...
    final List<String> labels =
        getLabels(
            checkEngine(
                    ...
                    1,
                    1,
                    new TermQuery(new Term("body", "snippet")),
                    params)
                .get(0));
  ...
  public void testHighlightingMultipleFields() throws Exception {
    ...
    final String snippetWithoutSummary =
        getLabels(checkEngine(getClusteringEngine("echo"), 1, 1, query, params).get(0)).get(1);
    ...
    final List<String> labels =
        getLabels(
            checkEngine(
                    ...
                    1,
                    1,
                    new TermQuery(new Term("url", "one_supported_language")),
                    params)
                .get(0));
    ...
    final List<String> labels =
        getLabels(
            checkEngine(
                    ...
                    1,
                    1,
                    new TermQuery(new Term("url", "one_supported_language_of_many")),
                    params)
                .get(0));
    assertEquals(3, labels.size());
    ...
    final List<String> labels =
        getLabels(
            checkEngine(
                    ...
                    1,
                    1,
                    new TermQuery(new Term("url", "custom_fields")),
                    params)
                .get(0));
  ...
  public void testCustomTokenizer() throws Exception {
    ...
    final List<String> labels =
        getLabels(
            checkEngine(
                    getClusteringEngine("custom-duplicating-tokenizer"),
                    1,
                    15,
                    new TermQuery(new Term("title", "field")),
                    params)
                .get(0));
  ...
  public void testCustomStemmer() throws Exception {
    ...
    final List<String> labels =
        getLabels(
            checkEngine(
                    getClusteringEngine("custom-duplicating-stemmer"),
                    1,
                    12,
                    new TermQuery(new Term("title", "field")),
                    params)
  ...
  public void testDefaultEngineOrder() throws Exception {
    ClusteringComponent comp =
        (ClusteringComponent) h.getCore().getSearchComponent("clustering-name-default");
    ...
    assertEquals(
        ...
        ((CarrotClusteringEngine) engines.get(ClusteringEngine.DEFAULT_ENGINE_NAME))
  ...
  public void testDeclarationEngineOrder() throws Exception {
    ClusteringComponent comp =
        (ClusteringComponent) h.getCore().getSearchComponent("clustering-name-decl-order");
    Map<String, SearchClusteringEngine> engines = getSearchClusteringEngines(comp);
    assertEquals(
  ...
  public void testDeclarationNameDuplicates() throws Exception {
    ClusteringComponent comp =
        (ClusteringComponent) h.getCore().getSearchComponent("clustering-name-dups");
    Map<String, SearchClusteringEngine> engines = getSearchClusteringEngines(comp);
  ...
  private List<NamedList<Object>> checkEngine(
      CarrotClusteringEngine engine, int expectedNumClusters) throws IOException {
    return checkEngine(
        engine,
        numberOfDocs,
        expectedNumClusters,
  ...
  private List<NamedList<Object>> checkEngine(
      CarrotClusteringEngine engine, int expectedNumClusters, SolrParams clusteringParams)
      throws IOException {
    return checkEngine(
        engine, numberOfDocs, expectedNumClusters, new MatchAllDocsQuery(), clusteringParams);
  }
  ...
  private List<NamedList<Object>> checkEngine(
    ...
    return h.getCore()
        .withSearcher(
            searcher -> {
              DocList docList =
                  searcher.getDocList(query, (Query) null, new Sort(), 0, numberOfDocs);
              ...
              SolrDocumentList solrDocList =
                  ClusteringComponent.docListToSolrDocumentList(
                      docList, searcher, engine.getFieldsToLoad(req), docIds);

              @SuppressWarnings("unchecked")
              List<NamedList<Object>> results =
                  (List<NamedList<Object>>) engine.cluster(query, solrDocList, docIds, req);
              req.close();
  ...
  private void checkClusters(
      ...
      int expectedSubclusterCount) {
    for (int i = 0; i < results.size(); i++) {
      NamedList<Object> cluster = results.get(i);
      checkCluster(cluster, expectedDocCount, expectedLabelCount, expectedSubclusterCount);
    }
  }
  ...
  private void checkCluster(
      NamedList<Object> cluster,
      int expectedDocCount,
      int expectedLabelCount,
      int expectedSubclusterCount) {
    checkCluster(cluster, expectedSubclusterCount > 0);
    assertEquals("number of docs in cluster", expectedDocCount, getDocs(cluster).size());
    assertEquals("number of labels in cluster", expectedLabelCount, getLabels(cluster).size());

    if (expectedSubclusterCount > 0) {
      List<NamedList<Object>> subclusters = getSubclusters(cluster);
      assertEquals("numClusters", expectedSubclusterCount, subclusters.size());
      assertEquals("number of subclusters in cluster", expectedSubclusterCount, subclusters.size());
    }
  }
