...
public interface LangIdParams {
  ...
  String OVERWRITE =
      LANGUAGE_ID + ".overwrite"; // Overwrite if existing language value in LANG_FIELD
  ...
  String MAP_INDIVIDUAL_FL =
      LANGUAGE_ID + ".map.individual.fl"; // Field list of fields to redetect language for
  String MAP_LCMAP =
      LANGUAGE_ID + ".map.lcmap"; // Enables mapping multiple langs to same output field
  ...
  String MAX_FIELD_VALUE_CHARS =
      LANGUAGE_ID
          + ".maxFieldValueChars"; // Maximum number of characters to use per field for language
  // detection
  String MAX_TOTAL_CHARS =
      LANGUAGE_ID
          + ".maxTotalChars"; // Maximum number of characters to use per all concatenated fields for
  // language detection
