...
public abstract class AbstractAtomicUpdatesMultivalueTestBase extends EmbeddedSolrServerTestBase {
    ...
    getSolrClient()
        .add(
            sdoc(
                ...
                "20000",
                fieldName,
                ImmutableMap.of("remove", Lists.newArrayList(values[0]))));
    getSolrClient().commit(true, true);
    ...
    getSolrClient()
        .add(
            sdoc(
                ...
                "20001",
                fieldName,
                ImmutableMap.of("remove", Lists.newArrayList(values[0], values[1], values[2]))));
    getSolrClient().commit(true, true);
            ...
            Arrays.asList(
                sdoc(
                    ...
                    ImmutableMap.of(
                        ...
                        "remove",
                        Lists.newArrayList(values[1], values[2]))),
                sdoc(
                    "id",
                    "20001",
                    fieldName,
        ...
        .add(
            Arrays.asList(
                sdoc(
                    ...
                    fieldName,
                    ImmutableMap.of(
                        "set", Lists.newArrayList(values[0], values[1], values[2], values[3]))),
                sdoc(
                    "id",
                    "20001",
                    fieldName,
  ...
  public void testMultivalueBooleanField() throws SolrServerException, IOException {
    ...
    getSolrClient()
        .add(sdoc("id", "20000", fieldName, ImmutableMap.of("remove", Lists.newArrayList(false))));
    getSolrClient().commit(true, true);
    ...
    getSolrClient()
        .add(
            sdoc(
                ...
                "20001",
                fieldName,
                ImmutableMap.of("remove", Lists.newArrayList(true, false))));
    getSolrClient().commit(true, true);
        ...
        .add(
            Arrays.asList(
                sdoc(
                    ...
                    "20000",
                    fieldName,
                    ImmutableMap.of("add", Lists.newArrayList(false, false)))));
    getSolrClient().commit(true, true);
        ...
        .add(
            Arrays.asList(
                sdoc(
                    ...
                    "20000",
                    fieldName,
                    ImmutableMap.of("set", Lists.newArrayList(true, false))),
                sdoc(
                    "id",
                    "20001",
                    fieldName,
                    ImmutableMap.of("set", Lists.newArrayList(false, true)))));
    getSolrClient().commit(true, true);
  ...
  public void testMultivalueLatLonField() throws SolrServerException, IOException {
    runTestForFieldWithQuery(
        "latLonRemove", new String[] {"1.0,-1.0", "2.0,-2.0", "3.0,-3.0", "4.0,-4.0"});
  }
