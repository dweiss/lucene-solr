...
public class CloudExitableDirectoryReaderTest extends SolrCloudTestCase {
   ...
   *
   * <p>ie: This test is not about testing the SolrClient, so keep the SOlrClient simple.
   */
  ...
  public void assertPartialResults(ModifiableSolrParams p, Runnable postRequestCheck)
      throws Exception {
