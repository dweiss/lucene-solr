...
public class OverseerCollectionConfigSetProcessorTest extends SolrTestCaseJ4 {
    ...
    public OverseerCollectionConfigSetProcessorToBeTested(
      ...
      super(
          ...
          new OverseerNodePrioritizer(
              zkStateReader, overseer.getStateUpdateQueue(), adminPath, shardHandlerFactory),
          workQueue,
          runningMap,
          completedMap,
          failureMap);
  ...
  protected Set<String> commonMocks(int liveNodesCount) throws Exception {
    ...
    when(clusterStateMock.getCollection(anyString()))
        .thenAnswer(
            invocation -> {
  ...
  protected void issueCreateJob(
    ...
    Map<String, Object> propMap =
        Utils.makeMap(
            ...
            CONFIG_NAME,
            OverseerCollectionMessageHandler.NUM_SLICES,
    ...
    if (sendCreateNodeList) {
      ...
      if (OverseerCollectionMessageHandler.CREATE_NODE_SET_SHUFFLE_DEFAULT != createNodeSetShuffle
          || random().nextBoolean()) {
      ...
      for (int j = 1; j <= numberOfReplica; j++) {
        ...
        if (dontShuffleCreateNodeSet) {
          final String expectedNodeName =
              nodeUrlWithoutProtocolPartForLiveNodes.get(
                  (numberOfReplica * (i - 1) + (j - 1))
                      % nodeUrlWithoutProtocolPartForLiveNodes.size());
          assertFalse(
              "expectedNodeName is null for coreName=" + coreName, null == expectedNodeName);
          ...
          assertTrue(
              "node name mismatch for coreName="
                  + coreName
                  + " ( actual="
                  + actualNodeName
                  + " versus expected="
  ...
  @Test
  public void testNoReplicationEqualNumberOfSlicesPerNodeSendCreateNodesEqualToLiveNodes()
      throws Exception {
    Integer numberOfNodes = 4;
    Integer numberOfNodesToCreateOn = 4;
  ...
  @Test
  public void testReplicationEqualNumberOfSlicesPerNodeSendCreateNodesEqualToLiveNodes()
      throws Exception {
    Integer numberOfNodes = 4;
    Integer numberOfNodesToCreateOn = 4;
    CreateNodeListOptions createNodeListOptions = CreateNodeListOptions.SEND;
  ...
  @Test
  public void testNoReplicationLimitedNodesToCreateOn() throws Exception {
    Integer numberOfNodes = 4;
  ...
  @Test
  public void testReplicationLimitedNodesToCreateOn() throws Exception {
    Integer numberOfNodes = 4;
    Integer numberOfNodesToCreateOn = 2;
    CreateNodeListOptions createNodeListOptions = CreateNodeListOptions.SEND;
    Integer replicationFactor = 2;
