...
public class HttpPartitionTest extends AbstractFullDistribZkTestBase {
  ...
  protected void waitForState(String collection, String replicaName, Replica.State state, long ms)
    ...
    while (!timeOut.hasTimedOut()) {
      ...
      zkr.forceUpdateCollection(collection);
  ...
  protected int sendDoc(int docId, Integer minRf, JettySolrRunner leaderJetty)
  ...
  protected int sendDoc(int docId, Integer minRf, SolrClient solrClient, String collection)
      throws IOException, SolrServerException {
    SolrInputDocument doc = new SolrInputDocument();
