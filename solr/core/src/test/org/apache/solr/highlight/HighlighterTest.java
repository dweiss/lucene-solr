...
public class HighlighterTest extends SolrTestCaseJ4 {
  ...
  public void testConfig() {
    DefaultSolrHighlighter highlighter =
        (DefaultSolrHighlighter) HighlightComponent.getHighlighter(h.getCore());
  ...
  public void testMethodPostings() {
    ...
    // note: the default schema.xml has no offsets in postings to test the PostingsHighlighter.
  ...
  public void testDisMaxHighlight() {
    ...
    args.put("qf", "tv_text");
    args.put("q.alt", "*:*");
    TestHarness.LocalRequestFactory sumLRF = h.getRequestFactory("/dismax", 0, 200, args);
  ...
  public void testGetHighlightFields() {
    ...
    TestHarness.LocalRequestFactory lrf = h.getRequestFactory("", 0, 10, args);
