...
public class XmlUpdateRequestHandlerTest extends SolrTestCaseJ4 {
  ...
  public void testNamedEntity() throws Exception {
    ...
    assertU("<commit/>");
    assertQ(req("foo_s:zzz"), "//*[@numFound='1']");
  }
  ...
  private static class MockUpdateRequestProcessor extends UpdateRequestProcessor {
    ...
    public void expectDelete(
        String id, String query, int commitWithin, long version, String route) {
      DeleteUpdateCommand cmd = new DeleteUpdateCommand(null);
      cmd.id = id;
      cmd.query = query;
      cmd.commitWithin = commitWithin;
      if (version != 0) cmd.setVersion(version);
      if (route != null) cmd.setRoute(route);
    ...
    public void processDelete(DeleteUpdateCommand cmd) throws IOException {
      ...
      assertTrue(
          "Expected [" + expected + "] but found [" + cmd + "]",
