...
public class SuggestComponentTest extends SolrTestCaseJ4 {
  ...
  public void testDefaultBuildOnStartupNotStoredDict() throws Exception {
    ...
    assertEquals(
        ...
        h.getCore()
            .getSolrConfig()
            .getVal("//searchComponent[@name='suggest']/lst[8]/str[@name='name']", false));
    assertNull(
        h.getCore()
            .getSolrConfig()
            .getVal("//searchComponent[@name='suggest']/lst[8]/str[@name='storeDir']", false));
    ...
    assertEquals(
        ...
        h.getCore()
            .getSolrConfig()
            .getVal("//searchComponent[@name='suggest']/lst[8]/str[@name='buildOnCommit']", true));
    assertNull(
        h.getCore()
            .getSolrConfig()
            .getVal(
                "//searchComponent[@name='suggest']/lst[8]/str[@name='buildOnStartup']", false));
  ...
  public void testDefaultBuildOnStartupStoredDict() throws Exception {
    ...
    assertEquals(
        ...
        h.getCore()
            .getSolrConfig()
            .getVal("//searchComponent[@name='suggest']/lst[7]/str[@name='name']", false));
    assertEquals(
        suggester,
        h.getCore()
            .getSolrConfig()
            .getVal("//searchComponent[@name='suggest']/lst[7]/str[@name='storeDir']", false));
    ...
    assertEquals(
        ...
        h.getCore()
            .getSolrConfig()
            .getVal("//searchComponent[@name='suggest']/lst[7]/str[@name='buildOnCommit']", true));
    assertNull(
        h.getCore()
            .getSolrConfig()
            .getVal(
                "//searchComponent[@name='suggest']/lst[7]/str[@name='buildOnStartup']", false));
  ...
  public void testLoadOnStartup() throws Exception {
    ...
    assertEquals(
        ...
        h.getCore()
            .getSolrConfig()
            .getVal("//searchComponent[@name='suggest']/lst[6]/str[@name='name']", false));
    assertEquals(
        suggester,
        h.getCore()
            .getSolrConfig()
            .getVal("//searchComponent[@name='suggest']/lst[6]/str[@name='storeDir']", false));
    ...
    assertEquals(
        ...
        h.getCore()
            .getSolrConfig()
            .getVal("//searchComponent[@name='suggest']/lst[6]/str[@name='buildOnCommit']", true));
    assertEquals(
        "false",
        h.getCore()
            .getSolrConfig()
            .getVal("//searchComponent[@name='suggest']/lst[6]/str[@name='buildOnStartup']", true));
  ...
  private void doTestBuildOnStartup(boolean createNewCores) throws Exception {
    ...
    assertEquals(
        ...
        h.getCore()
            .getSolrConfig()
            .getVal("//searchComponent[@name='suggest']/lst[3]/str[@name='name']", false));
    assertNull(
        h.getCore()
            .getSolrConfig()
            .getVal("//searchComponent[@name='suggest']/lst[3]/str[@name='storeDir']", false));
    ...
    assertEquals(
        ...
        h.getCore()
            .getSolrConfig()
            .getVal(
                "//searchComponent[@name='suggest']/lst[3]/str[@name='buildOnStartup']", false));
    assertEquals(
        "true",
        h.getCore()
            .getSolrConfig()
            .getVal("//searchComponent[@name='suggest']/lst[3]/str[@name='buildOnCommit']", false));
    ...
    assertEquals(
        ...
        h.getCore()
            .getSolrConfig()
            .getVal("//searchComponent[@name='suggest']/lst[5]/str[@name='name']", false));
    assertNull(
        h.getCore()
            .getSolrConfig()
            .getVal("//searchComponent[@name='suggest']/lst[5]/str[@name='storeDir']", false));
    assertEquals(
        "true",
        h.getCore()
            .getSolrConfig()
            .getVal(
                "//searchComponent[@name='suggest']/lst[5]/str[@name='buildOnStartup']", false));
    assertEquals(
        "false",
        h.getCore()
            .getSolrConfig()
            .getVal("//searchComponent[@name='suggest']/lst[5]/str[@name='buildOnCommit']", false));
