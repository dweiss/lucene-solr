...
public class TestExpandComponent extends SolrTestCaseJ4 {
  ...
  public void testNumericExpand() throws Exception {
    ...
    if (groups.get(0).indexOf("f") > -1) {
      ...
      floatAppend =
          Float.toString(Float.parseFloat(floatAppend)); // Create a proper float out of the string.
  ...
  private void _testExpand(String group, String floatAppend, String hint) throws Exception {
    ...
    assertQ(
        ...
        "/response/lst[@name='expanded']/result[@name='1"
            + floatAppend
            + "']/doc[1]/str[@name='id'][.='1']",
        "/response/lst[@name='expanded']/result[@name='1"
            + floatAppend
            + "']/doc[2]/str[@name='id'][.='7']",
        "/response/lst[@name='expanded']/result[@name='2"
            + floatAppend
            + "']/doc[1]/str[@name='id'][.='5']",
        "/response/lst[@name='expanded']/result[@name='2"
            + floatAppend
    ...
    assertQ(
        req(params, "expand.sort", "test_l desc, sub(1,1) asc"),
        "*[count(/response/result/doc)=2]",
        "*[count(/response/lst[@name='expanded']/result)=2]",
        "/response/result/doc[1]/str[@name='id'][.='2']",
        "/response/result/doc[2]/str[@name='id'][.='6']",
    ...
    // Test with nullPolicy, ExpandComponent should ignore docs with null values in the collapse
    // fields.
    ...
    params.add("expand.rows", "0");
    assertQ(
        req(params, "fl", "id,score"),
        "*[count(/response/result/doc)=2]",
        "*[count(/response/lst[@name='expanded']/result)=2]",
        "*[count(/response/lst[@name='expanded']/result[@name='1" + floatAppend + "']/doc)=0]",
        "*[count(/response/lst[@name='expanded']/result[@name='2" + floatAppend + "']/doc)=0]",
        "*[count(/response/lst[@name='expanded']/result[@maxScore])=0]", // maxScore should not be
        // available
        "/response/result/doc[1]/str[@name='id'][.='1']",
        "/response/result/doc[2]/str[@name='id'][.='5']",
    ...
    assertQ(
        req(params, "expand.sort", "score desc", "fl", "id,score"),
        "*[count(/response/result/doc)=2]",
        "*[count(/response/lst[@name='expanded']/result)=2]",
        "/response/result/doc[1]/str[@name='id'][.='2']",
        "/response/result/doc[2]/str[@name='id'][.='6']",
    ...
    assertQ(
        req(params, "expand.sort", "test_l desc", "fl", "id,test_i,score"),
        "*[count(/response/result/doc)=2]",
        "count(/response/lst[@name='expanded']/result)=2",
        "/response/result/doc[1]/str[@name='id'][.='2']",
        "/response/result/doc[2]/str[@name='id'][.='6']",
    ...
    assertQ(
        req(params, "expand.sort", "test_l desc, score asc", "fl", "id,test_i,score"),
        "*[count(/response/result/doc)=2]",
        "count(/response/lst[@name='expanded']/result)=2",
        "/response/result/doc[1]/str[@name='id'][.='2']",
        "/response/result/doc[2]/str[@name='id'][.='6']",
    ...
    params =
        params(
            ...
            "id asc");
    assertQ(
        req(params, "expand.field", "term_s"),
        ...
        "count(//*[@name='score'])=0");
    assertQ(
        req(params, "expand.field", "test_f"),
        "*[count(/response/result/doc)=6]",
    ...
    params =
        params(
            ...
            "id asc");
    params.set(
        "fq", "{!collapse cost=1000 field=" + group + "}", "{!collapse cost=2000 field=test_f}");
    assertQ(
        req(params),
        "*[count(/response/result/doc)=1]",
        "/response/result/doc[1]/str[@name='id'][.='2']",
    ...
    params.set(
        "fq", "{!collapse cost=3000 field=" + group + "}", "{!collapse cost=2000 field=test_f}");
    assertQ(
        req(params),
        "*[count(/response/result/doc)=1]",
        "/response/result/doc[1]/str[@name='id'][.='2']",
    ...
    params.set(
        "fq",
        "{!collapse cost=1000 field=" + group + " nullPolicy=collapse}",
        "{!collapse cost=2000 field=test_f}");
    assertQ(
        req(params),
        "*[count(/response/result/doc)=2]",
  ...
  public void testErrorCases() {
    ...
    e =
        expectThrows(
            ...
            () ->
                h.query(
                    req("q", "*:*", "expand", "true", "expand.field", "term_s", "expand.q", "{!")));
    assertEquals(SolrException.ErrorCode.BAD_REQUEST.code, e.code());
    ...
    assertEquals(SolrException.ErrorCode.BAD_REQUEST.code, e.code());
    assertTrue(
        e.getMessage().contains("Can't determine a Sort Order (asc or desc) in sort spec 'bleh'"));
