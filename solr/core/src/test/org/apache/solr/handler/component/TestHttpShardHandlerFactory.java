...
public class TestHttpShardHandlerFactory extends SolrTestCaseJ4 {
  ...
  public void getShardsWhitelist() throws Exception {
    ...
    try {
      ...
      final HttpShardHandlerFactory httpShardHandlerFactory = ((HttpShardHandlerFactory) factory);
      assertThat(
          httpShardHandlerFactory.getWhitelistHostChecker().getWhitelistHosts().size(), is(2));
      assertThat(
          httpShardHandlerFactory.getWhitelistHostChecker().getWhitelistHosts(),
          hasItem("abc:8983"));
      assertThat(
          httpShardHandlerFactory.getWhitelistHostChecker().getWhitelistHosts(),
          hasItem("def:8984"));
  ...
  public void testLiveNodesToHostUrl() throws Exception {
    Set<String> liveNodes =
        new HashSet<>(
            Arrays.asList(
                new String[] {
                  "1.2.3.4:8983_solr", "1.2.3.4:9000_", "1.2.3.4:9001_solr-2",
                }));
  ...
  public void testWhitelistHostCheckerDisabled() throws Exception {
    ...
    checker.checkWhitelist(
        "http://abc-1.com:8983/solr", Arrays.asList(new String[] {"abc-1.com:8983/solr"}));
    ...
    SolrException e =
        expectThrows(
            SolrException.class,
            () -> {
              whitelistHostChecker.checkWhitelist(
                  "http://abc-1.com:8983/solr", Arrays.asList("http://abc-1.com:8983/solr"));
            });
  ...
  public void testWhitelistHostCheckerNoInput() throws Exception {
    assertNull(
        "Whitelist hosts should be null with null input",
        new WhitelistHostChecker(null, true).getWhitelistHosts());
    assertNull(
        "Whitelist hosts should be null with empty input",
  ...
  public void testWhitelistHostCheckerMultipleHost() {
    WhitelistHostChecker checker =
        new WhitelistHostChecker(
            "http://abc-1.com:8983, http://abc-2.com:8983, http://abc-3.com:8983", true);
    checker.checkWhitelist(
        "http://abc-1.com:8983/solr", Arrays.asList("http://abc-1.com:8983/solr"));
  }
  ...
  public void testWhitelistHostCheckerMultipleHost2() {
    ...
    checker.checkWhitelist(
        ...
        Arrays.asList("http://abc-1.com:8983/solr", "http://abc-2.com:8983/solr"));
  }
  ...
  public void testWhitelistHostCheckerNonWhitelistedHost1() {
    ...
    SolrException e =
        expectThrows(
            ...
            () -> {
              checker.checkWhitelist(
                  "http://abc-1.com:8983/solr", Arrays.asList("http://abc-4.com:8983/solr"));
            });
    assertThat(e.code(), is(SolrException.ErrorCode.FORBIDDEN.code));
    ...
    SolrException e =
        expectThrows(
            ...
            () -> {
              checker.checkWhitelist(
                  "http://abc-1.com:8983/solr",
                  Arrays.asList("http://abc-1.com:8983/solr", "http://abc-4.com:8983/solr"));
            });
    assertThat(e.code(), is(SolrException.ErrorCode.FORBIDDEN.code));
    assertThat(e.getMessage(), containsString("not on the shards whitelist"));
  }
  ...
  public void testWhitelistHostCheckerNonWhitelistedHostHttps() {
    WhitelistHostChecker checker =
        new WhitelistHostChecker(
            "http://abc-1.com:8983, http://abc-2.com:8983, http://abc-3.com:8983", true);
    checker.checkWhitelist(
        "https://abc-1.com:8983/solr", Arrays.asList("https://abc-1.com:8983/solr"));
  }
  ...
  public void testWhitelistHostCheckerInvalidUrl() {
    ...
    SolrException e =
        expectThrows(
            SolrException.class, () -> checker.checkWhitelist("abc_1", Arrays.asList("abc_1")));
  ...
  public void testWhitelistHostCheckerCoreSpecific() {
    ...
    WhitelistHostChecker checker =
        new WhitelistHostChecker(
            "http://abc-1.com:8983/solr/core1, http://abc-2.com:8983/solr2/core2", true);
    checker.checkWhitelist(
        "http://abc-1.com:8983/solr/core2",
  ...
  public void testGetShardsOfWhitelistedHostsSingle() {
    assertThat(
        WhitelistHostChecker.implGetShardsWhitelist("http://abc-1.com:8983/solr/core1").size(),
        is(1));
    assertThat(
        WhitelistHostChecker.implGetShardsWhitelist("http://abc-1.com:8983/solr/core1")
            .iterator()
            .next(),
        equalTo("abc-1.com:8983"));
  }

  @Test
  public void testGetShardsOfWhitelistedHostsMulti() {
    assertThat(
        WhitelistHostChecker.implGetShardsWhitelist(
                "http://abc-1.com:8983/solr/core1,http://abc-1.com:8984/solr")
            .size(),
        is(2));
    assertThat(
        WhitelistHostChecker.implGetShardsWhitelist(
            "http://abc-1.com:8983/solr/core1,http://abc-1.com:8984/solr"),
        hasItem("abc-1.com:8983"));
    assertThat(
        WhitelistHostChecker.implGetShardsWhitelist(
            "http://abc-1.com:8983/solr/core1,http://abc-1.com:8984/solr"),
        hasItem("abc-1.com:8984"));
  }
  ...
  public void testGetShardsOfWhitelistedHostsIpv4() {
    assertThat(
        WhitelistHostChecker.implGetShardsWhitelist(
                "http://10.0.0.1:8983/solr/core1,http://127.0.0.1:8984/solr")
            .size(),
        is(2));
    assertThat(
        WhitelistHostChecker.implGetShardsWhitelist(
            "http://10.0.0.1:8983/solr/core1,http://127.0.0.1:8984/solr"),
        hasItem("10.0.0.1:8983"));
    assertThat(
        WhitelistHostChecker.implGetShardsWhitelist(
            "http://10.0.0.1:8983/solr/core1,http://127.0.0.1:8984/solr"),
        hasItem("127.0.0.1:8984"));
  }
  ...
  public void testGetShardsOfWhitelistedHostsIpv6() {
    assertThat(
        WhitelistHostChecker.implGetShardsWhitelist(
                "http://[2001:abc:abc:0:0:123:456:1234]:8983/solr/core1,http://[::1]:8984/solr")
            .size(),
        is(2));
    assertThat(
        WhitelistHostChecker.implGetShardsWhitelist(
            "http://[2001:abc:abc:0:0:123:456:1234]:8983/solr/core1,http://[::1]:8984/solr"),
        hasItem("[2001:abc:abc:0:0:123:456:1234]:8983"));
    assertThat(
        WhitelistHostChecker.implGetShardsWhitelist(
            "http://[2001:abc:abc:0:0:123:456:1234]:8983/solr/core1,http://[::1]:8984/solr"),
        hasItem("[::1]:8984"));
  ...
  public void testGetShardsOfWhitelistedHostsHttps() {
    assertThat(
        WhitelistHostChecker.implGetShardsWhitelist("https://abc-1.com:8983/solr/core1").size(),
        is(1));
    assertThat(
        WhitelistHostChecker.implGetShardsWhitelist("https://abc-1.com:8983/solr/core1"),
        hasItem("abc-1.com:8983"));
  }
  ...
  public void testGetShardsOfWhitelistedHostsNoProtocol() {
    assertThat(
        WhitelistHostChecker.implGetShardsWhitelist("abc-1.com:8983/solr"),
