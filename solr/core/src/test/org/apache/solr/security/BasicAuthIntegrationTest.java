...
public class BasicAuthIntegrationTest extends SolrCloudAuthTestCase {
  ...
  public void testBasicAuth() throws Exception {
    ...
    try {
      ...
      if (isUseV2Api) {
        ...
        ((GenericSolrRequest) genericReq)
            .setContentWriter(new StringPayloadContentWriter(command, CommonParams.JSON_MIME));
      }
      ...
      baseUrl = cluster.getRandomJetty(random()).getBaseUrl().toString();
      verifySecurityStatus(
          cl, baseUrl + authzPrefix, "authorization/user-role/harry", NOT_NULL_PREDICATE, 20);
      ...
      executeCommand(
          ...
          Utils.toJSONString(
              singletonMap(
                  "set-permission",
                  Utils.makeMap("collection", "x", "path", "/update/*", "role", "dev"))),
          "harry",
          "HarryIsUberCool");

      verifySecurityStatus(
          cl, baseUrl + authzPrefix, "authorization/permissions[1]/collection", "x", 20);
      ...
      executeCommand(
          ...
          Utils.toJSONString(
              singletonMap(
                  "set-permission",
                  Utils.makeMap("name", "collection-admin-edit", "role", "admin"))),
          "harry",
          "HarryIsUberCool");
      verifySecurityStatus(
          cl,
          baseUrl + authzPrefix,
          "authorization/permissions[2]/name",
      ...
      executeCommand(
          baseUrl + authzPrefix,
          cl,
          "{set-permission : { name : update , role : admin}}",
          "harry",
          "HarryIsUberCool");
      ...
      executeCommand(
          baseUrl + authcPrefix,
          cl,
          "{set-property : { forwardCredentials: true}}",
          "harry",
          "HarryIsUberCool");
      verifySecurityStatus(
          cl,
          baseUrl + authcPrefix,
          "authentication/forwardCredentials",
          "true",
          20,
          "harry",
          "HarryIsUberCool");
  ...
  private void addDocument(String user, String pass, String... fields)
      throws IOException, SolrServerException {
  ...
  public static void executeCommand(
      String url, HttpClient cl, String payload, String user, String pwd) throws Exception {
