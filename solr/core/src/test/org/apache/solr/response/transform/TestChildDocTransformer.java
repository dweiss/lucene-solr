  ...
  private void testChildDoctransformerXML() throws Exception {
    ...
    assertQ(
        req(
            ...
            "fl",
            "*,[child parentFilter=\"subject:parentDocument\"]"),
        test1);
    ...
    assertQ(
        req(
            ...
            "subject:\"parentDocument\" ",
            "fl",
            "id, subject,[child parentFilter=\"subject:parentDocument\" childFilter=\"title:foo\"]"),
        test2);
    ...
    assertQ(
        req(
            ...
            "subject:\"parentDocument\" ",
            "fl",
            "id, subject,[child parentFilter=\"subject:parentDocument\" childFilter=\"title:bar\" limit=2]"),
        test3);
  ...
  private void testChildDoctransformerJSON() throws Exception {
    ...
    assertJQ(
        req(
            ...
            "subject:\"parentDocument\" ",
            "fl",
            "id, subject,[child parentFilter=\"subject:parentDocument\" childFilter=\"title:bar\" limit=3]"),
        test3);
  }
  ...
  private void testChildDocNonStoredDVFields() throws Exception {
    ...
    assertJQ(
        req(
            ...
            "subject:\"parentDocument\" ",
            "fl",
            "intDvoDefault, subject,[child parentFilter=\"subject:parentDocument\" childFilter=\"title:foo\"]"),
        test2);
    ...
    assertJQ(
        req(
            ...
            "subject:\"parentDocument\" ",
            "fl",
            "intDvoDefault, subject,[child parentFilter=\"subject:parentDocument\" childFilter=\"title:bar\" limit=2]"),
        test3);
  }
  ...
  private void testChildReturnFields() throws Exception {
    ...
    assertJQ(
        req(
            ...
            "subject:\"parentDocument\" ",
            "fl",
            "*,[child parentFilter=\"subject:parentDocument\" fl=\"intDvoDefault,child_fl:[value v='child_fl_test']\"]"),
    ...
    try (SolrQueryRequest req =
        req(
            ...
            "subject:\"parentDocument\" ",
            "fl",
            "intDefault,[child parentFilter=\"subject:parentDocument\" fl=\"intDvoDefault, [docid]\"]")) {
