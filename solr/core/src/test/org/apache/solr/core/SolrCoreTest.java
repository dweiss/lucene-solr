...
public class SolrCoreTest extends SolrTestCaseJ4 {
  ...
  public void testImplicitPlugins() {
    ...
    int ihCount = 0;
    {
      ...
      ++ihCount;
      assertEquals(pathToClassMap.get("/admin/logging"), "solr.LoggingHandler");
      ++ihCount;
      ...
      ++ihCount;
      assertEquals(pathToClassMap.get("/admin/properties"), "solr.PropertiesRequestHandler");
      ++ihCount;
      ...
      ++ihCount;
      assertEquals(pathToClassMap.get("/admin/threads"), "solr.ThreadDumpHandler");
      ++ihCount;
