...
public class TestBadConfig extends AbstractBadConfigTestBase {
  ...
  public void testMultipleDirectoryFactories() throws Exception {
    assertConfigs("bad-solrconfig-multiple-dirfactory.xml", "schema12.xml", "directoryFactory");
  }

  public void testMultipleIndexConfigs() throws Exception {
    assertConfigs("bad-solrconfig-multiple-indexconfigs.xml", "schema12.xml", "indexConfig");
  }

  public void testMultipleCFS() throws Exception {
    assertConfigs("bad-solrconfig-multiple-cfs.xml", "schema12.xml", "useCompoundFile");
  }
  ...
  public void testBogusScriptEngine() throws Exception {
    ...
    assertConfigs("bad-solrconfig-bogus-scriptengine-name.xml", "schema.xml", "giberish");
  }
