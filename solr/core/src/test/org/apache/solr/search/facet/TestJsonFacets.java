...
public class TestJsonFacets extends SolrTestCaseHS {
  ...
  public void testStatsDistrib() throws Exception {
    ...
    client
        .queryDefaults()
        .set("shards", servers.getShards(), "debugQuery", Boolean.toString(random().nextBoolean()));
  ...
  public void doStats(Client client, ModifiableSolrParams p) throws Exception {
    ...
    // TODO: if a field will be used as a function source, we can't use multi-valued types for it
    // (currently)
  ...
  public static void doStatsTemplated(Client client, ModifiableSolrParams p) throws Exception {
    ...
    client.testJQ(
        params(
            ...
            "*:*",
            "json.facet",
            "{f1:{terms:{${terms} field:'${cat_s}', sort:'n1 desc', facet:{n1:'avg(${num_is})'}  }}"
