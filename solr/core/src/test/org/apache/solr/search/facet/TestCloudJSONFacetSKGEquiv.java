 ...
 * the results are consistent and equivilent regardless of what <code>method</code> (ie:
 ...
 *
 * <p>This test only concerns itself with the equivilency of results
 *
...
public class TestCloudJSONFacetSKGEquiv extends SolrCloudTestCase {
  ...
  public void testBespoke() throws Exception {
    ...
    { // trivial single level facet w/ prefix
      Map<String, TermFacet> facets = new LinkedHashMap<>();
      facets.put("xxx", new TermFacet(multiStrField(9), map("prefix", "2")));
