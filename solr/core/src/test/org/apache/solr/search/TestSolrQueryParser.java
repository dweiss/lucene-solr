...
public class TestSolrQueryParser extends SolrTestCaseJ4 {
  ...
  public void testSynonymQueryStyle() throws Exception {
    ...
    assertEquals(
        "(t_pick_best_foo:tabbi | t_pick_best_foo:cat | t_pick_best_foo:felin | t_pick_best_foo:anim)",
        q.toString());

    q = QParser.getParser("tabby", req(params("df", "t_as_distinct_foo"))).getQuery();
    assertEquals(
        "t_as_distinct_foo:tabbi t_as_distinct_foo:cat t_as_distinct_foo:felin t_as_distinct_foo:anim",
        q.toString());
  ...
  public void testSynonymsBoost_singleTermQuerySingleTermSynonyms_shouldParseBoostedQuery()
    ...
    assertEquals(
        "((t_pick_best_boosted_foo:tigre)^0.9 | t_pick_best_boosted_foo:tiger)", q.toString());
    ...
    assertEquals(
        "((t_pick_best_boosted_foo:lince)^0.8 | (t_pick_best_boosted_foo:lynx_canadensis)^0.9)",
        q.toString());
  ...
  public void testSynonymsBoost_singleTermQueryMultiTermSynonyms_shouldParseBoostedQuery()
    ...
    assertEquals(
        "((t_pick_best_boosted_foo:\"big cat\")^0.8 | (t_pick_best_boosted_foo:bagheera)^0.9 | (t_pick_best_boosted_foo:\"panthera pardus\")^0.85 | t_pick_best_boosted_foo:leopard)",
        q.toString());
    ...
    assertEquals(
        "((t_pick_best_boosted_foo:\"panthera leo\")^0.9 | (t_pick_best_boosted_foo:\"simba leo\")^0.8 | (t_pick_best_boosted_foo:kimba)^0.75)",
        q.toString());
  ...
  public void testSynonymsBoost_multiTermQuerySingleTermSynonyms_shouldParseBoostedQuery()
    ...
    // lynx => lince|0.8, lynx_canadensis|0.9
    Query q =
        QParser.getParser("tiger lynx", req(params("df", "t_pick_best_boosted_foo"))).getQuery();
    assertEquals(
        "((t_pick_best_boosted_foo:tigre)^0.9 | t_pick_best_boosted_foo:tiger)"
            + " ((t_pick_best_boosted_foo:lince)^0.8 | (t_pick_best_boosted_foo:lynx_canadensis)^0.9)",
        q.toString());
  ...
  public void testSynonymsBoost_multiTermQueryMultiTermSynonyms_shouldParseBoostedQuery()
    ...
    // lion => panthera leo|0.9, simba leo|0.8, kimba|0.75
    Query q =
        QParser.getParser("leopard lion", req(params("df", "t_pick_best_boosted_foo"))).getQuery();
    assertEquals(
        "((t_pick_best_boosted_foo:\"big cat\")^0.8 | (t_pick_best_boosted_foo:bagheera)^0.9 | (t_pick_best_boosted_foo:\"panthera pardus\")^0.85 | t_pick_best_boosted_foo:leopard)"
            + " ((t_pick_best_boosted_foo:\"panthera leo\")^0.9 | (t_pick_best_boosted_foo:\"simba leo\")^0.8 | (t_pick_best_boosted_foo:kimba)^0.75)",
        q.toString());
  ...
  public void testSynonymsBoost_singleConceptQuerySingleTermSynonym_shouldParseBoostedQuery()
    ...
    Query q =
        QParser.getParser(
            ...
            .getQuery();
    assertEquals(
        "((t_pick_best_boosted_foo:leopard)^0.6 | t_pick_best_boosted_foo:\"panthera pardus\") t_pick_best_boosted_foo:story",
        q.toString());
  ...
  public void
    ...
    Query q =
        QParser.getParser(
                "panthera blytheae", req(params("df", "t_pick_best_boosted_foo", "sow", "false")))
            .getQuery();
    assertEquals(
        "((t_pick_best_boosted_foo:\"oldest ancient panthera\")^0.45 | t_pick_best_boosted_foo:\"panthera blytheae\")",
        q.toString());
  ...
  public void testSynonymsBoost_singleConceptQueryMultiTermSynonyms_shouldParseBoostedQuery()
    ...
    Query q =
        QParser.getParser(
                "snow leopard", req(params("df", "t_pick_best_boosted_foo", "sow", "false")))
            .getQuery();
    assertEquals(
        "((t_pick_best_boosted_foo:\"panthera uncia\")^0.9 | (t_pick_best_boosted_foo:\"big cat\")^0.8 | (t_pick_best_boosted_foo:white_leopard)^0.6 | t_pick_best_boosted_foo:\"snow leopard\")",
        q.toString());
    ...
    q =
        QParser.getParser(
            ...
            .getQuery();
    assertEquals(
        "((t_pick_best_boosted_foo:jaguar)^0.95 | (t_pick_best_boosted_foo:\"big cat\")^0.85 | (t_pick_best_boosted_foo:\"black panther\")^0.65)",
        q.toString());
  ...
  public void testSynonymsBoost_multiConceptQuerySingleTermSynonym_shouldParseBoostedQuery()
    ...
    Query q =
        QParser.getParser(
            ...
            .getQuery();
    assertEquals(
        "((t_pick_best_boosted_foo:leopard)^0.6 | t_pick_best_boosted_foo:\"panthera pardus\") ((t_pick_best_boosted_foo:tigre)^0.9 | t_pick_best_boosted_foo:tiger)",
        q.toString());
  ...
  public void testSynonymsBoost_edismaxBoost_shouldParseBoostedPhraseQuery() throws Exception {
    Query q =
        QParser.getParser(
                ...
                "edismax",
                true,
                req(params("sow", "false", "qf", "t_pick_best_boosted_foo^10")))
            .getQuery();
    assertEquals(
        "+("
