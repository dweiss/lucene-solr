...
public class JSONResponseWriter implements QueryResponseWriter {
  ...
  public void write(Writer writer, SolrQueryRequest req, SolrQueryResponse rsp) throws IOException {
    ...
    if (namedListStyle.equals(JsonTextWriter.JSON_NL_ARROFNTV)) {
      w =
          new ArrayOfNameTypeValueJSONWriter(
  ...
  class ArrayOfNameTypeValueJSONWriter extends JSONWriter {
    ...
    @Override
    public void writeNamedList(String name, @SuppressWarnings({"rawtypes"}) NamedList val)
        throws IOException {
    ...
    public void writeMap(
        String name,
        @SuppressWarnings({"rawtypes"}) Map val,
    ...
    @Override
    public void writeArray(String name, @SuppressWarnings({"rawtypes"}) Iterator val)
        throws IOException {
