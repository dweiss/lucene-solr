...
public class QueryParser extends SolrQueryParserBase implements QueryParserConstants {
  ...
  protected Query newFieldQuery(
    ...
    setAutoGenerateMultiTermSynonymsPhraseQuery(
        fieldAutoGenPhraseQueries || getAutoGeneratePhraseQueries());
    // Don't auto-quote graph-aware field queries
    boolean treatAsQuoted =
        getSplitOnWhitespace()
            ? (quoted || fieldAutoGenPhraseQueries || getAutoGeneratePhraseQueries())
            : quoted;
      ...
      case NUMBER:
        {
          ...
          q =
              handleBareTokenQuery(
                  getField(field), term, fuzzySlop, prefix, wildcard, fuzzy, regexp);
          break;
        }
      case RANGEIN_START:
      case RANGEEX_START:
  ...
  public final void MultiTerm(String field, List<BooleanClause> clauses)
  ...
  private static void jj_la1_init_1() {
    jj_la1_1 =
        new int[] {
          0x0, 0x0, 0x0, 0x0, 0x7, 0x7, 0x7, 0x0, 0x0, 0x0, 0x0, 0x7, 0x4, 0x0, 0x0, 0x0, 0x0, 0x0,
          0xc8, 0xc8, 0x30, 0x0, 0x0, 0x0, 0x0, 0x0, 0x4,
        };
  }
