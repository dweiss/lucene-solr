...
public class IntervalFacets implements Iterable<FacetInterval> {
  ...
  private void accumIntervalsMulti(SortedSetDocValues ssdv, DocIdSetIterator disi, Bits bits)
      throws IOException {
  ...
  private void accumIntervalsSingle(SortedDocValues sdv, DocIdSetIterator disi, Bits bits)
      throws IOException {
