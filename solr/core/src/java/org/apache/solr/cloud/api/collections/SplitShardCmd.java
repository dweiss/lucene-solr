...
public class SplitShardCmd implements OverseerCollectionMessageHandler.Cmd {
  ...
  public boolean split(ClusterState clusterState, ZkNodeProps message, NamedList<Object> results)
    ...
    try {
      ...
      Assign.AssignStrategy assignStrategy =
          Assign.createAssignStrategy(ocmh.cloudManager, clusterState, collection);
   ...
   */
  private void handleFailureOnAsyncRequest(
      @SuppressWarnings({"rawtypes"}) NamedList results, String msgOnError) {
