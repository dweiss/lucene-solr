...
/**
 * Singleton that creates a Transformer for the XSLTServletFilter. For now, only caches the last
 * created Transformer, but could evolve to use an LRU cache of Transformers.
 *
