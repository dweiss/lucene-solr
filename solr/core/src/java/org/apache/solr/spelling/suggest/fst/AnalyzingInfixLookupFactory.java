...
public class AnalyzingInfixLookupFactory extends LookupFactory {
  ...
  /**
   * The path where the underlying index is stored if no index is found, it will be generated by the
   * AnalyzingInfixSuggester
   */
  protected static final String INDEX_PATH = "indexPath";

  /**
   * Minimum number of leading characters before PrefixQuery is used (default 4). Prefixes shorter
   * than this are indexed as character ngrams (increasing index size but making lookups faster)
   */
