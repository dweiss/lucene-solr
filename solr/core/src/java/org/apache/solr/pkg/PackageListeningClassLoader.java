...
public class PackageListeningClassLoader implements SolrClassLoader, PackageListeners.Listener {
  ...
  public <T> T newInstance(String cname, Class<T> expectedType, String... subpackages) {
    ...
    if (cName.pkg == null) {
      ...
      return applyResourceLoaderAware(
          version, version.getLoader().newInstance(cName.className, expectedType, subpackages));
    }
  }
  ...
  public <T> T newInstance(
    ...
    if (cName.pkg == null) {
      ...
      return applyResourceLoaderAware(
          ...
          version
              .getLoader()
              .newInstance(cName.className, expectedType, subPackages, params, args));
    }
  }
