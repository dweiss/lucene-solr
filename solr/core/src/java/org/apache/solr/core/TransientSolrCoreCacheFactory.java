...
public abstract class TransientSolrCoreCacheFactory {
  ...
  public static TransientSolrCoreCacheFactory newInstance(
    ...
    try {
      ...
      // Many things could cause this, bad solrconfig, mis-typed class name, whatever. However, this
      // should not
      // keep the enclosing coreContainer from instantiating, so log an error and continue.
      log.error(
          "Error instantiating TransientSolrCoreCacheFactory class [{}]: ", info.className, e);
      return null;
    }
  }
