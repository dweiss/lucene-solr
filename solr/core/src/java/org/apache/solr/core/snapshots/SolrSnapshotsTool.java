...
public class SolrSnapshotsTool implements Closeable, CLIO {
  ...
  public Map<String, List<String>> getIndexFilesPathForSnapshot(
      String collectionName, String snapshotName, Optional<String> pathPrefix)
  ...
  public void buildCopyListings(
      String collectionName, String snapshotName, String localFsPath, Optional<String> pathPrefix)
      throws SolrServerException, IOException {
    ...
    for (Map.Entry<String, List<String>> entry : paths.entrySet()) {
      ...
      try (Writer w =
          new OutputStreamWriter(
              new FileOutputStream(new File(localFsPath, entry.getKey())),
