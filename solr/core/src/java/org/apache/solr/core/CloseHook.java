 ...
 *
 * <p>Call {@link org.apache.solr.core.SolrCore#addCloseHook(org.apache.solr.core.CloseHook)} during
 * the {@link org.apache.solr.util.plugin.SolrCoreAware#inform(SolrCore)} method to add a close hook
 * to your object.
 *
 * <p>The close hook can be useful for releasing objects related to the request handler (for
...
public abstract class CloseHook {
   ...
   * searchers are closed <br>
   * Use this method for post-close clean up operations e.g. deleting the index from disk. <br>
   * <b>The core's passed to the method is already closed and therefore, its update handler or
   * searcher should *NOT* be used</b>
   *
