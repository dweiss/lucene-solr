...
public interface BackupRepository extends NamedListInitializedPlugin, Closeable {
  ...
  /**
   * This method returns the URI representation for the specified path. Note - the specified path
   * could be a fully qualified URI OR a relative path for a file-system.
   *
   ...
   *
   * @param path The path whose type needs to be checked.
   ...
   *
   * @param dirPath The parent directory of the file to be read
   * @param fileName The name of the file to be read
   * @param ctx the Lucene IO context
