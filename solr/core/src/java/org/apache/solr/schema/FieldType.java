...
public abstract class FieldType extends FieldProperties {
   ...
   * #treatUnboundedRangeAsExistence} should be overriden.
   *
   ...
   *
   * <p>This method should only be overriden whenever a fieldType does not support {@link
   ...
   *
   * <p>This method can be overriden to implement specialized existence logic for fieldTypes. The
