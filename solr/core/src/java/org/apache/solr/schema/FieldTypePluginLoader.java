...
public final class FieldTypePluginLoader extends AbstractPluginLoader<FieldType> {
  ...
  @Override
  protected FieldType create(SolrClassLoader loader, String name, String className, Node node)
      throws Exception {
  ...
  private Analyzer readAnalyzer(Node node) throws XPathExpressionException {
    ...
    NodeList charFilterNodes =
        (NodeList) xpath.evaluate("./charFilter", node, XPathConstants.NODESET);
    NodeList tokenizerNodes =
        (NodeList) xpath.evaluate("./tokenizer", node, XPathConstants.NODESET);
    ...
    AbstractPluginLoader<CharFilterFactory> charFilterLoader =
        new AbstractPluginLoader<CharFilterFactory>(
          ...
          protected CharFilterFactory create(
              SolrClassLoader loader, String name, String className, Node node) throws Exception {
