...
public class ManagedIndexSchemaFactory extends IndexSchemaFactory implements SolrCoreAware {
   ...
   * org.apache.solr.core.SolrResourceLoader#getConfigDir()}, or if configs are in ZooKeeper, under
   * {@link org.apache.solr.cloud.ZkSolrResourceLoader#getConfigSetZkPath()}.
   *
  ...
  private File locateConfigFile(String resource) {
    ...
    if (location.equals(resource) || location.startsWith("classpath:")) return null;
