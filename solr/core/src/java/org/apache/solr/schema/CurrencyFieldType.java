 ...
 *
 * <p>See <a
 * href="http://wiki.apache.org/solr/CurrencyField">http://wiki.apache.org/solr/CurrencyField</a>
 */
public class CurrencyFieldType extends FieldType implements SchemaAware, ResourceLoaderAware {
  ...
  class ConvertedCurrencyValueSource extends ValueSource {
    ...
    public FunctionValues getValues(
        @SuppressWarnings({"rawtypes"}) Map context, LeafReaderContext reader) throws IOException {
