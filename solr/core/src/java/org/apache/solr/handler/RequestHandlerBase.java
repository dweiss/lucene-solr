...
public abstract class RequestHandlerBase
    implements SolrRequestHandler, SolrInfoBean, NestedRequestHandler, ApiSupport {
  ...
  public void initializeMetrics(SolrMetricsContext parentContext, String scope) {
    ...
    MetricsMap metricsMap =
        new MetricsMap((detail, map) -> shardPurposes.forEach((k, v) -> map.put(k, v.getCount())));
  ...
  public static SolrParams getSolrParamsFromNamedList(
      @SuppressWarnings({"rawtypes"}) NamedList args, String key) {
