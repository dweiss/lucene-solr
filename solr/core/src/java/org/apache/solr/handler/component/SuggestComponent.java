...
public class SuggestComponent extends SearchComponent
      ...
      for (ShardResponse srsp : sreq.responses) {
        ...
        if ((resp = srsp.getSolrResponse().getResponse()) != null) {
          ...
          Map<String, SimpleOrderedMap<NamedList<Object>>> namedList =
              (Map<String, SimpleOrderedMap<NamedList<Object>>>)
  ...
  private void toNamedList(
      SuggesterResult suggesterResult, Map<String, SimpleOrderedMap<NamedList<Object>>> resultObj) {
  ...
  private SuggesterResult toSuggesterResult(
      Map<String, SimpleOrderedMap<NamedList<Object>>> suggestionsMap) {
    SuggesterResult result = new SuggesterResult();
