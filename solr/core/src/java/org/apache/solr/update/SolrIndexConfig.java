...
public class SolrIndexConfig implements MapSerializable {
  ...
  public SolrIndexConfig(SolrConfig solrConfig, String prefix, SolrIndexConfig def) {
    ...
    maxCommitMergeWaitMillis =
        solrConfig.getInt(prefix + "/maxCommitMergeWaitTime", def.maxCommitMergeWaitMillis);

    // how do we validate the value??
    ramPerThreadHardLimitMB =
        solrConfig.getInt(prefix + "/ramPerThreadHardLimitMB", def.ramPerThreadHardLimitMB);
    ...
    mergeSchedulerInfo =
        getPluginInfo(prefix + "/mergeScheduler", solrConfig, def.mergeSchedulerInfo);
    mergePolicyFactoryInfo =
        getPluginInfo(prefix + "/mergePolicyFactory", solrConfig, def.mergePolicyFactoryInfo);
    ...
    mergedSegmentWarmerInfo =
        getPluginInfo(prefix + "/mergedSegmentWarmer", solrConfig, def.mergedSegmentWarmerInfo);
