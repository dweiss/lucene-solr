 ...
 * scripts which can be loaded by the {@link SolrResourceLoader} (usually via the <code>conf</code>
 * dir for the SolrCore).
 *
 ...
 * ClassLoader may be used. By default, the engine used for each script is determined by the filed
 ...
 * @since 4.0.0
 */
public class StatelessScriptUpdateProcessorFactory extends UpdateRequestProcessorFactory
