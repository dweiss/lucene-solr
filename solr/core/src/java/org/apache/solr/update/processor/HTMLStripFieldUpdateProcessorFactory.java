 ...
 *
 * <p>For example, with the configuration listed below any documents containing HTML markup in any
 * field declared in the schema using <code>StrField</code> will have that HTML striped away.
 *
