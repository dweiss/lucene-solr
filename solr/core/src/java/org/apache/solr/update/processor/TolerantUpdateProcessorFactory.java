 ...
 *
 * <p><code>maxErrors</code> is an int value that can be specified in the configuration and/or
 * overridden per request. If unset, it will default to {@link Integer#MAX_VALUE}. Specifying an
 * explicit value of <code>-1</code> is supported as shorthand for {@link Integer#MAX_VALUE}, all
 * other negative integer values are not supported.
 *
 * <p>An example configuration would be:
 *
 ...
 * </pre>
 *
 * <p>The <code>maxErrors</code> parameter in the above chain could be overwritten per request, for
 * example:
 *
 * <pre class="prettyprint">
 ...
 * </pre>
 *
 * <p><b>NOTE:</b> The behavior of this UpdateProcessofFactory in conjunction with indexing
