 ...
 *
 * <p>For example, with the configuration listed below any documents containing String values (such
 * as "<code>abcdef</code>" or "<code>xyz</code>") in a field declared in the schema using <code>
 * IntPointField</code> or <code>LongPointField</code> would have those Strings replaced with the
 * length of those fields as an Integer (ie: <code>6</code> and <code>3</code> respectively)
 *
