...
public class UpdateLog implements PluginInfoInitialized, SolrMetricProducer {
  ...
  protected LinkedHashMap<BytesRef, LogPtr> oldDeletes =
      new LinkedHashMap<BytesRef, LogPtr>(numDeletesToKeep) {
        @Override
  ...
  */
  ...
  public synchronized long applyPartialUpdates(
      ...
      @SuppressWarnings({"rawtypes"}) SolrDocumentBase latestPartialDoc) {
  ...
  private void applyOlderUpdates(
      @SuppressWarnings({"rawtypes"}) SolrDocumentBase newerDoc,
      SolrInputDocument olderDoc,
    ...
    public void doReplay(TransactionLog translog) {
      try {
        ...
        OrderedExecutor executor =
            inSortedOrder ? null : req.getCore().getCoreContainer().getReplayUpdatesExecutor();
