 ...
 * as well as those fields that match a schema field with a long field type.
 *
 * <p>If all values are parseable as long (or are already Long), then the field will be mutated,
 * replacing each value with its parsed Long equivalent; otherwise, no mutation will occur.
 *
...
public class ParseLongFieldUpdateProcessorFactory extends ParseNumericFieldUpdateProcessorFactory {
  ...
  private static class ParseLongFieldUpdateProcessor
