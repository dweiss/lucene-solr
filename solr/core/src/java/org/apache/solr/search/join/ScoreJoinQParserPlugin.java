 ...
 * similar to {@link JoinQParserPlugin} <a href="http://wiki.apache.org/solr/Join">{!join}</a> This
 * plugin doesn't have own name, and is called by specifying local parameter <code>
 ...
 *       href="http://wiki.apache.org/solr/DocValues">docValues</a> are not enabled for this field,
 *       it will work anyway, but it costs some memory for {@link UninvertingReader}. Also, numeric
 *       doc values are not supported until <a
