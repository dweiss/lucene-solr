...
/**
 * A query that wraps a filter and simply returns a constant score equal to the query boost for
 * every document in the filter. This Solr extension also supports weighting of a SolrFilter.
 *
...
public class SolrConstantScoreQuery extends Query implements ExtendedQuery {
  ...
  protected class ConstantWeight extends ConstantScoreWeight {
    ...
    public ConstantWeight(IndexSearcher searcher, ScoreMode scoreMode, float boost)
        throws IOException {
  ...
  public boolean equals(Object other) {
    return sameClassAs(other) && Objects.equals(filter, ((SolrConstantScoreQuery) other).filter);
  }
