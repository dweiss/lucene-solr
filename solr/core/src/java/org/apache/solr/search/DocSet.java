...
public abstract class DocSet implements Accountable, Cloneable /* extends Collection<Integer> */ {
  ...
  /**
   * Returns a Filter for use in Lucene search methods, assuming this DocSet was generated from the
   * top-level MultiReader that the Lucene search methods will be invoked with.
   */
