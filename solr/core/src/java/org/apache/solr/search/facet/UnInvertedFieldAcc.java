...
public abstract class UnInvertedFieldAcc extends SlotAcc implements UnInvertedField.Callback {
  ...
  public UnInvertedFieldAcc(FacetContext fcontext, SchemaField sf, int numSlots)
      throws IOException {
    super(fcontext);
    this.sf = sf;
  ...
  abstract static class DoubleUnInvertedFieldAcc extends UnInvertedFieldAcc {
    ...
    public DoubleUnInvertedFieldAcc(
  ...
  abstract static class SDVUnInvertedFieldAcc extends DoubleUnInvertedFieldAcc {
    ...
    public SDVUnInvertedFieldAcc(FacetContext fcontext, SchemaField sf, int numSlots)
        throws IOException {
