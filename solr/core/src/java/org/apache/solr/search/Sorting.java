 ...
 *
 * @deprecated custom {@link FieldType}s should use the helper methods in the base class. Other
 *     usage should leverage th underling lucene {@link SortField} classes directly.
 */
@Deprecated
public class Sorting {

  /**
   * Returns a {@link SortField} for a string field. If nullLast and nullFirst are both false, then
   * default lucene string sorting is used where null strings sort first in an ascending sort, and
   ...
   * @return SortField
   * @deprecated custom {@link FieldType}s should use {@link FieldType#getSortField}. Other usage
   *     should leverage th underling lucene {@link SortField} classes directly.
   */
  @Deprecated
   ...
   *
   * @deprecated custom {@link FieldType}s should use {@link FieldType#getSortedSetSortField}. Other
   *     usage should leverage th underling lucene {@link SortedSetSortField} classes directly.
   */
  @Deprecated
  public static SortField getTextSortField(
      String fieldName, boolean reverse, boolean nullLast, boolean nullFirst) {
  ...
  private static void applyMissingFirstLast(
      SortField in, boolean reverse, boolean nullLast, boolean nullFirst) {
