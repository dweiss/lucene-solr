 ...
 * </code> a sensible default depending on the {@link Version} matching configured:
 *
 * <ul>
 *   <li><code>luceneMatchVersion &lt; 8.0</code> = {@link LegacyBM25Similarity}
  ...
  public Similarity getSimilarity() {
    ...
    if (null == similarity) {
      ...
      if (null == defaultSimFromFieldType) {
        ...
        defaultSim =
            coreVersion.onOrAfter(Version.LUCENE_8_0_0)
                ? new BM25Similarity()
