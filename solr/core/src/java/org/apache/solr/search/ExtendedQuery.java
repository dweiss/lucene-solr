...
/**
 * The ExtendedQuery interface provides extra metadata to a query. Implementations of ExtendedQuery
 * must also extend Query.
 */
public interface ExtendedQuery {
  ...
  /**
   * If true, the clauses of this boolean query should be cached separately. This is not yet
   * implemented.
   */
