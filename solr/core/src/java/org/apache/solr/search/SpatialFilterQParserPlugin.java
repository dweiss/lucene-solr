 ...
 *
 * <p>The field must implement {@link org.apache.solr.schema.SpatialQueryable}
 *
 * <p>All units are in Kilometers
 *
 * <p>Syntax:
 *
 ...
 *
 * <ul>
 *   <li>sfield - The field to filter on. Required.
 *   <li>pt - The point to use as a reference. Must match the dimension of the field. Required.
 *   <li>d - The distance in km. Required.
 * </ul>
 *
 ...
 * <pre>fq={!geofilt}&amp;sfield=store&amp;pt=10.312,-20&amp;d=3.5</pre>
 *
 * <p>Note: The geofilt for LatLonType is capable of also producing scores equal to the computed
 * distance from the point to the field, making it useful as a component of the main query or a
 * boosting query.
 */
