...
/**
 * {@link org.apache.lucene.search.highlight.Fragmenter} that tries to produce snippets that "look"
 * like a regular expression. <code>solrconfig.xml</code> parameters:
 *
 * <ul>
 *   <li><code>hl.regex.pattern</code>: regular expression corresponding to "nice" fragments.
 ...
 *   <li><code>hl.regex.maxAnalyzedChars</code>: how many characters to apply the regular expression
 *       to (independent from the global highlighter setting).
 * </ul>
 *
 * NOTE: the default for <code>maxAnalyzedChars</code> is much lower for this fragmenter. After this
 * limit is exhausted, fragments are produced in the same way as <code>GapFragmenter</code>
 */
public class RegexFragmenter extends HighlightingPluginBase implements SolrFragmenter {
  ...
  public void init(@SuppressWarnings({"rawtypes"}) NamedList args) {
    ...
    if (defaults != null) {
      defaultPatternRaw =
          defaults.get(HighlightParams.PATTERN, LuceneRegexFragmenter.DEFAULT_PATTERN_RAW);
    }
