...
public abstract class SolrExampleTests extends SolrExampleTestsBase {
  ...
  private ByteBuffer getFileContent(@SuppressWarnings({"rawtypes"}) NamedList nl, String name)
      throws IOException {
  ...
  /**
   * Depth first search of a SolrInputDocument looking for a decendent by id, returns null if it's
   * not a decendent
   */
   ...
   * documents constructed (including decendents) to allDocs via their id
   */
