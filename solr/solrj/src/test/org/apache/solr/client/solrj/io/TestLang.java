...
public class TestLang extends SolrTestCase {
  ...
  private static final String[] allFunctions = {
    ...
    "not",
    "or",
    TemporalEvaluatorYear.FUNCTION_NAME,
    TemporalEvaluatorMonth.FUNCTION_NAME,
    TemporalEvaluatorDay.FUNCTION_NAME,
    TemporalEvaluatorDayOfYear.FUNCTION_NAME,
    TemporalEvaluatorHour.FUNCTION_NAME,
    TemporalEvaluatorMinute.FUNCTION_NAME,
    TemporalEvaluatorSecond.FUNCTION_NAME,
    TemporalEvaluatorEpoch.FUNCTION_NAME,
    TemporalEvaluatorWeek.FUNCTION_NAME,
    TemporalEvaluatorQuarter.FUNCTION_NAME,
    TemporalEvaluatorDayOfQuarter.FUNCTION_NAME,
    "abs",
    "add",
    "div",
    "mult",
  ...
  public void testLang() {
    ...
    Map<String, Supplier<Class<? extends Expressible>>> registeredFunctions =
        factory.getFunctionNames();
