...
public class ZkMaintenanceUtils {
  ...
  // This not just a copy operation since the config manager takes care of construction the znode
  // path to configsets
  public static void downConfig(SolrZkClient zkClient, String confName, Path confPath)
      throws IOException {
  ...
  // This not just a copy operation since the config manager takes care of construction the znode
  // path to configsets
  public static void upConfig(SolrZkClient zkClient, Path confPath, String confName)
      throws IOException {
    ZkConfigManager manager = new ZkConfigManager(zkClient);
