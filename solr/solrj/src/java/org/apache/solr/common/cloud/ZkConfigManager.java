...
public class ZkConfigManager {
   ...
   * @param fromConfig the config to copy from
   * @param toConfig the config to copy to
   * @param copiedToZkPaths should be an empty Set, will be filled in by function with the paths
   *     that were actually copied to.
   * @throws IOException if an I/O error occurs
   */
  ...
  public static Path getConfigsetPath(String confDir, String configSetDir) throws IOException {
    ...
    throw new IllegalArgumentException(
        String.format(
            ...
            Paths.get(configSetDir, "conf", "solrconfig.xml")
                .normalize()
                .toAbsolutePath()
                .toString(),
            Paths.get(configSetDir, confDir, "conf", "solrconfig.xml")
                .normalize()
                .toAbsolutePath()
                .toString()));
  }
