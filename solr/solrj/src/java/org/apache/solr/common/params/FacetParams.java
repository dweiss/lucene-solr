...
public interface FacetParams {
  ...
  /**
   * Date string indicating the starting point for a date facet range. Can be overriden on a per
   * field basis.
   */
  public static final String FACET_DATE_START = FACET_DATE + ".start";
  /**
   * Date string indicating the ending point for a date facet range. Can be overriden on a per field
   * basis.
   */
  public static final String FACET_DATE_END = FACET_DATE + ".end";
  /**
   * Date Math string indicating the interval of sub-ranges for a date facet range. Can be overriden
   ...
   * 'start' and 'end' being evenly divisible by 'gap'. The default is false. Can be overriden on a
   * per field basis.
   */
   ...
   *
   * <p>Can be overriden on a per field basis.
   *
  ...
  /**
   * Number indicating the starting point for a numerical range facet. Can be overriden on a per
   * field basis.
   */
  public static final String FACET_RANGE_START = FACET_RANGE + ".start";
  /**
   * Number indicating the ending point for a numerical range facet. Can be overriden on a per field
   * basis.
   */
  public static final String FACET_RANGE_END = FACET_RANGE + ".end";
  /**
   * Number indicating the interval of sub-ranges for a numerical facet range. Can be overriden on a
   * per field basis.
   */
   ...
   * (multi-value). Can be overriden on a per field basis.
   */
