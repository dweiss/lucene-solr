...
public class SolrException extends RuntimeException {
  ...
  public static String toStr(Throwable e) {
    ...
    /**
     * This doesn't work for some reason!!!!! StringWriter sw = new StringWriter(); PrintWriter pw =
     * new PrintWriter(sw); e.printStackTrace(pw); pw.flush(); System.out.println("The STRING:" +
     * sw.toString()); return sw.toString();
     */
  }

  /**
   * For test code - do not log exceptions that match any of these regular expressions. A {@link
   * java.util.concurrent.CopyOnWriteArraySet is recommended}.
   */
  public static Set<String> ignorePatterns;

  /**
   * Returns null if this exception does not match any ignore patterns, or a message string to use
   * if it does.
   */
  public static String doIgnore(Throwable t, String m) {
    Set<String> ignorePatterns =
        SolrException.ignorePatterns; // guard against races, albeit unlikely
