...
public interface CollectionAdminParams {
  ...
  /**
   * The reverse-link to WITH_COLLECTION flag. It is stored in the cluster state of the
   * `withCollection` and points to the collection on which the `withCollection` was specified.
   */
   ...
   * etc.
   *
   * <p>e.g. {defaults:{collection:{replicationFactor:2}}}
   */
