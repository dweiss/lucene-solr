...
public class EnumeratedDistributionEvaluator extends RecursiveNumericEvaluator
    implements ManyValueWorker {

  private static final long serialVersionUID = 1;

  public EnumeratedDistributionEvaluator(StreamExpression expression, StreamFactory factory)
      throws IOException {
  ...
  public Object doWork(Object... values) throws IOException {
    ...
    if (values.length == 1) {
      ...
      int[] samples =
          ((List) first).stream().mapToInt(value -> ((Number) value).intValue()).toArray();
