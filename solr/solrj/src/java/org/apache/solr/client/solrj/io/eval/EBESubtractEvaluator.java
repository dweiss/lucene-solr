...
public class EBESubtractEvaluator extends RecursiveObjectEvaluator implements TwoValueWorker {
  ...
  public EBESubtractEvaluator(StreamExpression expression, StreamFactory factory)
      throws IOException {
  ...
  public Object doWork(Object first, Object second) throws IOException {
    ...
    if (first instanceof List && second instanceof List) {
      ...
      throw new IOException(
          "Parameters for ebeSubtract must either be two numeric arrays or two matrices. ");
    }
  }
}
