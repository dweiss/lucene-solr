...
public class DelegationTokenHttpSolrClient extends HttpSolrClient {
  ...
  /**
   * Package protected constructor for use by {@linkplain
   * org.apache.solr.client.solrj.impl.HttpSolrClient.Builder}.
   *
   * @lucene.internal
   * @deprecated use {@link
   *     DelegationTokenHttpSolrClient#DelegationTokenHttpSolrClient(HttpSolrClient.Builder)}
  ...
  /**
   * This constructor is defined at "protected" scope. Ideally applications should use {@linkplain
   * org.apache.solr.client.solrj.impl.HttpSolrClient.Builder} instance to configure this Solr
   * client instance.
   *
   ...
   */
  @Deprecated
  protected DelegationTokenHttpSolrClient(
      String baseURL,
      HttpClient client,
      ResponseParser parser,
      boolean allowCompression,
