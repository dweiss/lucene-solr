...
public class ConcurrentUpdateSolrClient extends SolrClient {
   ...
   *
   * @deprecated use {@link ConcurrentUpdateSolrClient#ConcurrentUpdateSolrClient(Builder)} instead,
   *     as it is a more extension/subclassing-friendly alternative
   */
  @Deprecated
  protected ConcurrentUpdateSolrClient(
  ...
  /**
   * set soTimeout (read timeout) on the underlying HttpConnectionManager. This is desirable for
