 ...
 *
 * <p>This class assumes the id field for your documents is called 'id' - if this is not the case,
 * you must set the right name with {@link #setIdField(String)}.
 */
...
public class CloudSolrClient extends BaseCloudSolrClient {
  ...
  protected Map<String, LBHttpSolrClient.Req> createRoutes(
    ...
    return urlMap == null
        ? null
        : updateRequest.getRoutes(router, col, urlMap, routableParams, idField);
  }
  ...
  @Deprecated
  public RouteResponse condenseResponse(
      @SuppressWarnings({"rawtypes"}) NamedList response, int timeMillis) {
  ...
  public static class RouteResponse
      extends BaseCloudSolrClient.RouteResponse<LBHttpSolrClient.Req> {}
  ...
  public static class Builder extends SolrClientBuilder<Builder> {
    ...
    /**
     * @deprecated use other constructors instead. This constructor will be changing visibility in
     *     an upcoming release.
     */
    @Deprecated
    public Builder() {}
    ...
    /**
     * Provide a ZooKeeper client endpoint to be used when configuring {@link CloudSolrClient}
     * instances.
     *
     ...
     *
     * <p>Method may be called multiple times. One of the provided values will be used to fetch the
     * list of live Solr nodes that the underlying {@link HttpClusterStateProvider} would be
     * maintaining.
     *
     * <p>Provided Solr URL is expected to point to the root Solr path
     * ("http://hostname:8983/solr"); it should not include any collections, cores, or other path
     * components.
     *
    ...
    /**
     * Provide a list of Solr URL to be used when configuring {@link CloudSolrClient} instances. One
     * of the provided values will be used to fetch the list of live Solr nodes that the underlying
     ...
     *     the ZooKeeper ensemble. Note that with certain Collection types like HashSet, the order
     *     of hosts in the final connect string may not be in the same order you added them.
     * @deprecated use Zk-host constructor instead
     */
    @Deprecated
    ...
    /**
     * Expert feature where you want to implement a custom cluster discovery mechanism of the solr
     * nodes as part of the cluster.
     *
     * @deprecated since this is an expert feature we don't want to expose this to regular users. To
     *     use this feature extend CloudSolrClient.Builder and pass your custom ClusterStateProvider
     */
    @Deprecated
