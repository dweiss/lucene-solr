...
public class HttpSolrClient extends BaseHttpSolrClient {
  ...
  /**
   * @deprecated use {@link HttpSolrClient#HttpSolrClient(Builder)} instead, as it is a more
   *     extension/subclassing-friendly alternative
   */
  @Deprecated
  protected HttpSolrClient(
      String baseURL, HttpClient client, ResponseParser parser, boolean allowCompression) {
    this(
        new Builder(baseURL)
  ...
  public NamedList<Object> request(
      @SuppressWarnings({"rawtypes"}) final SolrRequest request, String collection)
  ...
  public NamedList<Object> request(
      @SuppressWarnings({"rawtypes"}) final SolrRequest request, final ResponseParser processor)
      throws SolrServerException, IOException {
    return request(request, processor, null);
  }

  public NamedList<Object> request(
      @SuppressWarnings({"rawtypes"}) final SolrRequest request,
  ...
  private void setBasicAuthHeader(
      @SuppressWarnings({"rawtypes"}) SolrRequest request, HttpRequestBase method)
  ...
  private Header[] buildRequestSpecificHeaders(
      @SuppressWarnings({"rawtypes"}) final SolrRequest request) {
   ...
   *
   * @param timeout Timeout in milliseconds
   *     <p>s * @deprecated since 7.0 Use {@link Builder} methods instead.
   */
  @Deprecated
