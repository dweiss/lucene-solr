...
public class CoreApiMapping {
  public enum Meta implements CommandMeta {
    CREATE(
        ...
        "create",
        Utils.makeMap("config", "configSet")),
    ...
    REJOINLEADERELECTION(
        NODEAPIS, POST, CoreAdminAction.REJOINLEADERELECTION, "rejoin-leader-election", null),
    ...
    Meta(
      ...
      this.method = method;
      this.paramstoAttr =
          paramstoAttr == null ? Collections.EMPTY_MAP : Collections.unmodifiableMap(paramstoAttr);
      this.action = action;
    }
